    ...
    <div class="room_flash">
        <div class="flash_cont" style="position:relative;background: #ebebeb;">
            ...
            <iframe scrolling="no" frameborder="0" src="partyMessage.html" id="messages" allowtransparency="true"
                    name="messages"
                    style="background:#fff;width:375px; height:255px;position:absolute;top:17px;left:488px;z-index:2;"></iframe>
            <%--</s:if>--%>
            <%--<s:else>--%>
            ...
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                    ...
                    name="Girl" width="860" height="350" id="Girl" wmode="transparent"
                    style="position:relative;z-index:3;">
                <param name="movie" value="<s:property value="flashPatch"/>"/>
                <param name="quality" value="high"/>
                <param name="wmode" value="transparent"/>
                <param name="allowFullScreen" value="true"/>
                <embed src="<s:property value="flashPatch"/>" allowFullScreen="true" width="860" height="350"
