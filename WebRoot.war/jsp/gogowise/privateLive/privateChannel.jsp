...
<script language="JavaScript" type="text/javascript">
     ...
     function CloseBrowser(){
      ...
      function updateSubChannlSignal(userID,subChannelID){
        //  alert("updateSubChannlSignal  privateChannel's subChannel id :"+subChannelID);
...
<div class="room_cont">
    ...
    <div class="room_header">
        <div id="apDiv1"><img src="<s:property value="userPrivateChannel.user.pic"/>" alt="<s:property value="userPrivateChannel.user.nickName"/>" /></div>
        <div class="user_msg">
        ...
        <div class="user_nums">
            ...
            <span class="out"><span class="orWord_large"><s:property value="userFansNum"/></span>&nbsp;<s:property value="%{getText('onlive.fensi')}"/></span>
        </div>
        <div class="room_effect">
            <%-- host端看看直播效果和推荐好友，guest端是推荐好友 --%>
            <s:if test="host">
                    <a id="addLiveTitle"  href="#add_live_title" target="_blank"><s:property value="%{getText('gogowise.personalOnlive.title')}" /></a>
            ...
            <span class="out"><%--<s:property value="%{getText('personal.onlive.last.time')}"/>--%>&nbsp;<span class="orWord_large" id="personalOnlive_duration">0</span>&nbsp;<s:property value="%{getText('label.minute')}"/></span>
            <span class="out"><%--<s:property value="%{getText('personal.onlive.start.time')}"/>--%>&nbsp;<span class="orWord_large"><s:date name="subPrivateChannel.openTime" format="%{getText('dateformat.forclass')}"/></span></span>
        </div>
    </div>
  <div class="room_flash">
    <div class="flash_cont" style="position:relative;background: #ebebeb;">
      <%--<s:if test="host">--%>
          <iframe scrolling="no" frameborder="0" src="partyMessage.html" id="messages" allowtransparency="true" name="messages" style="background:#fff;width:375px; height:255px;position:absolute;top:17px;left:488px;z-index:2;"></iframe>
      <%--</s:if>--%>
      <%--<s:else>--%>
          <%--<iframe scrolling="no" frameborder="0" src="partyMessage.html" id="messages" allowtransparency="true" name="messages" style="background:#fff;width:390px; height:270px;position:absolute;top:17px;left:488px;z-index:2;"></iframe>--%>
      <%--</s:else>--%>
      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" name="Girl" width="860" height="350" id="Girl" wmode="transparent" style="position:relative;z-index:3;" >
          <param name="movie" value="<s:property value="flashPatch"/>" />
          <param name="quality" value="high" />
          <param name="wmode" value="transparent" />
          <param name="allowFullScreen" value="true" />
          <embed src="<s:property value="flashPatch"/>" allowFullScreen="true" width="860" height="350" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" name="Girl" id="GirlEmbed"></embed>
      </object>
    </div>
...
<div style="display:none;">
    <div class="invite_student_container" id="invite_student_container">
        <s:form id="emailForm_personalOnlive">
            ...
            <div class="invite_student_inner">
                ...
                <p class="begin_invite"><label onclick="inviteFriends();"><s:property value="%{getText('course.invite.begin')}"/></label>&nbsp;&nbsp;&nbsp;<span id="inviteMessage" style="color: green;"></span></p>
            </div>
        </s:form>
    </div>
    ...
    <div id="add_live_title">
        ...
        <input class="input2" type="button" onclick="addPerOnliveName(<s:property value="personalOnlive.id"/>);" value="确定添加"/>
