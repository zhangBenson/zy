...
<div id="prChargeWrap" class="fl">
    ...
    <div id="chargeSelect" class="fl">
        <s:form action="initConfirmCharge">
            ...
            <s:select list="#{'1':'1','2':'2','3':'3','4':'4'}" headerKey="4" headerValue="4" cssClass="long_text_field"
                      id="step2_course_type" name="userPrivateChannel.channelCombo"/>&nbsp;<s:property
                value="%{getText('privateLiveCharge.tip3')}"/> <br/><br/>
            <input type="text" name="comboNum" id="comboNum"/>&nbsp;<s:property
                value="%{getText('privateLiveCharge.tip4')}"/>&nbsp;&nbsp;<span class="tip_words" id="comboNumMsg"></span><br/>
            <input type="submit" class="submit_btn_large" onclick="return checkInteger('comboNum','comboNumMsg');"
                   value="<s:property value="%{getText('privateLiveCharge.tip5')}"/>"/>
        </s:form>
    </div>
</div>