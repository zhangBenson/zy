...
<div class="room_cont">
  ...
  <div class="room_flash">
    <div class="flash_cont" style="position:relative;background: #ebebeb;height: auto;">
      ...
      <iframe scrolling="no" frameborder="0" src="partyMessage.html" id="messages" allowtransparency="true" name="messages" style="background:#fff;width:400px; height:255px;position:absolute;top:380px;left:505px;z-index:2;"></iframe>

      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" name="Girl" width="860" height="650" id="Girl" wmode="transparent" style="position:relative;z-index:3;" >
          <param name="movie" value="<s:property value="flashPatch"/>" />
          <param name="quality" value="high" />
          <param name="wmode" value="transparent" />
          <param name="allowFullScreen" value="true" />
          <embed src="<s:property value="flashPatch"/>" allowFullScreen="true" width="860" height="650" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" name="Girl" id="GirlEmbed"></embed>
      </object>
    </div>
