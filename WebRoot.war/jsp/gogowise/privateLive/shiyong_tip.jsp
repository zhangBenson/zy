...
<div id="prTipWrap" class="fl">
    ...
    <div id="tipContent" class="fl">
        ...
        <table>
            <tr>
                <th><s:property value="%{getText('eye.home.monitor')}"/></th>
                <th><s:property value="%{getText('eye.comp.monitor')}"/></th>
                <th><s:property value="%{getText('eye.shop.monitor')}"/></th>
            </tr>
            <tr>
                <td><s:property value="%{getText('eye.home.monitor.care')}"/></td>
                <td><s:property value="%{getText('eye.comp.monitor.improve')}"/></td>
                <td><s:property value="%{getText('eye.shop.monitor.out')}"/></td>
            </tr>
        </table>
        <%--</p>--%>
    </div>
    ...
    <ul id="tipOperate" class="fl">
        <%--<s:if test="validDays > 0">--%>
        <li>
            <a href="openPrivateChannel.html" class="submit_btn_large"><s:property
                    value="%{getText('shiyong.tips3')}"/></a>
        </li>
        <li>
            <a href="monitorAuthority.html" class="submit_btn_large"><s:property
                    value="%{getText('monitor.authority')}"/></a>
        </li>
        <%--</s:if>--%>
        <%--<li>--%>
