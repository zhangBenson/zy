    ...
    <div id="chargeSelect" class="fl">
        <s:form action="chargeSuccess">
               ...
               <s:hidden name="totalCharges"/>
                ...
                <br/>
                <br/>
            <s:property value="%{getText('confirmCharge.tip25')}"/><s:property value="totalCharges"/> &nbsp;&nbsp; <s:property value="%{getText('confirmCharge.tip26')}"/> &nbsp;&nbsp;&nbsp;<a href="myGGWAccount.html"><s:property value="%{getText('confirmCharge.tip27')}"/></a> <br/><br/>
                <input type="submit" class="submit_btn_large" value="<s:property value="%{getText('confirmCharge.tip28')}"/>" />
        </s:form>
    </div>
</div>