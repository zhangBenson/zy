...
<div id="prTipWrap" class="fl">
    ...
    <ul id="tipOperate" class="fl">
        <li>
            <a href="createPrivateChannel.html" class="submit_btn_large"><s:property value="%{getText('private.tip4')}"/></a>
        </li>
        <li>
            <a href="privateLiveCharge.html" class="submit_btn_large"><s:property value="%{getText('private.tip5')}"/></a>
        </li>
    </ul>
