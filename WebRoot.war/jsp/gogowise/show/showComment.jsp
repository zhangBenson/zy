...
<s:iterator value="showComments" status="idx">
    <li class="li_out" style="text-align: left;">
        <ul class="ul_in">
            <li class="li_1"><s:a action="userBlog" target="_blank"><s:param name="user.id" value="commenter.id"/><img
            ...
            <li class="li_3">
                ...
                <s:if test="myShow.owner.id == #session.userID && commenter.id != #session.userID">
                    <span class="span_3"><a
                            onclick="replyToComment('<s:property value="commenter.nickName"/>',<s:property
                                    value="commenter.id"/>)"><s:property value="%{getText('blog.comments.reply')}"/></a></span>
                    <span class="span_3"><a onclick="deleteThisComment(this,<s:property value="id"/>)"><s:property
                ...
                <s:else>
                    <span class="span_3"><a onclick="deleteThisComment(this,<s:property value="myShow.id"/>,<s:property
                            value="id"/>)"><s:property value="%{getText('blog.comments.delete')}"/></a></span>
                </s:else>
            </li>
        </ul>
    </li>
