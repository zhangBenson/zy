          ...
          <ul class="content_courseInfo">
              <li>
                  ...
                  <div class="option_content">
                      <s:if test="existAds">
                          <s:select name="advertisement.fromAdvertisement.id"  list="ads" listKey="key"  id="advertisement_name" cssClass="long_text_field" listValue="value"/>
                      </s:if>
                      <s:else>
              ...
              <li>
                  ...
                  <div class="option_content"><s:textfield cssClass="long_text_field" id="bid_link" name="advertisement.linkAddress"/>
                  </div>
              </li>
              <li>
              ...
              <li class="long_select_li">
                  ...
                  <div class="option_content"><s:textfield cssClass="short_text_field" id="bid_price" name="advertisement.bidPrice"/></div>
              </li>
              <li>
                  <div class="option_tittle"><s:property value="%{getText('show.bidding.ad.logo')}" /></div>
                  <div class="bid_adImg_input_msg input_msg"></div>
                  <div class="option_content">
                    <img src="images/defaultImgs/show.jpg" id="bid_adImg_preview" style="width:240px;height:180px;"/><br/>
