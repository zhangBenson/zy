...
<div class="blogframe">
    ...
    <div id="courseinfo">
        <p><s:property value="%{getText('show.blog.host.username')}"/>：<b><s:a action="userBlog"><s:param name="user.id"
                                                                                                          value="myShow.owner.id"/><s:property
                value="myShow.owner.nickName"/></s:a></b></p>

        <p><s:property value="%{getText('show.start.time')}"/>：<b><s:date name="myShow.showDate"
                                                                          format="%{getText('dateformat')}"/></b></p>

        <p><s:property value="%{getText('show.attention.member.num')}"/>：<b><s:property value="myShow.fansNum"/></b></p>

        <p><s:property value="%{getText('show.finished.terms.num')}"/>：<b><s:property value="myShow.showTermsNum"/></b>
        </p>
    </div>
    <div id="evaluate">
        <table>
            <tr>
                <td class="htitle"><s:property value="%{getText('label.score')}"/>：</td>
                <td><s:property value="myShow.synthetical"/></td>
            </tr>
            <tr>
                <td class="htitle"><s:property value="%{getText('label.interest')}"/>：</td>
                <td><s:property value="myShow.interest"/></td>
            </tr>
            <tr>
                <td class="htitle"><s:property value="%{getText('label.practivity')}"/>：</td>
                <td><s:property value="myShow.available"/></td>
            </tr>
            <tr>
                <td class="htitle"><s:property value="%{getText('label.interactivity')}"/>：</td>
                <td><s:property value="myShow.interaction"/></td>
            </tr>
        </table>
    </div>
    <div id="course_share">
    ...
    <div class="reservation_external">
        <div class="external_inner">
            <ul>
                ...
                <li><s:property value="%{getText('label.course.total')}"/><s:property
                        value="course.totalHours"/><s:property
                        value="%{getText('label.course.class.passed')}"/><s:property
                        value="course.finshedClassNum"/><s:property value="%{getText('label.course.you.can')}"/></li>
                <li><a id="course_reg"
                       href="initCourseconfirm.html?course.id=<s:property value="course.id"/>"><s:property
                        value="%{getText('label.course.register')}"/></a></li>
...
<div class="blogframe2" id="reservepanel">
    ...
    <h4><s:property value="%{getText('button.booking.our.course')}"/></h4>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <s:iterator value="course.classes">
                    <tr>
                        ...
                        <td width="140px"><s:property value="%{getText('label.day.of.week.'+weekDay)}"/>
                            &nbsp;&nbsp;<s:date name="date" format="%{getText('dateformat.hour.minute')}"/></td>
                    </tr>
                </s:iterator>
            </table>
        </div>
            ...
            <div class="reserveRight">
                <table>
                    <tr>
                        ...
                        <td><s:textfield id="courseReservationInitial" name="courseReservation.initial" readonly="true"
                                         cssClass="Wdatepicker"
                    ...
                    <tr>
                        <td></td>
                        <td colspan="3"><input type="submit" class="reserve_submit"
                                               value="<s:property value="%{getText('button.book.course')}"/>"
                                               onclick="return checkCourseReservation();"/>&nbsp;&nbsp;<span
                                class="reserve_close"><s:property value="%{getText('button.close')}"/></span></td>
                    </tr>
                </table>
            </div>
        </s:form>
...
<s:form action="recommendShow" method="POST">
    ...
    <div class="blogframe2" id="recommdatepanel">
        <img src="images/blogindex/frame2top.gif"/>
        <h4><s:property value="%{getText('show.recommend.my.show')}"/></h4>
        ...
        <div class="recommdatepanel_inner">
            <table>
                ...
                <tr>
                    ...
                    <td><input class="recommdate_email" type="text" name="emails" onblur="checkEmail(this);">
                </tr>
                <tbody class="added_line"></tbody>
                <tr>
                    <td align="right" valign="top"><s:property value="%{getText('button.message')}"/>&nbsp;</td>
                    <td><textarea class="recommdate_message"
                                  placeholder="<s:property value="%{getText('show.recommend.default.content')}"/>"
                                  name="comments"></textarea></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input class="recommdate_submit" type="submit" onclick="return checkCourseRecommend();"
                               value="<s:property value="%{getText('button.submit')}" />"/>&nbsp;&nbsp;<span
                            class="recommdate_close recommdatebtn"><s:property
                            value="%{getText('button.close')}"/></span></td>
                </tr>
            </table>
        </div>
        <img src="images/blogindex/frame2bottom.gif" class="frame1bottom"/>
    ...
    <div style="display:inline;margin-left:15px; margin-bottom:5px;">
        <table width="96%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="introcon">
                    <p>
                        <s:a action="userBlog" target="_blank"><s:param name="user.id" value="myShow.owner.id"/><img
                                src="<s:property value="myShow.owner.pic" />" height="56px" width="56px"
...
<div class="blogframe2">
    ...
    <div id="dynamicDiv">
        ...
        <div id="communicatepanel" class="tab_3_content"><img src="images/blogindex/QA.gif" width="60" height="60"
                                                              style="float:left;"/>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" class="infolist">
                                <tr>
                                    ...
                                    <td class="uploadtime"><s:property
                                            value="%{getText('label.updatetime')}"/>：<s:date name="provideTime"
                                                                                             format="%{getText('global.display.datetime')}"/></td>
                                    <td class="uploadtime"><s:property
                                            value="%{getText('label.approved.time')}"/>：<s:date name="estimateTime"
                                                                                                format="%{getText('global.display.datetime')}"/></td>
                                </tr>
                                <tr>
...
<div class="blogframe2 ubd_2">
    <img src="images/blogindex/frame2top.gif"/>
    <h4 style="width:300px;"><s:property value="%{getText('blog.message.board')}"/></h4>
            ...
            <ul class="ul_out" id="message_list_ul">
                    ...
                    <li class="li_out">
                        <ul class="ul_in">
                            ...
                            <li class="li_3">
                                ...
                                <span class="span_2"><s:date name="commentTime"
                                ...
                                <s:if test="myShow.owner.id == #session.userID && commenter.id != #session.userID">
                                    <span class="span_3"><a
                                            onclick="replyToComment('<s:property value="commenter.nickName"/>',
                                                <s:property value="commenter.id"/>)"><s:property
                ...
                <s:if test="commentsNum != 0">
                    <s:if test="!commentsNumOverflow">
                        <a class="more_or_close" onclick="getMoreComments();"><s:property
                                value="%{getText('blog.comments.more.result')}"/>&gt;&gt;</a>
                    </s:if>
                    <s:elseif test="commentsNumOverflow && commentsNum>=10">
                        <a class="more_or_close" onclick="rollBack();">&lt;&lt;<s:property
