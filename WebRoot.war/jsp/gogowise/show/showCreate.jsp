      ...
      <div class="create_content">
          <ul class="content_courseInfo">
              <li>
                  ...
                  <div class="option_content"><s:textfield cssClass="long_text_field" id="show_showName" name="myShow.name"/>
                  </div>
              </li>
              <li>
              ...
              <li class="long_select_li">
                  ...
                  <div class="option_content">
                     <div class="option_content">
                      <s:select list="#{1:getText('myShow.label.type.1'),2:getText('myShow.label.type.2'),3:getText('myShow.label.type.3'),4:getText('myShow.label.type.4')}" cssClass="short_text_field" listKey="key"
              ...
              <li class="long_select_li">
                  ...
                  <div class="option_content"><s:textfield id="show_showDate" name="myShow.showDate" readonly="true" value="" cssClass="Wdatepicker short_text_field"/></div>
              </li>
              <li class="long_select_li">
                  <div class="option_tittle"><s:property value="%{getText('show.start.time')}"/></div>
                  <div class="show_startTime_input_msg input_msg"></div>
                  <div class="option_content"><s:textfield id="show_startTime" name="myShow.showFixedTime" readonly="true" value="" cssClass="WTime short_text_field"/></div>
              </li>
              <li class="long_select_li">
              ...
              <li>
                  ...
                  <div class="option_content">
                    <img src="images/nopic.jpg" id="show_log_preview" onerror="javascript:this.src='images/nopic.jpg'"/><br/>
