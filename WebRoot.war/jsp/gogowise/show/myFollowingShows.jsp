        ...
        <div class="course_item">
            ...
            <div class="infoWrap">
                ...
                <p class="time">
                    ...
                    <a class="manage_course" id="" href="addShowEvent.html?myShow.id=<s:property value="id"/>"><s:property value="%{getText('add.show.new.events')}"/></a>
                </p>
            </div>
        </div>
                       ...
                       <li>
                          <div class="highlight">
                              <div class="area">
                                  ...
                                  <input type="text" css="highlight_file" name="showNewEvent.title" id="courseNewEvent_title<s:property value="#idx.index"/>"/>
                              </div>
                              <div class="area">
                                  ...
                                  <%--<input type="file" css="highlight_file" name="" id="courseNewEvent_logUrl"/>--%>
                                      ...
                                      <input type="hidden" id="courseNewEvent_logoUrl<s:property value="#idx.index"/>" name="showNewEvent.logoUrl"/>
                              </div>
                              <div class="area">
                                  <p><s:property value="%{getText('term.info.update.right.there')}"/><span class="live_term_highlight_tip"></span></p>
                                  <textarea name="showNewEvent.content" id="courseNewEvent_content<s:property value="#idx.index"/>"></textarea>
                              </div>
                              <div class="handle">
