...
<div class="square_container">
    ...
    <div class="head_img">
        <p class="desc"><span class="big"><s:property value="%{getText('index.second.image.intro1')}"/></span><br/><br/><s:property value="%{getText('index.second.image.intro2')}"/></p>
        <p class="handle">
            <a  class="handle_1" href="initShowCreate.html"><s:property value="%{getText('show.creation')}"/></a>
            <a  class="handle_2" href="showRangeBoard.html"><s:property value="%{getText('show.ad.bidding.in.square')}"/></a>
        </p>
    </div>
        ...
        <div class="cont">
            <ul>
                ...
                <li>
                    ...
                    <a class="nick" href="userBlog.html?user.id=<s:property value="owner.id"/>" title="<s:property value="owner.nickName"/>"><s:property value="owner.nickName"/></a>
                    <span class="date"><s:date name="firstFutureTerm.startTime" format="%{getText('dateformat.forclass')}"/></span>
    ...
    <div class="highlight">
        ...
        <ul>
            <s:iterator value="goGoWiseAnnounces">
               <li><div class="dot"></div><a href="announceRead.html?goGoWiseAnnounce.id=<s:property value="id"/>" title="<s:property value="title"/>" class="goGoWiseAnnounce_newEvents"><s:property value="title"/></a></li>
            </s:iterator>
        </ul>
    </div>
            ...
            <ul>
               <s:iterator value="newestShows">
                   <li>
                        ...
                        <a class="title" href="showBlog.html?myShow.id=<s:property value="id"/>" title="<s:property value="name"/>"><s:property value="name"/></a>
                        <s:if test="!userFocused"><a class="reserve" href="javascript:;" onclick="becomeFans(this,<s:property value="id"/>);"><s:property value="%{getText('user.add.focus')}"/></a></s:if>
                        <s:else><a class="reserve" href="javascript:;" onclick="becomeFans(this,<s:property value="id"/>);"><s:property value="%{getText('user.add.focused')}"/></a></s:else>
                        <div class="msg">
                            <span class="num num1"><s:property value="totalInviteNum"/>&nbsp;<s:property value="%{getText('user.inviteNum')}"/></span>
                            <span class="num num2"><s:property value="fansNum"/>&nbsp;<s:property value="%{getText('onlive.fensi')}"/></span>
                        </div>
                        <span class="date"><s:date name="firstFutureTerm.startTime" format="%{getText('dateformat.forclass')}"/></span>
                        <a class="teacher" href="userBlog.html?user.id=<s:property value="owner.id"/>" title="<s:property value="owner.nickName"/>"><img src="<s:property value="owner.pic"/>"/></a>
                   </li>
               </s:iterator>
            </ul>
        </div>
        ...
        <div class="cont">
            <ul>
                ...
                <s:iterator value="hotestShows">
                    <li class="thesame">
                        <a class="thesame img" href="showBlog.html?myShow.id=<s:property value="id"/>" title="<s:property value="name"/>"><img src="<s:property value="logoUrl"/>"/></a>
                        <a class="thesame title" href="showBlog.html?myShow.id=<s:property value="id"/>" title="<s:property value="name"/>"><s:property value="name"/></a>
                        <span class="thesame reg"><s:property value="totalInviteNum"/>&nbsp;<s:property value="%{getText('show.total.invite.num.in.all')}"/></span>
                        <span class="thesame date"><s:date name="firstFutureTerm.startTime" format="%{getText('dateformat.forclass')}"/></span>
                        <a class="teacher" href="userBlog.html?user.id=<s:property value="owner.id"/>" title="<s:property value="owner.nickName"/>"><img src="<s:property value="owner.pic"/>"/></a>
                    </li>
                </s:iterator>
            </ul>
    ...
    <div class="highlight sc_f" style="margin-top: 20px;">
        ...
        <ul>
            <s:iterator value="showNewEvents">
               <li><div class="dot"></div><a href="showEventRead.html?showNewEvent.id=<s:property value="id"/>" title="<s:property value="title"/>" class="show_newEvents"><s:property value="title"/></a></li>
            </s:iterator>
        </ul>
    </div>
    <%--<div class="ad_img"></div>--%>
