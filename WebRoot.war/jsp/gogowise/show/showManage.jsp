...
<div class="course_create_container">
      <p class="create_content_title">
            <s:property value="%{getText('personal.show.management')}"/>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="addShowHight.html?myShow.id=<s:property value="myShow.id"/>">添加个人秀新鲜事</a>
      </p>
  <s:form action="manageShow" method="POST" enctype="multipart/form-data">
      ...
      <div class="create_content">
          <ul class="content_courseInfo">
              ...
              <li>
                  ...
                  <div class="option_content"><s:textfield cssClass="long_text_field" id="step2_course_name" name="myShow.name" disabled="true" type="text"/>
                  </div>
              </li>
              <li>
              ...
              <li class="long_select_li">
                  ...
                  <div class="option_content">
                      <input type="text" id="show_showDate" name="myShow.showDate" disabled="true" value="" class="Wdatepicker short_text_field"/>
                  </div>
              </li>
              <li class="long_select_li">
                  <div class="option_tittle"><s:property value="%{getText('show.start.time')}"/></div>
                  <div class="show_startTime_input_msg input_msg"></div>
                  <div class="option_content"><input type="text" id="show_startTime" name="myShow.showFixedTime" value="" readonly="true" class="WTime short_text_field"/></div>
              </li>
              <li class="long_select_li">
              ...
              <li>
                  ...
                  <div class="option_content">
                    <img src="<s:property value="myShow.logoUrl"/>" id="show_log_preview" onerror="javascript:this.src='images/nopic.jpg'"/><br/>
      ...
      <div class="create_back_forth">
          <s:submit cssClass="submit_btn" onclick="return checkShowInfoForm();" value="%{getText('course.maintenance.confirm')}"/>
      </div>
  </s:form>
</div>
