...
<div class="highlight" >
    <div class="dir">
         <p class="create_content_title">
            <s:property value="%{getText('personal.show.management')}"/>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="addShowHight.html">添加个人秀新鲜事</a>
         </p>
    </div>
    ...
    <s:form action="saveShowNewEvent" id="show_newEvent_form" enctype="multipart/form-data" method="post">
        ...
        <div class="area">
            <p>花絮标题</p><div style="color: red;" id="showNewEvent_title_msg"></div>
        ...
        <div class="area">
            <p>花絮内容<span class="live_term_highlight_tip"></span></p><div style="color: red;" id="showNewEvent_content_msg"></div>
            <textarea name="showNewEvent.content" id="showNewEvent_content"></textarea>
        </div>
        <div class="handle">
            <a href="javascript:;" class="submit" onclick=" return saveTitbits();"><s:property value="%{getText('term.info.save')}"/></a>
