...
<div class="mf_2">
    <div class="overview cf">
        <div class="sub_info fl">
            <p class="number"><s:property value="totalNumOfViewOnlive"/><s:property
                    value="showFansNum"/><span><s:property value="%{getText('onlive.fensi')}"/></span></p>

            <p class="describe"><s:property value="%{getText('people.watched.my.show')}"/></p>
        </div>
        <div class="sub_info fl">
            <p class="number"><s:property value="totalNumOfLiveChannels"/><s:property
                    value="showTermsNum"/><span><s:property value="%{getText('the.static.terms')}"/></span></p>
        ...
        <div style="">
            <div class="course_item">
                ...
                <div class="infoWrap">
                    ...
                    <p class="maintenance">
                        <s:property value="fansNum"/><s:property
                            value="%{getText('the.num.of.focus.on.live.channel')}"/>
                        <strong>•</strong>
                    ...
                    <p class="time">
                        <a class="manage_course"
                           href="initShowManage.html?myShow.id=<s:property value="id"/>"><s:property
                                value="%{getText('personal.show.management')}"/></a>
                        ...
                        <a class="manage_course"
                           href="showNewEventsManage.html?myShow.id=<s:property value="id"/>"><s:property
                                value="%{getText('show.new.events.management')}"/></a>
                        <a class="manage_course" href="initShowAds.html?myShow.id=<s:property value="id"/>"><s:property
                                value="%{getText('show.ad.management')}"/></a>
                    </p>
                </div>
            </div>
        </div>
