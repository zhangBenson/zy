...
<div id="cnt_cntai">
    <ul class="cntai_first_ul">
        <s:iterator value="myShows">
            <li>
                <ul class="sub_ul">
                    <li class="li_0"><s:a action="showBlog" target="_blank"><s:param name="myShow.id" value="id"/><img
                    ...
                    <li class="li_3"><s:property value="%{getText('show.creation.time')}"/>：<span
                            class="orangeWords"><s:date name="publishTime" format="%{getText('dateformat')}"/></span>
                    </li>
                    <li class="li_3"><s:property value="%{getText('show.total.terms')}"/>：<span
                            class="orangeWords"><s:property value="finishedTermsNum"/></span></li>
                    ...
                    <li class="li_4"><input type="button"
                                            value="<s:property value="%{getText('show.ad.management')}" />"></li>
                </ul>
