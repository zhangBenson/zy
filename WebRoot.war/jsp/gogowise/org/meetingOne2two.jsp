...
<s:form>
    ...
    <div class="titleWrapper">
        <h2>
            <s:property value="%{getText('org.matters.video.meeting')}"/>(<a href="orgBlog.html?org.id=<s:property value="orgMeeting.organization.id"/>" target="_blank"><s:property value="orgMeeting.organization.schoolName"/></a>)
        </h2>
        <h3>
    ...
    <div class="flashWrapper">
        <iframe scrolling=no frameborder="0"  src="partyMessage.html" id="messages"  name="messages"  style="position:absolute;z-index:2;background-color: white;top:355px;left:520px;*top:350px;*left:520px;width:430px; height:200px;*width:425px; *height:200px;margin: 0px;tapping:0px"></iframe>
