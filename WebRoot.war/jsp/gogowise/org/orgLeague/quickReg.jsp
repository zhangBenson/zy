        ...
        <s:form action="saveThirdStep" theme="simple" id="responserForm" enctype="multipart/form-data" validate="true"
            ...
            <ul class="principalMsg">
                <li class="quick_long_li">
                    ...
                    <div class="input_content"><s:textfield cssClass="inputName" id="secondStepName" name="org.responsiblePerson.userName"/></div>
                </li>
                <li class="quick_long_li">
                ...
                <li class="quick_long_li">
                     ...
                     <div class="input_content"><s:textfield id="secondStepContact" cssClass="inputTel" name="org.responsiblePerson.telphone"/></div>
                </li>
                <li class="quick_long_li">
