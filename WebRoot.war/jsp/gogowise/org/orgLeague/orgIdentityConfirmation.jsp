...
<s:form validate="true" theme="css_xhtml" method="POST" action="orgIdentityConfirm">
  ...
  <div id="regright">
      ...
      <p class="inputTips"><s:property value="%{getText('msg.email')}"/><span class="errorinfo"  id="yzemail">*</span>
          <span id="emailNotExist" style="display: none;">
              <s:property value="%{getText('identity.is.not.exist')}"/><a href="####" onclick="addRepswAndnickName();" style="color:#ff0000;"><s:property value="%{getText('link.here')}"/></a><s:property value="%{getText('message.to.complete')}"/>
          </span>
