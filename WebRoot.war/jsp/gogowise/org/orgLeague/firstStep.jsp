...
<div id="orgLeagueDiv">
  ...
  <div id="orgCenterDiv">
    <div class="tiphead"> <span><s:property value="%{getText('org.sayhello')}"/></span><s:property value="%{getText('orgleague.need')}"/></div>
    ...
    <div class="ifReady">
      <form action="" method="post">
        ...
        <a href="initThirdStep.html"><div class="ifReadyYes"><span class="yesword"><s:property value="%{getText('lable.yesno.true')}"/></span></div></a>
        <a href="index.html"><div class="ifReadyNo"><span class="noword"><s:property value="%{getText('lable.yesno.false')}"/></span></div></a>
      </form>
    </div>
    <ul class="orgStep">
