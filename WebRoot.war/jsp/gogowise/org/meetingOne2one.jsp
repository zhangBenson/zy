...
<s:form>
    ...
    <div class="flashWrapper">
        <iframe scrolling=no frameborder="0" src="partyMessage.html" id="messages" name="messages"
                style="position:absolute;z-index:2;background-color: white;top:355px;left:520px;*top:350px;*left:520px;width:430px; height:200px;*width:425px; *height:200px;margin: 0px;tapping:0px"></iframe>
