...
<s:form>
    ...
    <div class="flashWrapper">
        <iframe scrolling=no frameborder="0"  src="partyMessageOne2Three.html" id="messages"  name="messages"  style="position:absolute;z-index:2;background-color: white;top:410px;left:530px;*top:410px;*left:530px;width:405px; height:230px;*width:405px; *height:230px;"></iframe>

        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" name="Girl" width="1004" height="730" id="Girl" wmode="transparent" style="position:relative;z-index:3;" >
