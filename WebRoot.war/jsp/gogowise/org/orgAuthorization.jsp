    ...
    <div class="auth_left">
                ...
                <table>
                    ...
                    <s:iterator value="orgTeachers">
                        <tr class="tearcher_content">
                            ...
                            <td class="td_email"><s:property value="teacher.email"/>
                            <td/>
        ...
        <div class="auth_left_2">
            <div class="addlist">
                ...
                <table>
                    <tr class="tittle">
                        <td><span class="option_tittle">邮箱</span><span class="authorization_input_msg input_msg"></span>
                        </td>
                        <td>昵称</td>
                        <td>授权</td>
                    </tr>
                    <tr class="addlist_msg_tr">
                        <td class="addlist_input">
                            <s:textfield name="orgTeacher.teacher.email" onblur='checkAuthorizationEmail(this);'
                                         cssClass="authorization_input"/>
            ...
            <div class="auth_left_4"><input type="submit" value="保存修改"
                                            onclick="javascript:document.getElementById('form1').submit();"/></div>
        </div>
    </div>
</div>
