            ...
            <s:iterator value="hotCourses">
                <li class="course">
                    <s:a action="voaCourseBlog"><s:param name="course.id" value="id"/>
                        <img src="<s:property value="logoUrl"/> " title="<s:property value="description"/>"  class="courseImg"/>
                    </s:a>
    ...
    <div class="ubd_3_1">
        ...
        <ul>
            <s:iterator value="hotTeachers">
                 <li><img src="<s:property value="pic"/>" class="portraitImg" title="<s:property value="nickName"/>"/></li>
            </s:iterator>
            <li class="li_turn"><a href="javascript:;" class="turn_left" title="上一页"></a><a href="javascript:;"class="turn_right" title="下一页"></a></li>
        </ul>
    </div>
    <div class="ubd_3_2">
        <h4>所有老师</h4>
