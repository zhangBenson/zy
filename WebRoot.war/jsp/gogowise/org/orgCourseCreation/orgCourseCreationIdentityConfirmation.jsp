...
<s:form validate="true" theme="css_xhtml" method="POST" action="orgCourseCreationIdentityConfirm">
  ...
  <div id="regright">
      ...
      <p class="inputTips"><s:property value="%{getText('msg.email')}"/><span class="errorinfo"  id="yzemail">*</span>
          <span id="emailNotExist" style="display: none;">
              <s:property value="%{getText('identity.is.not.exist')}"/><a href="####" onclick="addRepswAndnickName();" style="color:#ff0000;font-size: 14px;"><s:property value="%{getText('link.here')}"/></a><s:property value="%{getText('message.to.complete')}"/>
          </span>
    ...
    <p class="nextButton"><input type="submit" name="button" id="btn1" onclick="return checkForm();" value="<s:property value="%{getText('button.log.in')}"/>" />  <a href="initRepassword.html"><span id="forgotPwd" style="display:inline;"><s:property value="%{getText('link.forget.pwd')}"/>？</span></a>
    </p>
   </div>
  </div>
</div>
