...
<div class="rightcontent">
             ...
             <s:iterator value="courses" status="idx">
              <div class="blogframe">
                  ...
                  <div class="courseLogo"><img src="<s:property value="logoUrl"/>" onerror="javascript:this.src='images/nopic.jpg'"/></div>
                  <div class="course_info">
                      <div class="course_tittle">
                          ...
                          <div class="teacher_student_list">
                              <table cellpadding="0" cellspacing="0">
                                <tr class="table_tittle"><td colspan="3"  width="370px;"><s:property value="%{getText('label.forcast.lecturer')}" /></td></tr>
                                <tr><td width="150px"><s:property value="%{getText('msg.email')}"/></td>
                                    <td width="140px"><s:property value="%{getText('menber.reg.nickName')}"/></td>
                                    <td width="70px"><s:property value="%{getText('label.status')}"/></td></tr>
                                <tr><td width="150px"><span class="orangeWords"><s:property value="teacher.email"/></span></td>
                                    <td width="140px"><span class="orangeWords"><s:property value="teacher.nickName"/></span></td>
                                    <td width="70px"><span class="orangeWords"><s:property value="%{getText('label.interviewee.accept.'+teacherAccept)}"/></span></td></tr>
                                <br/>
                                <tr class="table_tittle"><td colspan="3"  width="370px;"><s:property value="%{getText('label.student')}" /></td></tr>
                                <tr><td width="150px"><s:property value="%{getText('msg.email')}"/></td>
                                    <td width="140px"><s:property value="%{getText('menber.reg.nickName')}"/></td>
                                    <td width="70px"><s:property value="%{getText('label.status')}"/></td></tr>
                                ...
                                <tr>
                                    <td width="150px"><span class="orangeWords"><s:property value="invitedStudentEmail"/></span></td>
                                    <td width="140px"><span class="orangeWords"><s:property value="student.nickName"/></span></td>
                                    <td width="70px"><span class="orangeWords"><s:property value="%{getText('label.interviewee.accept.'+acceptInvite)}"/></span></td>
                                </tr>
                                </s:iterator>
                      ...
                      <div class="course_detail">
                          <table cellpadding="5" cellspacing="5">
                              <tr><td><s:property value="%{getText('label.online.class.startdate')}"/>：<span class="orangeWords"><s:date name="startDate" format="%{getText('dateformat')}"/></span></td><td><s:property value="%{getText('label.online.class.enddate')}"/>：<span class="orangeWords"><s:date name="finishDate" format="%{getText('dateformat')}"/></span></td></tr>
                              <tr><td><s:property value="%{getText('course.sequence.latest',{classOneTheCornerSequence})}"/>：<span class="orangeWords"><s:date name="classOnTheCorner.date" format="%{getText('dateformat.forclass')}"/></span></td><td><s:property value="%{getText('label.salary.status')}"/>：<span class="orangeWords"><s:property value="%{getText('label.payed')}"/></span></td></tr>
                          </table>
                      </div>
                      ...
                      <div class="course_manipulate">
                           <s:a action="startSupervision" cssClass="course_supervise_btn"><s:param name="courseClass.id" value="classOnTheCorner.id"/><s:property value="%{getText('button.start.supervision')}" /></s:a>
