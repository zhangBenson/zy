...
<div class="interviewContainer">
  ...
  <div class="interviewDetail">
  	<ul>
        <li><div class="option_tittle"><s:property value="%{getText('select.org')}"/></div><br/>
         <p class="option_content"><s:select name="orgMeeting.organization.id" list="orgs" listKey="key" cssClass="interview_input" listValue="value"/></p></li>
        <li><div class="option_tittle"><s:property value="%{getText('label.meeting.host.email')}"/></div><span class="interviewer_input_msg input_msg"></span><br />
          <p class="option_content"><input name="orgMeeting.hostManEmail" type="text" class="interview_input interviewer_input" /></p>
        </li>
        <li><div class="option_tittle"><s:property value="%{getText('label.meeting.attendee.email')}"/></div><div class="interviewer_add"><s:property value="%{getText('interview.add')}"/></div><span class="interviewee_input_msg input_msg"></span>
            <p class="option_content">
            <table>
                <tr><td><input name="memberEmails" type="text" onblur='checkIntervieweeEmail(this)' class="interview_input interviewee_input" /></td></tr>
                <tbody class="interviewee_email"></tbody>
            </table>
            </p>
        </li>
        <li><div class="option_tittle"><s:property value="%{getText('label.meeting.description')}"/></div><span class="interview_textarea_msg input_msg"></span><div class="interview_content_wordsLeft"></div><br/>
          <p class="option_content"><textarea class="interview_textarea" name="orgMeeting.content"></textarea></p>
        </li>
        <li><div class="option_tittle"><s:property value="%{getText('label.meeting.time')}"/></div><span class="interviewTime_input_msg input_msg"></span><br />
          <p class="option_content"><s:textfield id="" name="orgMeeting.startTime" readonly="true" cssClass="Wdatepicker interview_input interviewTime_input" onfocus="WdatePicker({lang:'%{getText('language')}',startDate:'%y-%M-01 00:00:00',dateFmt:'%{getText('dateformat.forclass')}',alwaysUseStartDate:true})"/></p>
        </li>
        <li>
          <input type="submit" onclick="return checkForm();" class="interview_submit" value="<s:property value="%{getText('button.publish.meeting')}"/>"/>
        </li>
    </ul>
  </div>
  </s:form>
