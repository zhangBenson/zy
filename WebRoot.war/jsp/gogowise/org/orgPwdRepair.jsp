...
<s:form validate="true" theme="css_xhtml" method="POST" action="orgBackEndUserConfirm">
  ...
  <div id="regright">
      <div id="regrightCont">
         ...
         <p class="inputTips"><input name="checkbox" type="checkbox" value="checked" id="checkbox" checked="checked"/>
              <a href="<%=request.getContextPath()%>/jsp/gogowise/Clause.htm" class="boxy"><s:property value="%{getText('read')}"/></a></p>
         </div>
         <p class="nextButton">
             <input type="submit" name="button" id="btn1" onclick="return checkForm();" value="<s:property value="%{getText('button.next')}" />" />
         </p>
