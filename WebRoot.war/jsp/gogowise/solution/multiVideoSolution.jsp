...
<div id="solutionWrap" >
        ...
        <div id ="contentLeft">
            ...
            <ul>
              ...
              <div id="StartUse" class="StartUseIt"><a class="begin_live1 act_btn1" href="openUserChannelResult.html"><s:property value="%{getText('contentLeft.param9')}"/></a></div>
        ...
        <div id ="contentRight">
             <div id="privateApply">
                     ...
                     <div id="companyUse">
                               ...
                               <div class="png1"><img src="images/solution/companyMonitoring.png" alt="title.solution.company.image">   </div>
             ...
             <div id="OperationalPolicy">
                 ...
                 <table id="table" cellspacing="0" cellpadding="0" >
                           <tr><th><s:property value = "%{getText('OperationalPolicy.table.param0')}"/>1</th><td align=left>9.8<s:property value = "%{getText('OperationalPolicy.table.param1')}"/></td></tr>
                           <tr><th><s:property value = "%{getText('OperationalPolicy.table.param0')}"/>2</th><td align=left>98<s:property value = "%{getText('OperationalPolicy.table.param2')}"/></td></tr>
