...
#rightcontent{ border:0px; width:800px;}
#all{ width:800px;}
#alls{ width:800px;}
#mains{ width:800px; float:left; border-color:#999; border-style:dotted; border-width:1px; margin:4px 0; float:left;}
 #mainss{ width:800px; float:left; border-color:#999; border-style:dotted; border-width:1px; margin:4px 0; float:left;}
.mycompetition{ width:800px;background:#F6F6F6; font-family:"微软雅黑", "宋体"; color:#444; font-size:13px;}
.mycompetition td{ height:30px;}
.tdleft{ text-align:right; width:80px; padding-right:6px; color:#000;}
.tdright{ text-align:left; width:130px; color:#069;}
...
<div id="mains">
  ...
  <tr>
    ...
    <td colspan="3" class="tdright"><s:property value="competitionPhase.competition.description"/>
      </td>
    </tr>
</table>
</div>
...
<s:iterator value="competitionAudiences">
    ...
    <div id="mainss">
      ...
      <tr>
          <td class="tdleft">参赛类型：</td>
        <td class="tdright"><s:property value="%{getText('singup.type.'+competitionSession.allocationType)}"/></td>
        <td class="tdleft">倒计时：</td>
        <td class="tdright"><s:property value="competitionSession.remainTime"/></td>
      </tr>
      <tr>
        <td class="tdleft">内容：</td>
        <td colspan="3" class="tdright"><s:property value="competitionSession.competitionPhase.competition.description"/>
          </td>
        </tr>
    </table>
    </div>
