    ...
    <div class="stepCont step1Cont">
        ...
        <div class="pic_2">
            ...
            <div class="repeat_course">
                <a href="javascript:;"><s:property value="%{getText('label.select.repeat')}"/>?</a>
            </div>
            <div class="storeWrap">
                <input type="button" class="store_btn" id="step1_store" value="保存"/>
                <span class="tip_words" id="step1_store_msg"/>
            </div>
        </div>
        ...
        <div class="stepCont">
            ...
            <div class="pic_2">
                ...
                <div class="storeWrap">
                    ...
                    <span class="tip_words" id="step2_store_msg"/>
                </div>
            </div>
            <div class="pic_2 after_store" id="step2_store_cont">
                <ul>
                    ...
                    <li><s:property value="%{getText('course.info.of.teaching.book')}"/>：<span class="orange_words"
                                                                                               id="store_courseTeachingBook"></span>
                    </li>
...
<div class="content_clause">
    <input name="checkbox" type="checkbox" value="" id="clauseCheckbox"/>
...
<div class="create_confirm">
    <input type="button" class="submit_btn" onclick="publishCourse();" value="创建课程"/>
</div>
