...
<head>
    ...
    <style type="text/css">
        ...
        #firstnews li a:hover, #firstnews li a:active {
            color: #999;
        }
        ...
        #secondnews li a:hover, #firstnews li a:active {
            color: #F0F;
        }
        ...
        .title1 a:hover, #newjoin .title1 a:active {
            color: #003300
        }
        ...
        #suggest {
            ...
            height: 270px;
            float: left;
            background: url(images/know.gif) no-repeat top;
            margin-top: 4px;
            margin-left: 1px;
        }
        ...
        #songlist li {
            list-style-image: url(images/document_mp3.png);
            height: 25px;
            margin-top: 5px;
        }
        ...
        #songlist li a:hover, #songlist li a:active {
            text-decoration: underline;
            color: #CC0099;
        }
        ...
        h1 {
            height: 24px;
            border-bottom: #006633 dotted 2px;
            padding-bottom: 2px;
            margin-bottom: 6px;
        }
...
<div id="all">
    ...
    <div id="main">
        <div id="mains">
            <div id="first">
                <div id="inform"><span><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    只要能上网，只要你想唱，足不出户，立马开启梦想之旅！小小的渴望，大大的梦想，让音乐于你我间记录，让音乐伴你我同成长！一个表演的舞台，一颗渴望歌唱的心灵，交汇碰撞出青春的最强音！用歌声表达情绪，用音乐宣泄情感，用激情撼动梦想的极限
                    ! </p></span></div>
		<span id="movie">
                        <s:if test="singUped">
            ...
            <div id="hotnews">
                <div id="left">
                    <h1><img src="images/item2.gif" width="25"/><span id="title2" class="title1"><a
                            href="#">最新热点</a></span></h1>
            ...
            <div id="suggest"><span id="title2" class="title1"><a href="#">推荐试听</a></span>
            ...
            <div class="newjoin" style="width:1000px;">
                <div class="hot">
                    <div class="title1" style="width:452px;"><img src="images/item.gif" width="19" height="18"/><a
                            href="#">最新加入</a></div>
                ...
                <div class="hot">
                    <div class="title1" style="width:530px;"><img src="images/item.gif" width="19" height="18"/><a
                            href="#">奖项设置</a></div>
