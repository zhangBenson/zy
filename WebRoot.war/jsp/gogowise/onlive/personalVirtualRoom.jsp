...
<div id="room_title">
    ...
    <p>
        <s:if test="personalOnlive.owner.id == #session.userID">
            <a id="addLiveTitle" href="#add_live_title"><s:property
                    value="%{getText('gogowise.personalOnlive.title')}"/></a>
            <a id="addLiveAnnounce" href="#add_live_announce"><s:property
                    value="%{getText('per.onlive.announce')}"/></a>
            <a href="addLiveGoingAnnouncement.html" target="_blank"><s:property
                    value="%{getText('live.trailer.announce')}"/></a>
        </s:if>
        <a id="guest_invite" href="#invite_student_container"><s:property
                value="%{getText('personal.onlive.recommend.friend')}"/></a>
    </p>
</div>
    ...
    <div id="panel_flash">
        <div class="flash">
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                    ...
                    width="410" height="350" name="Girl" id="Girl" wmode="transparent">
                <param name="movie" value="<s:property value="flashPatch"/>"/>
                <param name="quality" value="high"/>
                <param name="wmode" value="transparent"/>
                <param name="allowFullScreen" value="true"/>
                <embed src="<s:property value="flashPatch"/>" allowFullScreen="true" width="410" height="350"
        ...
        <div class="host_desc">
            <a class="img" href="userBlog.html?user.id=<s:property value="personalOnlive.owner.id"/>" target="_blank">
                <img id="share_pic" src="<s:property value="personalOnlive.owner.pic"/>"
                     title="<s:property value="personalOnlive.owner.nickName"/>"/>
            </a>
            ...
            <span><s:property value="personalOnlive.owner.fansNum"/><s:property
                    value="%{getText('user.add.focus')}"/></span>
            <s:if test="personalOnlive.owner.id != #session.userID">
                <a class="submit_btn"
                   onclick="becomeFans(this,<s:property value="personalOnlive.owner.id"/>);"><s:property
        ...
        <div class="onliveList">
            ...
            <ul>
                <s:iterator value="personalOnlives">
                    <li>
                        <a href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="id"/>" target="_blank"
                           class="img"><img src="<s:property value="owner.pic"/>"/></a>
                        <a href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="id"/>" target="_blank"
                           class="title"><s:property value="owner.nickName"/></a>
                    </li>
                </s:iterator>
            </ul>
        </div>
    ...
    <div id="chat_music">
        ...
        <div class="chat" id="cmcont1">
            ...
            <div class="msg" id="msg_handle">
                ...
                <span class="msg_to_all" id="msg_to_all" alt="1" style="cursor: pointer;"><s:property
                        value="%{getText('word.all.person')}"/></span>
                ...
                <div class="msg_face">
                    ...
                    <div class="defaultFacePanel" id="defaultFacePanel" style="display: none;">
                        ...
                        <a class="faceIcon" facecode="[face2]" title="[face2]" href="###"></a><a class="faceIcon"
                                                                                                 facecode="[face3]"
                                                                                                 title="[face3]"
                                                                                                 href="###"></a><a
                            class="faceIcon" facecode="[face4]" title="[face4]" href="###"></a><a class="faceIcon"
                                                                                                  facecode="[face5]"
                                                                                                  title="[face5]"
                                                                                                  href="###"></a><a
                            class="faceIcon" facecode="[face6]" title="[face6]" href="###"></a><a class="faceIcon"
                                                                                                  facecode="[face7]"
                                                                                                  title="[face7]"
                                                                                                  href="###"></a><a
                            class="faceIcon" facecode="[face8]" title="[face8]" href="###"></a><a class="faceIcon"
                                                                                                  facecode="[face9]"
                                                                                                  title="[face9]"
                                                                                                  href="###"></a><a
                            class="faceIcon" facecode="[face10]" title="[face10]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face11]"
                                                                                                    title="[face11]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face12]" title="[face12]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face13]"
                                                                                                    title="[face13]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face14]" title="[face14]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face15]"
                                                                                                    title="[face15]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face16]" title="[face16]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face17]"
                                                                                                    title="[face17]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face18]" title="[face18]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face19]"
                                                                                                    title="[face19]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face20]" title="[face20]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face21]"
                                                                                                    title="[face21]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face22]" title="[face22]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face23]"
                                                                                                    title="[face23]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face24]" title="[face24]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face25]"
                                                                                                    title="[face25]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face26]" title="[face26]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face27]"
                                                                                                    title="[face27]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face28]" title="[face28]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face29]"
                                                                                                    title="[face29]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face30]" title="[face30]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face31]"
                                                                                                    title="[face31]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face32]" title="[face32]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face33]"
                                                                                                    title="[face33]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face34]" title="[face34]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face35]"
                                                                                                    title="[face35]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face36]" title="[face36]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face37]"
                                                                                                    title="[face37]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face38]" title="[face38]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face39]"
                                                                                                    title="[face39]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face40]" title="[face40]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face41]"
                                                                                                    title="[face41]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face42]" title="[face42]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face43]"
                                                                                                    title="[face43]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face44]" title="[face44]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face45]"
                                                                                                    title="[face45]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face46]" title="[face46]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face47]"
                                                                                                    title="[face47]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face48]" title="[face48]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face49]"
                                                                                                    title="[face49]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face50]" title="[face50]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face51]"
                                                                                                    title="[face51]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face52]" title="[face52]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face53]"
                                                                                                    title="[face53]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face54]" title="[face54]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face55]"
                                                                                                    title="[face55]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face56]" title="[face56]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face57]"
                                                                                                    title="[face57]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face58]" title="[face58]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face59]"
                                                                                                    title="[face59]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face60]" title="[face60]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face61]"
                                                                                                    title="[face61]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face62]" title="[face62]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face63]"
                                                                                                    title="[face63]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face64]" title="[face64]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face65]"
                                                                                                    title="[face65]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face66]" title="[face66]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face67]"
                                                                                                    title="[face67]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face68]" title="[face68]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face69]"
                                                                                                    title="[face69]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face70]" title="[face70]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face71]"
                                                                                                    title="[face71]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face72]" title="[face72]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face73]"
                                                                                                    title="[face73]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face74]" title="[face74]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face75]"
                                                                                                    title="[face75]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face76]" title="[face76]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face77]"
                                                                                                    title="[face77]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face78]" title="[face78]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face79]"
                                                                                                    title="[face79]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face80]" title="[face80]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face81]"
                                                                                                    title="[face81]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face82]" title="[face82]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face83]"
                                                                                                    title="[face83]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face84]" title="[face84]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face85]"
                                                                                                    title="[face85]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face86]" title="[face86]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face87]"
                                                                                                    title="[face87]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face88]" title="[face88]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face89]"
                                                                                                    title="[face89]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face90]" title="[face90]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face91]"
                                                                                                    title="[face91]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face92]" title="[face92]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face93]"
                                                                                                    title="[face93]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face94]" title="[face94]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face95]"
                                                                                                    title="[face95]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face96]" title="[face96]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face97]"
                                                                                                    title="[face97]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face98]" title="[face98]" href="###"></a><a class="faceIcon"
                                                                                                    facecode="[face99]"
                                                                                                    title="[face99]"
                                                                                                    href="###"></a><a
                            class="faceIcon" facecode="[face100]" title="[face100]" href="###"></a><a class="faceIcon"
                                                                                                      facecode="[face101]"
                                                                                                      title="[face101]"
                                                                                                      href="###"></a><a
                            class="faceIcon" facecode="[face102]" title="[face102]" href="###"></a><a class="faceIcon"
                                                                                                      facecode="[face103]"
                                                                                                      title="[face103]"
                                                                                                      href="###"></a><a
                            class="faceIcon" facecode="[face104]" title="[face104]" href="###"></a>
                    </div>
                </div>
...
<div style="display:none;">
    <div class="invite_student_container popup_box" id="invite_student_container">
        <s:form id="emailForm_personalOnlive">
            ...
            <p><span class="clip_link_btn submit_btn" onclick="copyToClipboard();"><s:property
                    value="%{getText('course.invite.link.copy')}"/></span></p>

            <p class="or_pragraph"><s:property value="%{getText('course.selection.or')}"/><s:property
                    value="%{getText('button.message')}"/>&nbsp;&nbsp;&nbsp;<span class="tip_words"
                                                                                  id="invite_text_tip"></span></p>

            <p class="leave_msg"><textarea id="invite_comments" name="inviteMessage"></textarea></p>

            <p class="email_list" id="invite_email_list">
                    <span><s:property value="%{getText('label.email.friend')}"/><label id="invite_add_email"
                                                                                       class="add_btn"><s:property
                            value="%{getText('interview.add')}"/></label>&nbsp;&nbsp;<label id="invite_email_msg"
                                                                                            class="tip_words"></label><br/>
                        <input type="text" class="emails" onblur="checkInviteEmail(this);" name="emails"></span>
            </p>

            <p class="begin_invite"><label onclick="inviteFriends();" class="submit_btn"><s:property
    ...
    <div id="add_live_title" class="popup_box">
        <input class="input1" type="text"
               placeholder="<s:property value="%{getText('gogowise.personalOnlive.title')}"/>"
               id="personalOnlive_name"/><br/>
        ...
        <input class="input2" type="button" onclick="addPerOnliveName(<s:property value="personalOnlive.id"/>);"
               value="<s:property value="%{getText('button.ok')}"/>"/>

        <div id="addPerOnliveName_Msg"></div>
    </div>

    <div id="add_live_announce" class="popup_box">
        <p><s:property value="%{getText('per.onlive.announce.here')}"/><span class="tip_words"
                                                                             id="annnounce_add_tip"></span></p>
