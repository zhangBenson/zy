    ...
    <div class="item_wrap cf" id="item_wrap">
        ...
        <s:iterator value="liveChannels">
            <div class="item">
                ...
                <div class="cf">
                    <a class="avatar fl" href="javascript:;" target="_blank"
                       title="<s:property value="theLatestChannelTerms.host.nickName"/>">
                        <img src="<s:property value="theLatestChannelTerms.host.pic"/>" class="to_popup"
                             alt="<s:property value="theLatestChannelTerms.host.nickName"/>" height="40"
                             width="40"><input name="id" value="9058478300" type="hidden">
                    </a>

                    <div class="fl">
                        <h4><a class="title" href="javascript:;"
                               title="<s:property value="theLatestChannelTerms.subTitle"/>"><s:property
                                value="name"/></a></h4>
                        <a class="nickname" href="javascript:;"
                           title="<s:property value="theLatestChannelTerms.host.nickName"/>"><s:property
                                value="theLatestChannelTerms.host.nickName"/></a>
                    </div>
                    <span class="start_time fr"><s:date name="theLatestChannelTerms.startTime"
                    ...
                    <div class="fl">
                        ...
                        <p class="course_tags cf">
                            <s:if test="userType != 0">
                                <a href="javascript:;"
                                   onclick="setUser2LiveFollower(<s:property value="id"/>,this);"><s:property
