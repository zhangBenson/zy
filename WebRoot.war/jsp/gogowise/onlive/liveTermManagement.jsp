...
<div class="mf_1">
    <p id="sub_nav"><a href="initMyOnlive.html"><s:property value="%{getText('my.onlive')}"/></a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<s:property value="%{getText('management.the.terms.info')}"/></p>
</div>
<div class="ltm">
    <s:iterator value="liveChannel.channelTermses" status="idx">
        <div class="bg_top"></div>
        <div class="ltm_all">
            <p class="course_logo"><a href="liveTermBlog.html?channelTerms.id=<s:property value="id"/>"><img src="<s:property value="logoUrl"/>"/></a></p>
            ...
            <p class="details cf">
                <span class="fl"><s:property value="%{getText('onlive.channel.introduction')}"/>：<s:property value="description"/><s:property value="description"/></span>
            </p>
            <div class="time">
                <a class="manage_course add_highlight" href="javascript:;"><s:property value="%{getText('term.add.titbits')}"/></a>
                <a class="manage_course manage_live_term" href="javascript:;"><s:property value="%{getText('term.info.update')}"/></a>
            </div>
            ...
            <div class="highlight highlight<s:property value='#idx.index'/>" >
              <form enctype="multipart/form-data" id="liveChannel_newEvent<s:property value="#idx.index"/>">
                  <input type="hidden" name="channelTerms.id" value="<s:property value="id"/>"/>
                    ...
                    <div class="area">
                        <p>请在这里添加花絮图片</p>
                        <div class="show_logo_input_msg input_msg" id="channelEvent_msg<s:property value="#idx.index"/>"></div>
                        <img src="images/defaultImgs/onlive.jpg" id="channelEvent_log_preview<s:property value="#idx.index"/>"/><br/>
                        <input type="file" name="upload" id="channelEvent_logoUrl_upload<s:property value="#idx.index"/>"/>
                        <input type="hidden" name="liveChannelNewEvent.logoUrl" id="channelNewEventLogo<s:property value="#idx.index"/>"/>
                    </div>
                    <div class="area">
                        <p><s:property value="%{getText('term.info.update.right.there')}"/><span class="live_term_highlight_tip"></span></p>
                        <textarea name="liveChannelNewEvent.content" id="channelTerm<s:property value="#idx.index"/>"></textarea>
                    </div>
                    <div class="handle">
                        <a href="javascript:;" class="submit" onclick="saveTitbits(<s:property value='#idx.index'/>);"><s:property value="%{getText('term.info.save')}"/></a>
                        <a href="javascript:;" class="cancel" onclick="closeHighlight(<s:property value='#idx.index'/>);"><s:property value="%{getText('term.info.reset')}"/></a>
                    </div>
                </form>
            </div>
            ...
            <div class="live_term_info live_term_info<s:property value="#idx.index"/>">
                ...
                <div class="lti_1 lti_0">
                    <p><s:property value="%{getText('onlive.channel.term.name')}"/><span id="live_term_title_tip" class="live_term_tip"></span></p>
                    <s:textfield id="live_term_title" name="subTitle"/>
                </div>
                <div class="lti_2 lti_0">
                    <p><s:property value="%{getText('channel.term.des')}"/><span id="live_term_desc_tip" class="live_term_tip"></span></p>
                    <s:textarea id="live_term_desc" name="description"/>
                </div>
                <div class="lti_3 lti_0">
                    <p><s:property value="%{getText('onlive.channel.term.logo')}"/><span id="live_term_logo_tip<s:property value='#idx.index'/>" class="live_term_tip"></span></p>
                    <img id="live_term_logo_img<s:property value='#idx.index'/>" src="<s:property value='logoUrl'/>"/>
                    <input type="file" class="" id="live_term_logo_upload<s:property value='#idx.index'/>" name="upload"/>
                    <s:hidden id="live_term_logo_hidden" name="logoUrl"/>
                </div>
                <div class="lti_1 lti_0">
                    <p><s:property value="%{getText('onlive.host.name')}"/><span id="live_term_host_tip" class="live_term_tip"></span></p>
                    <s:textfield id="live_term_title_hostEmail" name="hostEmail" onblur="checkNecessaryEmail(this,'live_term_host_tip');"/>
                </div>
                <div class="lti_1 lti_0">
                    <p><s:property value="%{getText('channel.term.contetant')}"/><a href="javascript:;" class="player_add_btn add_btn" id="player_add_btn<s:property value="#idx.index"/>"><s:property value="%{getText('interview.add')}"/></a><span id="live_term_player_tip" class="live_term_tip"></span></p>
                    <%--<s:textfield id="live_term_title" name="contestants" onblur="checkUnnecessaryEmail(this,'live_term_player_tip');" value=""/>--%>
                </div>
                <div class="lti_1 lti_0">
                    <p><s:property value="%{getText('channel.term.guest')}"/><a href="javascript:;"  class="guest_add_btn add_btn" id="guest_add_btn<s:property value="#idx.index"/>"><s:property value="%{getText('interview.add')}"/></a><span id="live_term_guest_tip" class="live_term_tip"></span></p>
                ...
                <div class="lti_4 lti_0">
                    <a href="#fancybox" class="handle_btn submit" onclick="updateTermInfo(<s:property value='#idx.index'/>);"><s:property value="%{getText('term.info.save')}"/></a>
                    <a href="javascript:;" class="handle_btn cancel" onclick="closeTermInfo(<s:property value='#idx.index'/>);"><s:property value="%{getText('term.info.reset')}"/></a>
                </div>
                </form>
            </div>
        </div>
