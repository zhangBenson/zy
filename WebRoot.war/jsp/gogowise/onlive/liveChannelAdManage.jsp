...
<div id="cnt_cntai">
    <ul class="cntai_first_ul">
        ...
        <li>
            <ul class="sub_ul">
                <li class="li_0"><s:a action="liveChannelBlog" target="_blank"><s:param name="liveChannel.id" value="id"/><img src="<s:property value="logoUrl"/>"/></s:a></li>
                ...
                <li class="li_3"><s:property value="%{getText('show.creation.time')}" />：<span class="orangeWords"><s:date name="createTime" format="%{getText('dateformat')}"/></span></li>
                <li class="li_3"><s:property value="%{getText('show.total.terms')}" />：<span class="orangeWords"><s:property value="totalTermsNum"/></span></li>
                <li class="li_3"><s:property value="%{getText('show.total.fans.num')}" />：<span class="orangeWords"><s:property value="totalFollowerNum"/></span></li>
                ...
                <li class="li_4"><a href="javascript:;"><s:property value="%{getText('show.ad.management')}" /></a></li>
            </ul>
            <s:iterator value="nextSeasonAdvertisements" status="idx">
                <ul class="sub_u2">
                    <li class="li_0"><img src="<s:property value="adLogoUrl"/>" alt="<s:property value="%{getText('show.ad.logo')}" />"/></li>
            ...
            <ul class="sub_u2">
                    ...
                    <li class="li_1"><s:property value="%{getText('show.ad.accept')}" /><input onclick="acceptBid(<s:property value="id"/>,<s:property value="liveChannel.id"/>,this);" type="checkbox" <s:if test="accept">checked="checked"</s:if>/></li>
            </ul>
            </s:iterator>
        </li>
        </s:iterator>
