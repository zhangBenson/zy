...
<s:iterator value="personalOnlives">
    ...
    <div class="listView fl">
        ...
        <div class="viewLeft fl">
            <p class="title">
                <a class="title" href="userBlog.html?user.id=<s:property value="owner.id"/>"><s:property value="title"/></a>
            ...
            <p class="info">
                <span><s:property value="%{getText('personal.onlive.broadcast.time')}"/>：<span class="orange_words"><s:date name="startTime" format="%{getText('dateformat.forclass')}"/></span></span>&nbsp;&nbsp;&nbsp;
                <span><span class="orange_words"> <s:property value="clickRate"/></span>&nbsp;<s:property value="%{getText('user.onlive.click.num')}"/></span>    <br/>
                <span><span class=""><s:property value="%{getText('show.blog.host.username')}"/> ：</span>&nbsp;<span class="orange_words"><a class="title" href="userBlog.html?user.id=<s:property value="owner.id"/>"><s:property value="owner.nickName"/></a></span></span>
