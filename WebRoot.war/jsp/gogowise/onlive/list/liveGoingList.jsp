...
<s:iterator value="personalOnlives">
    ...
    <div class="listView fl">
        ...
        <div class="viewLeft fl">
            <p class="title">
                <a class="title" href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="id"/>"><s:property value="title"/></a>
                ...
                <a class="watch orange_words" href="liveOnMap.html?personalOnlive.id=<s:property value="id"/>" target="_blank"><s:property value="%{getText('click.to.map')}"/></a>
            </p>
            <p class="info">
                <span><s:property value="%{getText('course.start.time')}"/>：<span class="orange_words"><s:date name="startTime" format="%{getText('dateformat.forclass')}"/></span></span>&nbsp;&nbsp;&nbsp;
                <span><span class="orange_words"> <s:property value="numOfAudience"/></span>&nbsp;<s:property value="%{getText('per.onlive.online.users')}"/></span>
            </p>
