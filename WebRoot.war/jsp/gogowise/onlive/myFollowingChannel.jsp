...
<%--<link href="css/onlive/myFollow.css" rel="stylesheet" type="text/css"/>--%>
    ...
    <s:iterator value="liveChannels" status="idx">
        <div class="course_item">
            ...
            <div class="infoWrap">
                ...
                <p class="time">
                    <a class="manage_course" href="javascript:;"><s:property value="%{getText('cancel.the.onlive.focus')}"/></a>
                    ...
                    <a class="manage_course" id="" href="addLiveEvent.html"><s:property value="%{getText('add.show.new.events')}"/></a>
                </p>
            </div>
        </div>
                       ...
                       <li>
                          <div class="highlight">
                              <div class="area">
                                  ...
                                  <input type="text" css="highlight_file" name="liveChannelNewEvent.title" id="courseNewEvent_title<s:property value="#idx.index"/>"/>
                              </div>
                              <div class="area">
                                  ...
                                  <%--<input type="file" css="highlight_file" name="" id="courseNewEvent_logUrl"/>--%>
                                      ...
                                      <input type="hidden" id="courseNewEvent_logoUrl<s:property value="#idx.index"/>" name="liveChannelNewEvent.logoUrl"/>
                              </div>
                              <div class="area">
                                  <p><s:property value="%{getText('term.info.update.right.there')}"/><span class="live_term_highlight_tip"></span></p>
                                  <textarea name="liveChannelNewEvent.content" id="courseNewEvent_content<s:property value="#idx.index"/>"></textarea>
                              </div>
                              <div class="handle">
