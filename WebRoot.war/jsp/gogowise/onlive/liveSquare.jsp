...
<div class="square_container">
    ...
    <div class="head_img">
        <p class="desc"><span class="big"><s:property
                value="%{getText('index.third.image.intro1')}"/></span><br/><br/><br/><s:property
                value="%{getText('index.third.image.intro2')}"/></p>
        ...
        <div class="cont">
            <ul>
                <s:iterator value="liveChannelsOnline" status="idx">
                    <li>
                        <a class="img fl"
                           href="liveTermBlog.html?channelTerms.id=<s:property value="theLatestChannelTerms.id"/>"
                           title="<s:property value="name"/>"><img src="<s:property value="logoUrl"/>"/></a>

                        <p class="focus fl"><s:property value="fansNum"/><s:property
                                value="%{getText('the.num.of.focus.on.live.channel')}"/></p>

                        <p><a class="title fl"
                              href="liveTermBlog.html?channelTerms.id=<s:property value="theLatestChannelTerms.id"/>"
                              title="<s:property value="name"/>"><s:property value="name"/></a></p>
            ...
            <div class="cont">
                <ul>
                    <s:iterator value="onlivings" status="idx">
                        <li>
                            <a class="img" href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="id"/>"
                               title="<s:property value="owner.nickName"/>"><img src="<s:property value="owner.pic"/>"/></a>
                            <a class="title" href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="id"/>"
                               title="<s:property value="owner.nickName"/>"><s:property value="owner.nickName"/></a>
                            <s:if test="!owner.userFocused">
                                <a class="reserve" href="javascript:;"
                                   onclick="addUserFocus(this,<s:property value="owner.id"/>);"
                                   style="display: inline;"><s:property value="%{getText('user.add.focus')}"/></a>
                            </s:if>
                            <s:else>
                                <a class="reserve" href="javascript:;"
                                   onclick="addUserFocus(this,<s:property value="owner.id"/>);"
                                   style="display: inline;"><s:property value="%{getText('user.add.focused')}"/></a>
                            </s:else>
                            <div class="msg">
                                <span class="num num1"><s:property value="owner.fansNum"/><s:property
                                        value="%{getText('onlive.fensi')}"/></span>
                                    <%--<span class="num num2"><s:property value="fansNum"/>粉丝</span>--%>
                            </div>
                            <span class="date"><s:property value="%{getText('course.start.time')}"/>：<s:date
                                    name="startTime" format="%{getText('dateformat.forclass')}"/></span>
                        </li>
                    </s:iterator>
                </ul>
            </div>
                ...
                <s:iterator value="hotestLiveChannels" status="idx">
                    <li>
                        ...
                        <s:if test="userType == 1">
                            <a class="reserve" href="javascript:;" id="focusButton<s:property value="#idx.index"/>"
                               onclick="userAddFollows(this,<s:property value="id"/>);"
                               style="display: inline;"><s:property value="%{getText('user.add.focus')}"/></a>
                        </s:if>
                        <s:else>
                            <a class="reserve" href="javascript:;" id="focusButton<s:property value="#idx.index"/>"
                        ...
                        <span class="date"><s:property value="%{getText('onlive.creation.time')}"/>：<s:date
                                name="createTime" format="%{getText('dateformat.forclass')}"/></span>
                    </li>
                </s:iterator>
            </ul>
        </div>
                ...
                <s:iterator value="onliveStars">
                    <li>
                        <a class="img" href="userBlog.html?user.id=<s:property value="owner.id"/>"
                           title="<s:property value="owner.nickName"/>"><img src="<s:property value="owner.pic"/>"/></a>
                        <a class="nick" href="userBlog.html?user.id=12"
                           title="<s:property value="owner.id"/>"><s:property value="owner.nickName"/></a>
                        <span class="msg"><s:property value="owner.fansNum"/> <s:property
                                value="%{getText('onlive.fensi')}"/> &nbsp;&nbsp;&nbsp;<s:property
                                value="owner.onliveTimes"/><s:property
                                value="%{getText('personal.onliv.times')}"/></span>
                        <s:if test="!owner.userFocused"><a class="focus"
                                                           onclick="addUserFocus(this,<s:property value="owner.id"/>);"><s:property
                                value="%{getText('user.add.focus')}"/></a></s:if>
                        <s:else><a class="focus"
                                   onclick="addUserFocus(this,<s:property value="owner.id"/>);"><s:property
    ...
    <div class="highlight" style="margin-top: 20px;">
        ...
        <ul>
            <s:iterator value="liveChannelNewEvents">
                <li>
                    <div class="dot"></div>
                    <a href="liveChannelEventRead.html?liveChannelNewEvent.id=<s:property value="id"/>"
                       title="<s:property value="title"/>" class="liveChannel_newEvents"><s:property value="title"/></a>
                </li>
            </s:iterator>
        </ul>
        <script type="text/javascript">
