...
<div class="mf_2">
    <div class="overview cf">
        <div class="sub_info fl">
            <p class="number"><s:property value="totalNumOfViewOnlive"/><span><s:property
                    value="%{getText('onlive.fensi')}"/></span></p>

            <p class="describe"><s:property value="%{getText('the.num.of.watched.my.onlive')}"/></p>
        </div>
        <div class="sub_info sub_info_center fl">
            <p class="number"><s:property value="totalNumOfViewVideo"/><span><s:property
                    value="%{getText('the.static.times')}"/></span></p>

            <p class="describe"><s:property value="%{getText('the.num.of.onlive.record.open.times')}"/></p>
        </div>
        <div class="sub_info fl">
            <p class="number"><s:property value="totalNumOfChannelTerms"/><span><s:property
                    value="%{getText('the.static.terms')}"/></span></p>
    ...
    <s:iterator value="liveChannels" status="idx">
        <div class="course_item">
            ...
            <div class="infoWrap">
                ...
                <p class="maintenance">
                    <a href="initLiveChannelManagement.html?liveChannel.id=<s:property value="id"/>">[<s:property
                            value="%{getText('onlive.message.update')}"/>]</a>
                    <strong>•</strong>
                ...
                <p class="time">
                    <a class="manage_course"
                       href="initLiveChannelManagement.html?liveChannel.id=<s:property value="id"/>"><s:property
                            value="%{getText('onlive.channel.management')}"/></a>
                    <a class="manage_course"
                       href="manageLiveTerm.html?liveChannel.id=<s:property value="id"/>"><s:property
                            value="%{getText('onlive.term.management')}"/></a>
                    ...
                    <a class="manage_course"
                       href="maintenanceOnlive.html?liveChannel.id=<s:property value="id"/>"><s:property
                            value="%{getText('create.a.new.term')}"/></a>
                    <a class="manage_course"
                       href="initLiveChannelAds.html?liveChannel.id=<s:property value="id"/>"><s:property
                            value="%{getText('onlive.channel.ad.management')}"/></a>
                </p>
            </div>
        </div>
