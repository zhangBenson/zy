...
<div id="flash_cont">
    <div class="room_tip1">
        <p class="p1">
            <a id="securityQuit" class="submit_btn_large"><s:property
                    value="%{getText('control.room.security.quit')}"/></a>
            <s:if test="userPrivateChannel.user.id != #session.userID">
                <a class="whose" href="userBlog.html?user.id=<s:property value="userPrivateChannel.user.id"/>"
                   target="_blank"><s:property
                        value="%{getText('monitor.whose',{userPrivateChannel.user.nickName})}"/></a>
            </s:if>
            <s:else>
        ...
        <p class="p2">
            ...
            <a href="multiVideoSolution.html" target="_blank" class="submit_btn"><s:property
                    value="%{getText('control.room.more.solution')}"/></a>
        </p>
    </div>
    <div class="flashWrap">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0"
                width="410" height="350" name="Girl0" id="Girl0" wmode="transparent">
            <param name="movie" value="<s:property value="flashPatch"/>?id=0"/>
            <param name="quality" value="high"/>
            <param name="wmode" value="transparent"/>
            <param name="allowFullScreen" value="true"/>
            <embed src="<s:property value="flashPatch"/>?id=0" allowFullScreen="true" width="410" height="350"
                   quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer"
                   type="application/x-shockwave-flash" wmode="transparent" name="Girl0" id="GirlEmbed0"></embed>
        </object>
    </div>
    <div class="flashWrap">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0"
                width="410" height="350" name="Girl1" id="Girl1" wmode="transparent">
            <param name="movie" value="<s:property value="flashPatch"/>?id=1"/>
            <param name="quality" value="high"/>
            <param name="wmode" value="transparent"/>
            <param name="allowFullScreen" value="true"/>
            <embed src="<s:property value="flashPatch"/>?id=1" allowFullScreen="true" width="410" height="350"
                   quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer"
                   type="application/x-shockwave-flash" wmode="transparent" name="Girl1" id="GirlEmbed1"></embed>
        </object>
    </div>
    <div class="flashWrap">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0"
                width="410" height="350" name="Girl2" id="Girl2" wmode="transparent">
            <param name="movie" value="<s:property value="flashPatch"/>?id=2"/>
            <param name="quality" value="high"/>
            <param name="wmode" value="transparent"/>
            <param name="allowFullScreen" value="true"/>
            <embed src="<s:property value="flashPatch"/>?id=2" allowFullScreen="true" width="410" height="350"
                   quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer"
                   type="application/x-shockwave-flash" wmode="transparent" name="Girl2" id="GirlEmbed2"></embed>
        </object>
    </div>
    <div class="room_other">
        <div class="term-list">
            <h3 class="h3_title"><s:property value="%{getText('index.onlive.hottest')}"/></h3>
            <a href="hotOnLiveList.html" target="_blank" class="other_more"><s:property
                    value="%{getText('others.more')}"/></a>
            <ul>
                <s:iterator value="hotOnlives">
                    <li>
                        <a href="userBlog.html?user.id=<s:property value="owner.id"/>" target="_blank" class="a_img"
                           title="<s:property value="owner.nickName"/>"><img src="<s:property value="owner.pic"/>"/></a>
                        <a href="userBlog.html?user.id=<s:property value="owner.id"/>" target="_blank" class="a_title"
        ...
        <div class="highlight">
            ...
            <a href="announceRead.html?goGoWiseAnnounce.id=1" target="_blank" class="other_more"><s:property
                    value="%{getText('others.more')}"/></a>
            <ul>
                <s:iterator value="goGoWiseAnnounces">
                    <li>
                        <div class="dot"></div>
                        <a href="announceRead.html?goGoWiseAnnounce.id=<s:property value="id"/>" target="_blank"
    ...
    <div class="room_tip2">
        <h3><span class="warm_tip"><s:property value="%{getText('org.warmtip')}"/>：</span><s:property
                value="%{getText('control.room.click.plus')}"/> <a href="downloadRemoteEye.html" target="_blank"
                                                                   class="submit_btn"> <s:property
                value="%{getText('control.room.ggw.remote.eye')}"/></a>
