            ...
            <ul class="content_courseInfo">
                <li>
                    ...
                    <div class="option_content">
                        <s:if test="existAds">
                            <s:select name="advertisementForLive.fromAdvertisement.id" list="ads" listKey="key"
                                      id="advertisement_name" cssClass="long_text_field" listValue="value"/>
                        </s:if>
                        <s:else>
                            <s:textfield cssClass="long_text_field" id="bid_brand"
                                         name="advertisementForLive.productName"/>
                        </s:else>
                    </div>
                </li>
                <li>
                    ...
                    <div class="option_content"><s:textfield cssClass="long_text_field" id="bid_link"
                                                             name="advertisementForLive.linkAddress"/>
                    </div>
                </li>
                <li>
                    ...
                    <div class="option_content">
                        <s:textarea cssClass="long_text_area" id="bid_description"
                                    name="advertisementForLive.description"/>
                    </div>
                </li>
                <li class="long_select_li">
                    ...
                    <div class="option_content"><s:textfield cssClass="short_text_field" id="bid_price"
                                                             name="advertisementForLive.bidPrice"/></div>
                </li>
                <li>
