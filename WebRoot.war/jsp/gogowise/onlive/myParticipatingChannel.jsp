    ...
    <s:iterator value="liveChannels" status="idx">
        <div class="course_item">
            ...
            <div class="infoWrap">
                ...
                <p class="time">
                    <a class="manage_course" href="javascript:;"><s:property value="%{getText('onlive.channel.cancel.partispate')}"/></a>
                    ...
                    <a class="manage_course" id="" href="addLiveEvent.html?liveChannel.id=<s:property value="id"/>"><s:property value="%{getText('add.show.new.events')}"/></a>
                </p>
            </div>
        </div>
