...
<div class="lcb_left fl">
    ...
    <div class="term_info fl">
        ...
        <div class="basic">
            <p><span><s:date name="liveChannel.createTime"
                             format="%{getText('dateformat.forclass')}"/></span><span>已开办<s:property
                    value="liveChannel.totalTermsNum"/>期&nbsp;|&nbsp;<s:property value="liveChannel.fansNum"/>人关注</span>
            </p>

            <p><s:property value="%{getText('onlive.host.name')}"/>&nbsp;<span
                    class="orWord_large">2.5</span>选手&nbsp;<span class="orWord_large">4.7</span>嘉宾&nbsp;<span
                    class="orWord_large">3.7</span></p>
        ...
        <div class="operate">
            <a href="javascript:;" class="act_btn host_btn"><s:property
                    value="%{getText('live.term.blog.be.host')}"/></a>
            <a href="javascript:;" class="act_btn player_btn"><s:property
                    value="%{getText('live.term.blog.be.contestant')}"/></a>
            <a href="javascript:;" class="act_btn guest_btn"><s:property
                    value="%{getText('live.term.blog.be.guest')}"/></a>
        </div>
                    ...
                    <s:iterator value="liveChannel.channelTermses">
                        <li>
                            <a href="liveTermBlog.html?channelTerms.id=<s:property value="id"/>"
                               title="<s:property value="subTitle"/>"><img src="<s:property value="logoUrl"/>"
                                                                           alt="<s:property value="subTitle"/> "></a>

                            <p><a href="liveTermBlog.html?channelTerms.id=<s:property value="id"/>"
                                  title="<s:property value="subTitle"/>"><s:property value="subTitle"/> </a></p>

                            <p><span class="cnum"><s:date name="startTime"
                                                          format="%{getText('dateformat.forclass')}"/></span></p>
                        </li>
                    </s:iterator>
                </ul>
            </div>
    ...
    <div class="message_box">
        ...
        <div class="cont_out">
            ...
            <a href="javascript:;" class="submit_btn"
               onclick="submitComment(<s:property value="liveChannel.id"/>);"><s:property
                    ...
                    <p>
                        ...
                        <a href="javascript:;" class="nick_name"><s:property value="commenter.nickName"/></a>
                            <span class="span_out">
                                ...
                                <s:elseif
                                        test="liveChannel.creator.id != #session.userID && commenter.id != #session.userID">
                                    <a class="span2" href="javascript:;"
                                       onclick="replyToComment('<s:property value="commenter.nickName"/>',<s:property
                                               value="commenter.id"/>);"><s:property
                                            value="%{getText('blog.comments.reply')}"/></a>
    ...
    <div class="fans lcb_round persons">
        ...
        <ul>
            <s:iterator value="onliveFollowers">
                <li class="imgLi"><a href="userBlog.html?user.id=<s:property value="channelTerms.host.id"/>"
                                     title='<s:property value="channelTerms.host.nickName"/>'><img
                        src="images/tmp/p1.jpg"/></a></li>
            </s:iterator>
    ...
    <div class="fans lcb_round persons">
        ...
        <ul>
            <s:iterator value="liveChannel.allHosts">
                <li class="imgLi"><a href="userBlog.html?user.id=<s:property value="id"/>"
    ...
    <div class="news lcb_round">
        ...
        <ul class="list03 fblue">
            <s:iterator value="liveChannelNewEvents">
                <li><a href="liveChannelEventRead.html?liveChannelNewEvent.id=<s:property value="id"/>"><s:property
                        value="title"/></a></li>
            </s:iterator>
        </ul>
    </div>
    <div class="hot_terms lcb_round">
        ...
        <ul>
            <s:iterator value="liveChannels">
                <li class="imgLi">
                    <a class="up" href="liveChannelBlog.html?liveChannel.id=<s:property value="id"/>"><img
                            src="<s:property value="logoUrl"/>"/></a>
                    <a class="down" href="liveChannelBlog.html?liveChannel.id=<s:property value="id"/>"><s:property
                            value="name"/></a>
                </li>
            </s:iterator>
            <li class="li_more"><a href="javascript:;">更多&nbsp;↓</a></li>
