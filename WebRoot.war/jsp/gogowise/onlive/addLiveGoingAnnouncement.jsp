...
<div class="eidtorWrap fl">
    <s:form action="saveLiveTrailer">
        ...
        <p>
            <label><s:property value="%{getText('live.trailer.edit.main.titler')}"/></label>&nbsp;&nbsp;&nbsp;<span
                class="tip_words" id="announce_title_tip"></span> <br/><br/>
            <input class="text announce_title" type="text" name="liveTrailer.title"/> <br/><br/><br/>
        </p>

        <p>
            <label for="editor1"><s:property value="%{getText('live.trailer.edit.main.content')}"/></label>&nbsp;&nbsp;&nbsp;<span
                class="tip_words" id="announce_content_tip"></span> <br/><br/>
            <textarea cols="80" id="editor1" name="liveTrailer.content" rows="10"
                      placeholder="<s:property value="%{getText('live.trailer.edit.main.content.description')}"/>"></textarea>
            <ckeditor:replace replace="editor1" basePath="js/ckeditor/" config="<%=settings %>"/>
        </p>

        <p>
            <input class="submit a_focus" id="announce_submit_btn" type="submit" onclick="return checkAnnouncement();"
                   value="<s:property value="%{getText('course.maintenance.confirm')}"/>"/>
        </p>
    </s:form>
