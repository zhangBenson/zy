...
<div class="ltb_cont">
    <div class="lcb_up">
        <div class="logo">
            <a href="liveChannelBlog.html?liveChannel.id=<s:property value="channelTerms.liveChannel.id"/>" title="<s:property value="channelTerms.liveChannel.name"/>"><img id="share_pic" src="<s:property value="channelTerms.liveChannel.logoUrl"/>"/></a>
        </div>
        <div class="info">
            <a class="title" id="share_title" title="<s:property value="channelTerms.liveChannel.name"/>"><s:property value="channelTerms.liveChannel.name"/></a>
                    ...
                    <div class="scroll_center">
                        <ul id="scroll_list_ul">
                            <s:iterator value="channelTerms.liveChannel.channelTermses">
                                <li>
                                    <a href="liveTermBlog.html?channelTerms.id=<s:property value="id"/>" title="<s:property value="subTitle"/>"><img src="<s:property value="logoUrl"/>"/></a>
                                </li>
                            </s:iterator>
                        </ul>
                    </div>
    ...
    <div class="lcb_left">
        <div class="term_info">
            ...
            <h5><span><s:property value="%{getText('live.term.blog.terms.sequence.first')}"/><s:property value="channelTerms.termSequence"/><s:property value="%{getText('live.term.blog.terms.sequence.tail')}"/></span>--<s:property value="channelTerms.subTitle"/></h5>
            <div class="date_host">
                <s:property value="%{getText('org.meeting.virtual.host')}"/>：<a class="host name_link" href="userBlog.html?user.id=<s:property value="channelTerms.host.id"/>" title="<s:property value="channelTerms.host.nickName"/>"><s:property value="channelTerms.host.nickName"/></a>
                ...
                <div class="player if">
                    ...
                    <s:iterator value="channelTerms.contestants">
                        <s:if test="member != null">
                           <a href="userBlog.html?user.id=<s:property value="member.id"/>" title="<s:property value="member.nickName"/>"><s:property value="member.nickName"/></a>
                        </s:if>
                        <s:else>
                           <a href="javascript:;" title="<s:property value="memberEmail"/>"><s:property value="memberEmail"/></a>
                        </s:else>
                    </s:iterator>
                </div>
                <div class="guest if">
        ...
        <div class="person_info">
            ...
            <div class="info">
                <div class="ifl">
                    <a href="userBlog.html?user.id=<s:property value="channelTerms.host.id"/>"  title='<s:property value="channelTerms.host.nickName"/>'><img src="<s:property value="channelTerms.host.pic"/>"/></a>
                    <a href="javascript:;" class="focus"><s:property value="%{getText('user.add.focus')}"/></a>
                </div>
                <div class="ifc">
                    <a href="userBlog.html?user.id=<s:property value="channelTerms.host.id"/>" class="name_link" title='<s:property value="channelTerms.host.nickName"/>'><s:property value="channelTerms.host.nickName"/></a>
                    <span class="data"><span class="orWord"><s:property value="channelTerms.host.fansNum"/></span>&nbsp;&nbsp;<s:property value="%{getText('onlive.fensi')}"/>
                        <%--&nbsp;&nbsp;|&nbsp;&nbsp;<span class="orWord">20</span>学生&nbsp;&nbsp;|&nbsp;&nbsp;<span class="orWord">20</span>课程--%>
                    </span>
                    <span class="desc">
                        <s:if test="channelTerms.host.selfDescription == null"><s:property value="%{getText('onlive.fensi')}"/></s:if>
                        <s:else><s:property value="%{getText('live.term.without.host.selfIntro')}"/></s:else>
                    </span>
                </div>
                <div class="ifr">
                    <ul>
                        <li><s:property value="%{getText('live.term.average.score')}"/>&nbsp;&nbsp;<span class="orWord_large">4.1</span>&nbsp;<s:property value="%{getText('user.evaluate.grade')}"/></li>
                        <li><s:property value="%{getText('live.term.highest.score')}"/>&nbsp;&nbsp;<span class="orWord_large">5.0</span>&nbsp;<s:property value="%{getText('user.evaluate.grade')}"/></li>
                        <li><s:property value="%{getText('live.term.lowest.score')}"/>&nbsp;&nbsp;<span class="orWord_large">3.3</span>&nbsp;<s:property value="%{getText('user.evaluate.grade')}"/></li>
                        <li><s:property value="%{getText('live.term.evaluate.user.num')}"/>&nbsp;&nbsp;<span class="orWord_large">2537</span>&nbsp;<s:property value="%{getText('label.person')}"/></li>
                        <li class="gradeLi"><span class="type2_left"><s:property value="%{getText('live.term.evaluate.by.myself')}"/>&nbsp;&nbsp;</span><span id="rate_t_1" class="type2"></span><span class="orWord_large ontime_value" id="grade_1">&nbsp;&nbsp;3.5</span></li>
                    </ul>
                </div>
                <script type="text/javascript">
                    $("#rate_t_1").rate({
        ...
        <s:if test="channelTerms.confirmedContestantsNum != 0">
            <div class="person_info">
                ...
                <s:iterator value="channelTerms.confirmedContestants" status="idx">
                    ...
                    <div class="info">
                        <div class="ifl">
                            <a href="userBlog.html?user.id=<s:property value="member.id"/>"  title='<s:property value="member.nickName"/>'><img src="<s:property value="member.pic"/>"/></a>
                            <a href="javascript:;" class="focus"><s:property value="%{getText('user.add.focus')}"/></a>
                        </div>
                        <div class="ifc">
                            <a href="userBlog.html?user.id=<s:property value="member.id"/>" class="name_link" title='<s:property value="member.nickName"/>'><s:property value="member.nickName"/></a>
                            <span class="data"><span class="orWord"><s:property value="member.fansNum"/></span>&nbsp;&nbsp;<s:property value="%{getText('onlive.fensi')}"/>
                                <%--&nbsp;&nbsp;|&nbsp;&nbsp;<span class="orWord">20</span>学生&nbsp;&nbsp;|&nbsp;&nbsp;<span class="orWord">20</span>课程--%>
                            </span>
                            <span class="desc">
                                <s:if test="member.selfDescription == null"><s:property value="%{getText('live.term.without.contestant.selfIntro')}"/></s:if>
                        ...
                        <div class="ifr">
                            <ul>
                                ...
                                <li><s:property value="%{getText('live.term.lowest.score')}"/>&nbsp;&nbsp;<span class="orWord_large">3.3</span>&nbsp;<s:property value="%{getText('user.evaluate.grade')}"/></li>
                                <li><s:property value="%{getText('live.term.evaluate.user.num')}"/>&nbsp;&nbsp;<span class="orWord_large">2537</span>&nbsp;<s:property value="%{getText('label.person')}"/></li>
                                <li class="gradeLi"><span class="type2_left"><s:property value="%{getText('live.term.evaluate.by.myself')}"/>&nbsp;&nbsp;</span><span id="rate_t_contestant_<s:property value="#idx.index"/>" class="type2"></span><span class="orWord_large ontime_value" id="grade_contestants_<s:property value="#idx.index"/>">&nbsp;&nbsp;3.5</span></li>
                            </ul>
                        </div>
                    </div>
                    <script type="text/javascript">
            ...
            <s:iterator value="channelTerms.confirmedGuests" status="idx">
                ...
                <div class="info">
                    ...
                    <div class="ifc">
                        ...
                        <span class="desc">
                            <s:if test="member.selfDescription == null"><s:property value="%{getText('live.term.without.guest.selfIntro')}"/></s:if>
                            <s:else><s:property value="member.selfDescription"/></s:else>
                        </span>
                    </div>
                    <div class="ifr">
                        <ul>
                            ...
                            <li><s:property value="%{getText('live.term.lowest.score')}"/>&nbsp;&nbsp;<span class="orWord_large">3.3</span>&nbsp;<s:property value="%{getText('user.evaluate.grade')}"/></li>
                            <li><s:property value="%{getText('live.term.evaluate.user.num')}"/>&nbsp;&nbsp;<span class="orWord_large">2537</span>&nbsp;<s:property value="%{getText('label.person')}"/></li>
                            <li class="gradeLi"><span class="type2_left"><s:property value="%{getText('live.term.evaluate.by.myself')}"/>&nbsp;&nbsp;</span><span id="rate_t_guests_<s:property value="#idx.index"/>" class="type2"></span><span class="orWord_large ontime_value" id="grade_guests_<s:property value="#idx.index"/>">&nbsp;&nbsp;3.5</span></li>
                        </ul>
                    </div>
                </div>
                <script type="text/javascript">
        ...
        <div class="message_box">
            ...
            <div class="cont_out">
                ...
                <a href="javascript:;" class="submit_btn" onclick="submitComment(<s:property value="channelTerms.id"/>);"><s:property value="%{getText('button.submit')}"/></a>
                    ...
                    <s:iterator value="liveTermComments">
                     ...
                     <s:if test="commentsNum != 0">
                            <s:if test="!commentsNumOverflow">
                                <a  class="more_or_close" href="javascript:;" onclick="getMoreComments();"><s:property value="%{getText('blog.comments.more.result')}"/>&gt;&gt;</a>
                            </s:if>
                            <s:elseif test="commentsNumOverflow && commentsNum>=10">
                                <a class="more_or_close" href="javascript:;" onclick="rollBack();">&lt;&lt;<s:property value="%{getText('blog.comments.rollBack')}"/></a>
                            </s:elseif>
                     </s:if>
                    <script type="text/javascript">
    ...
    <div class="lcb_right">
        <div class="begin">
            ...
            <s:else>
                 <p><s:property value="%{getText('live.term.left.time')}"/><br/><span class="orWord" id="channelTermsLeftTime"></span></p>
                 <script type="text/javascript">
        ...
        <div class="fans lcb_round persons">
            <h4><s:property value="channelTerms.liveChannel.totalFollowerNum"/> <s:property value="%{getText('live.term.channel.focused.user.num')}"/></h4>
            <ul>
                <s:iterator value="channelTerms.liveChannel.onliveFollowers">
                      <li class="imgLi"><a href="userBlog.html?user.id=<s:property value="follower.id"/>"  title='<s:property value="follower.nickName"/>'><img src="<s:property value="follower.pic"/>"/></a></li>
                </s:iterator>
        ...
        <div class="news lcb_round">
            ...
            <ul class="list03 fblue">
                <li><a href="javascript:;" target="_blank" title="">&gt;&nbsp;&nbsp;<s:property value="channelTerms.titbits"/></a></li>
            </ul>
        </div>
        </s:if>
        ...
        <div class="hot_terms lcb_round">
            ...
            <ul>
                ...
                <li class="imgLi">
                    <a class="up" href="javascript:;"  title='<s:property value="name"/>'><img src="<s:property value="logoUrl"/>"/></a>
                    <a class="down" href="javascript:;"  title='<s:property value="name"/>'><s:property value="name"/></a>
                </li>
                </s:iterator>
                <li class="li_more"><a href="javascript:;"><s:property value="%{getText('others.more')}"/>&nbsp;↓</a></li>
            </ul>
        ...
        <div class="ads">
           ...
           <a class="ad-bid" href="listLiveChannelAdBid.html?liveChannel.id=<s:property value="channelTerms.liveChannel.id"/>"><s:property value="%{getText('live.term.ad.bidding')}"/></a>
        </div>
</div>
