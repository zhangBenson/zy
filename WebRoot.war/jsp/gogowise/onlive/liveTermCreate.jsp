...
<div class="mf_2">
    <s:form action="saveChannelTerms" method="POST" validate="false" theme="css_xhtml" enctype="multipart/form-data">
        ...
        <ul>
            ...
            <li class="li_2">
                <p class="title"><s:property value="%{getText('onlive.channel.term.start.time')}"/><span class="asterisk">*</span></p>
            ...
            <li>
                <p class="title"><s:property value="%{getText('onlive.term.host.email')}"/><span class="asterisk">*</span></p>
            ...
            <li>
                <p class="title"><s:property value="%{getText('channel.term.contetant')}"/></p><a class="add_btn" id="player_add_btn" href="javascript:;"><s:property value="%{getText('interview.add')}"/></a>
            ...
            <li>
                <p class="title"><s:property value="%{getText('channel.term.guest')}"/></p><a class="add_btn" id="guest_add_btn" href="javascript:;"><s:property value="%{getText('interview.add')}"/></a>
                <span class="tip_message" id="guest_tip"></span>
                <input type="text" class="long_text_field onlive_guest" id="onlive_guest" name="guests" />
            </li>
        </ul>
        <div class="btn_para"><s:submit cssClass="submit_btn" onclick="return checkOnliveForm();"  value="%{getText('onlive.new.term')}" /> </div>
    </s:form>
</div>
