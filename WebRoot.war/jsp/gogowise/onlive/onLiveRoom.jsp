...
<h2 style="color:#cc6600;"><s:property value="%{getText('onlive.virtual.room.head.title')}"/>：<s:property
        value="channelTerms.liveChannel.name"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <s:property
        value="%{getText('onlive.host.name')}"/>：<s:property value="channelTerms.host.nickName"/></h2>
...
<div style="background-color:#EAEAEA; position: relative; z-index:1;">
    <iframe scrolling=no frameborder="0" src="partyMessage.html" id="messages" name="messages"
            style="position:absolute;z-index:2;background-color:#FFF;top:355px;left:660px;*top:350px;*left:520px;width:300px; height:200px;*width:425px; *height:200px;margin: 0px;tapping:0px"></iframe>
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
            codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" name="Girl"
            width="1004" height="630" id="Girl" wmode="transparent" style="position:relative;z-index:3;">
        <param name="movie" value="<s:property value="flashPatch"/>"/>
        <param name="quality" value="high"/>
        <param name="wmode" value="transparent"/>
        <param name="allowFullScreen" value="true"/>
        <embed src="<s:property value="flashPatch"/>" allowFullScreen="true" width="1004" height="730" quality="high"
