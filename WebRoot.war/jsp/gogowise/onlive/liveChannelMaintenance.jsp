...
<div class="mf_1">
    <p id="sub_nav"><a href="initMyOnlive.html"><s:property value="%{getText('my.onlive')}" /></a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span id="nav_title">如何才能让你的课程更吸引人？</span>（管理栏目信息）</p>
</div>
...
<div class="mf_2">
    ...
    <ul>
        ...
        <li>
            <p class="title"><s:property value="%{getText('channel.term.contetant')}"/></p><a class="add_btn" href="javascript:;"><s:property value="%{getText('interview.add')}"/></a>
            <span class="tip_message" id="player_tip"></span>
            <s:textfield name="contestants" cssClass="long_text_field" id="onlive_player"/>
        </li>
        <li>
            <p class="title"><s:property value="%{getText('channel.term.guest')}"/></p><a class="add_btn" href="javascript:;"><s:property value="%{getText('interview.add')}"/></a>
            <span class="tip_message" id="guest_tip"></span>
            <s:textfield name="guests" cssClass="long_text_field" id="onlive_guest"/>
        </li>
    </ul>
    <p class="btn_para"><s:submit cssClass="submit_btn" onclick="checkOnliveForm();"  value="%{getText('onlive.channel.creation')}" /> </p>
</div>
