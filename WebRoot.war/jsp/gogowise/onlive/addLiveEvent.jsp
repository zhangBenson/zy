...
<div class="eidtorWrap fl">
    <s:form action="saveLiveEvent">
        ...
        <p>
            <label><s:property value="%{getText('liveChannel.new.events.title')}"/></label>&nbsp;&nbsp;&nbsp;<span class="tip_words" id="event_title_tip"></span> <br/><br/>
            <input class="text event_title" type="text" name="liveChannelNewEvent.title"/><br/><br/><br/>
        </p>

        <p>
            <label for="editor1"><s:property value="%{getText('liveChannel.new.events.content')}"/></label> &nbsp;&nbsp;&nbsp;<span class="tip_words" id="event_content_tip"></span> <br/><br/>
            <textarea cols="80" id="editor1" name="liveChannelNewEvent.content" rows="10"><s:property value="%{getText('liveChannel.new.events.description')}"/></textarea>
            <ckeditor:replace  replace="editor1" basePath="js/ckeditor/"  config="<%=settings %>"/>
        </p>

        <p>
            <input class="submit a_focus" type="submit" onclick="return checkEvent();" value="<s:property value="%{getText('show.confirm.to.public')}"/>"/>
        </p>
    </s:form>
...
<script type="text/javascript">
    ...
    function checkEvent(){
        ...
        if(eventTitle == "")  {
            $("#event_title_tip").html("请填写主题！"); b1 = false;
        }else b1 = true;
