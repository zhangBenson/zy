...
<div class="mf_2">
    <s:form action="saveLiveChannel" method="POST" enctype="multipart/form-data">
        ...
        <ul>
            ...
            <li>
                <p class="title"><s:property value="%{getText('onlive.channel.description')}"/><span class="asterisk">*</span></p>
        ...
        <p class="btn_para"><s:submit cssClass="submit_btn" onclick="return checkOnliveForm();"  value="%{getText('create.a.new.channel')}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <s:submit cssClass="submit_btn" onclick="return checkOnliveFormForCreateChannel();"  value="%{getText('create.new.channel.and.new.a.term')}" />
        </p>
    </s:form>
</div>
