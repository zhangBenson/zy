    ...
    <tr>
        <td>
            <s:if test="pagination.hasPre">
                ...
                <s:a href="%{url_pre}" cssClass="page_pre" title="%{getText('pagination.last.page')}"><s:text name="pagination.last.page"/><s:property value="actionName"/></s:a>
            </s:if>
            ...
            <s:if test="pagination.hasNext">
                ...
                <s:a href="%{url_next}" cssClass="page_next" title="%{getText('pagination.next.page')}"><s:text name="pagination.next.page"/></s:a>
            </s:if>
        </td>
    </tr>
</table>
