...
<s:form method="POST" action="createOrganization" id="form" validate="true" theme="css_xhtml"
    ...
    <div id="onlingclass">
        <div id="con1">
            <table width="400" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="tdleft"><s:textfield type="text" name="organization.responsiblePerson.userName"
                                                    id="username"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="tdleft"><s:textfield type="text" name="organization.responsiblePerson.cardId"
                                                    id="card"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="tdleft"><s:textfield type="text" name="organization.responsiblePerson.telphone"
                                                    id="telphone"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="tdleft"><s:textarea type="text" name="organization.description" id="description"
                                                   cssStyle="width: 300px;height: 40px;"/></td>
                </tr>
                <tr>
                    <td class="tdleft">请上传组织机构图片<span class="errorinfo" id="yzslogourl">*</span><s:file name="upload"
                                                                                                        id="fileField"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="tdleft"><s:textfield name="organization.depositBankName" type="text"
                                                    id="depositBankName"/></td>
                </tr>
                <tr>
                    <td class="tdleft">组织机构开户账号 <span class="errorinfo" id="yzdepositBankAccount">*</span></td>
                </tr>
                <tr>
                    <td class="tdleft"><s:textfield name="organization.depositBankAccount" type="text"
                                                    id="depositBankAccount"/></td>
                </tr>
                <tr>
