...
<s:form>
    ...
    <div class="flash_wrap">
        <iframe scrolling=no frameborder="0"  src="partyMessage.html" allowtransparency="true" id="messages"  name="messages"  style="background:#fff;width:430px; height:200px;position:absolute;top:355px;left:485px;z-index:2;"></iframe>
        ...
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" name="Girl" width="1004" height="630" id="Girl" wmode="transparent"  class="flash_obj" >
          ...
          <embed src="<s:property value="flashPatch"/>" allowFullScreen="true" allowtransparency="true" width="1004" height="630" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" name="Girl" id="GirlEmbed"></embed>
        </object>
    </div>
