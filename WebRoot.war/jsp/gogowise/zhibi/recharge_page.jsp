    ...
    <s:form id="transfer_form" action="" validate="true" theme="css_xhtml" method="post">
        <div class="block">
            ...
            <table>
                <tr>
                    <td>充值账号：</td>
                    <td>hailinchl@yeah.net</td>
                </tr>
                <tr>
                    <td>充值类型：</td>
                    <td>知币 &nbsp;&nbsp;&nbsp;&nbsp;1 知币 = 1 元（人民币）</span> </td>
                </tr>
                <tr>
                    <td>充值数额：</td>
                    <td>
                        ...
                        <s:radio list="#{'30':'30知币','60':'60知币','120':'120知币','-1':'其他'}" listKey="key"
                                 listValue="value" name="chargeAmount" cssClass="charge_amount" id="charge_amount"
                                 value="30"/>
                        <input type="text" name="chargeAmountOther" id="input_chargeAmount"/> &nbsp;知币 <span
                            id="money_msg">请输入有效的数额，如：45</span>
                    </td>
                </tr>
                <tr>
                    <td>付款金额：</td>
                    <td><span id="finalMoney">30</span> &nbsp;&nbsp; 元</td>
                </tr>
            </table>
        </div>
