    ...
    <s:form id="transfer_form" action="executeTransfer" validate="true" theme="css_xhtml" method="post">
            <div class="block">
               <h3><s:property value="%{getText('gogowise.zhibi.transfer.step1')}"/></h3>
                <table>
                    <tr><td><s:property value="%{getText('gogowise.zhibi.transfer.receiver')}"/></td><td><s:textfield name="receiver.nickName" id="toName"/></td><td><s:property value="%{getText('gogowise.zhibi.transfer.receiver.nickName')}"/></td></tr>
                    <tr><td><s:property value="%{getText('gogowise.zhibi.transfer.account')}"/></td><td><s:textfield name="receiver.email" id="toEmail"/></td><td><s:property value="%{getText('gogowise.zhibi.transfer.receiver.email')}"/>&nbsp;&nbsp;&nbsp;<span class="tip_words" id="toEmail_tip"></span> </td></tr>
                </table>
            </div>
            <div class="block">
                <h3><s:property value="%{getText('gogowise.zhibi.transfer.step2')}"/></h3>
                <table>
                    <tr><td><s:property value="%{getText('gogowise.zhibi.transfer.zhibi.type')}"/></td><td><s:property value="%{getText('label.zhibi.true')}"/></td><td></td></tr>
                    <tr><td><s:property value="%{getText('gogowise.zhibi.transfer.total')}"/></td><td><s:textfield name="transferMoney" id="transferMoney"/></td><td><s:property value="%{getText('label.zhibi.true')}"/>&nbsp;&nbsp;&nbsp;<span class="tip_words" id="transferMoney_tip"></span> </td></tr>
                    <tr><td><s:property value="%{getText('gogowise.zhibi.transfer.message')}"/></td><td><s:textfield name="transferMessage"/></td><td><s:property value="%{getText('gogowise.zhibi.transfer.tips')}"/></td></tr>
                </table>
            </div>
            <div class="block">
                <h3><s:property value="%{getText('gogowise.zhibi.transfer.step3')}"/></h3>
                <table>
                    <tr><td><s:property value="%{getText('gogowise.zhibi.transfer.payer.account')}"/></td><td><s:property value="#session.email"/></td><td></td></tr>
                </table>
            </div>
            <div class="block">
               <h3><s:property value="%{getText('gogowise.zhibi.transfer.step4')}"/></h3>
                <table>
                    ...
                    <tr><td><s:property value="%{getText('gogowise.zhibi.transfer.confirmCode')}"/></td><td><s:textfield name="checkCode" id="confirmCode"/></td><td><input type="button" value="<s:property value="%{getText('gogowise.zhibi.transfer.achieve.confirmCode')}"/>" onclick="getConfirmCode();"/>&nbsp;&nbsp;&nbsp;<span class="tip_words" id="confirmCode_tip"></span></td></tr>
                </table>
            </div>
            <div class="confirm">
                <input type="submit" onclick="return checkTransferForm();" value="<s:property value="%{getText('confirm.to.transfer')}"/>" />
            </div>
    </s:form>
</div>
