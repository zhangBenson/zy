    ...
    <div class="memeberWrap fl">
         <s:iterator value="baseUsers">
                <div class="memeberInfo fl">
                    <div class="Info1 fl">
                        <a href="userBlog.html?user.id=<s:property value="id"/>" title="<s:property value="nickName"/>"><img class="memberLogo" src="<s:property value="pic"/>"/></a>
                    </div>
                    <div class="Info2 fl">
                        <a class="a_title" href="userBlog.html?user.id=<s:property value="id"/>" title="<s:property value="nickName"/>"><s:property value="nickName"/></a>                       <br/>
                        <span><%--7课程&nbsp;&nbsp;5个人秀&nbsp;&nbsp;4直播&nbsp;&nbsp;--%><s:property value="fansNum"/><s:property value="%{getText('user.add.focus')}"/></span>                                                 <br/>
