        ...
        <ul class="ul_in">
            ...
            <li class="li_3">
                ...
                <s:if test="user.id == #session.userID && owner.id != #session.userID">
                     <span class="span_3"><a onclick="replyToComment('<s:property value="owner.nickName"/>')" href="#message_area_tip">回复</a></span>
                     <span class="span_3"><a onclick="deleteThisComment(this,<s:property value="id"/>)" href="#message_area_tip">删除</a></span>
                </s:if>
