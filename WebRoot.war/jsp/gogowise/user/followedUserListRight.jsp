...
<div class="rightItem1">
    ...
    <s:iterator value="hottestBlogers">
        <div class="onePerson fl">
            ...
            <p class="personMid fl">
                ...
                <span class="sheet"><span class="orange_words"><s:property value="fansNum"/>&nbsp;</span><s:text name="onlive.fensi"/>&nbsp;&nbsp;&nbsp;<%--<span class="orange_words">70&nbsp;</span>课程--%></span>
