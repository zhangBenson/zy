...
<div class="ubd_2">
    <div id="video" style="display:none;float:left;width:560px;height:427px;padding: 2px;border: 1px solid #CCC;background: #ebebeb;">

          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" name="Girl" width="560px" height="427px" id="Girl">
              <param name="movie" value="flash/VideoPlayer.swf" />
              <param name="quality" value="high" />
              <param name="wmode" value="Window" />
              <param name="allowFullScreen" value="true" />
              <embed src="flash/VideoPlayer.swf" allowFullScreen="true" width="560px" height="427px" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="Window" name="Girl" id="GirlEmbed"></embed>
          </object>
    ...
    <div class="ubd_2_1">
        ...
        <a class="a_all" href="#">(<s:property value="%{getText('search.header.all')}"/><s:property value="coursesAsTeacherNum"/>)</a>
        <ul>
            <s:iterator value="coursesAsTeacher" status="idx">
                <li class="li_out">
                    <ul>
                        <li class="li_1"><s:a action="voaCourseBlog"><s:param name="course.id" value="id"/><img src="<s:property value="logoUrl"/>" /></s:a></li>
                        ...
                        <li class="li_4"><s:property value="%{getText('blog.time.left')}"/>&nbsp;&nbsp;<strong id="timeLeftForBook<s:property value="#idx.index"/>"></strong></li>
                    </ul>
                </li>
                <script type="text/javascript">
    ...
    <div class="ubd_2_2">
        ...
        <a class="a_all" href="#">(<s:property value="%{getText('search.header.all')}"/><s:property value="coursesAsStudentNum"/>)</a>
        <ul class="ul_out">
        ...
        <ul>
            <s:iterator value="myShows">
                <li class="course">
                    ...
                    <span title="<s:property value="name"/>"><s:a action="showBlog"><s:param name="myShow.id" value="id" /><s:property value="name"/></s:a></span>
                </li>
            </s:iterator>
        </ul>
    </div>
    ...
    <div class="ubd_2_2">
        ...
        <a class="a_all" href="#">(<s:property value="%{getText('search.header.all')}"/><s:property value="browsedCoursesNum"/>)</a>
        <ul>
            <s:iterator value="browsedCourses">
                <li class="course">
                    <s:a action="voaCourseBlog"><s:param name="course.id" value="course.id"/>
                        <img src="<s:property value="course.logoUrl"/> " title="<s:property value="course.name"/>"  class="courseImg"/>
                    </s:a>
                    <span title="<s:property value="course.name"/>"><s:a action="voaCourseBlog"><s:param name="course.id" value="course.id"/><s:property value="course.name"/></s:a></span>
                </li>
            </s:iterator>
        </ul>
    </div>
    <div class="ubd_2_1">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr><th width="90px"><s:property value="%{getText('onlive.virtual.room.head.title')}"/></th><th><s:property value="%{getText('course.start.time')}"/></th><th><s:property value="%{getText('lable.course.endtime')}"/></th><th><s:property value="%{getText('user.onlive.duration')}"/></th><th><s:property value="%{getText('user.onlive.history.online.reged.fens')}"/></th><th><s:property value="%{getText('user.onlive.history.online.fens')}"/></th><th><s:property value="%{getText('user.onlive.click.num')}"/></th><th><s:property value="%{getText('live.map.address')}"/></th></tr>
        ...
        <div class="ubd_2_3_list">
            <ul class="ul_out" id="message_list_ul">
                <s:iterator value="comments" status="idx">
                    <li class="li_out">
                        <ul class="ul_in">
                            <li class="li_1"><s:a action="userBlog" target="_blank"><s:param name="user.id" value="owner.id"/><img src="<s:property value="owner.pic"/>" class="portraitImg"/></s:a></li>
                            <li class="li_2"><s:a action="userBlog" target="_blank"><s:param name="user.id" value="owner.id"/><s:property value="owner.nickName"/></s:a></li>
                            <li class="li_3">
    ...
    <div class="ubd_3_1">
        ...
        <ul>
            <s:iterator value="students">
                 <li><a href="userBlog.html?user.id=<s:property value="id"/>"><img src="<s:property value="pic"/>" class="portraitImg" title="<s:property value="nickName"/>"/></a></li>
            </s:iterator>
    ...
    <div class="ubd_3_1">
        ...
        <ul>
           <s:iterator value="userFanses">
                 <li><a href="userBlog.html?user.id=<s:property value="fan.id"/>"><img src="<s:property value="fan.pic"/>" title="<s:property value="fan.nickName"/>"/></a></li>
            </s:iterator>
            <li class="li_turn"><a href="javascript:;" class="turn_left" title="<s:property value="%{getText('pagination.last.page')}"/>"></a><a href="javascript:;"class="turn_right" title="<s:property value="%{getText('pagination.next.page')}"/>"></a></li>
        </ul>
    </div>
