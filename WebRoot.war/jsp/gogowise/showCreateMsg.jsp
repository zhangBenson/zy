...
<div>
    <div id="protocol">
        ...
        <div id="cons">
            ...
            <p> 2、甲方及所属所有教师在知元网进行网络教学所产生的收益，包括网络实时教学、教学录像、教学课件等（以下简称为甲方版权收益），乙方将支付甲方此收益的20%作为甲方的版权收益；</p>
            ...
            <p> 5、甲方有权随时变更知元网负责人，通过<span class="highlight">知元网首页&gt;&gt;组织机构&gt;&gt;变更负责人</span>进入负责人变更流程。一旦变更完成，原负责人将终生拥有其负责期内甲方版权收益的8%，同时乙方开始支付新负责人其负责期内所开办新的课程产生版权收益的8%作为其劳动报酬。我们收到贵校负责人变更协议后生效，生效日期以邮戳为准。
            </p>
            ...
            <p> 8、乙方工作人员在为甲方提供服务之前，必须获得相关老师以及学校负责人的批准，批准流程在知元网中实现；</p>
            ...
            <p>
                14、此协议一式四份，甲方一份、甲方知元网负责人一份，乙方两份，乙方收到两份甲方签字、盖章协议原件以及一份加盖甲方公章的甲方法人执照复印件后，经乙方审核确认真实后协议生效，生效日期以邮件收到日邮戳为准。</p>
