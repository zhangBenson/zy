...
<div class="course_msg">
    <div class="course_title">
        <s:a action="voaCourseBlog" target="_blank"><s:param name="course.id" value="courseClass.course.id"/><s:property
    ...
    <div class="operate">
        <a id="invite_students" class="submit_btn" href="#invite_student_container"
           title="<s:property value="%{getText('course.invite.tip.words')}"/>"><s:property
