...
<div class="content_container">
    <div class="content_body">
        <ul>
            <li class="help_question" onclick="showAnswer(this);"><span class="num">1</span><s:property
                    value="%{getText('faq1')}"/></li>
            ...
            <li class="help_question" onclick="showAnswer(this);"><span class="num">2</span><s:property
                    value="%{getText('faq2')}"/></li>
            <li class="help_answer">
                <div class="pic_1"></div>
                <div class="pic_2">
                    <p>
            ...
            <li class="help_question" onclick="showAnswer(this);"><span class="num">3</span><s:property
                    value="%{getText('faq3')}"/></li>
            <li class="help_answer">
                <div class="pic_1"></div>
                <div class="pic_2">
                    <ul>
            ...
            <li class="help_question" onclick="showAnswer(this);"><span class="num">4</span><s:property
                    value="%{getText('faq4')}"/></li>
            <li class="help_answer">
                <div class="pic_1"></div>
                <div class="pic_2">
                    <ul>
            ...
            <%--<div class="pic_3"></div>--%>
            <%--</li>--%>
            <li class="help_question" onclick="showAnswer(this);"><span class="num">5</span><s:property
                    value="%{getText('faq5')}"/></li>
            <li class="help_answer">
                <div class="pic_1"></div>
                <div class="pic_2">
                    <ul>
