...
<div id="wrapper">
    ...
    <div id="MapInfoCon">
        <p><s:property value="%{getText('map.body.param3',{personalOnlives.size})}"/></p>
        <s:iterator value="personalOnlives" id="perO" status="idx">
            <div class="infoWrap" onclick="moveCenterTo(markers,infoWindows,<s:property value="#idx.Index"/>,<s:property
                ...
                <div class="infoMid">
                    ...
                    <ul>
                        <li><s:property value="%{getText('map.body.param5')}"/><s:property value="#perO.address"/></li>
                ...
                <div class="infoRight">
                    <a href="userBlog.html?user.id=<s:property value="#perO.owner.id"/>" target="_blank"
                       title="<s:property value="%{getText('map.body.param7',{#perO.owner.nickName})}"/>"><img
...
//            if(!bMap.getBounds().contains(livePoint)) continue;
        ...
        sContent =
                <%--"<h4 style='margin:0 0 5px 0;padding:0.2em 0'><s:property value="%{getText('per.onlive.room',{owner.nickName})}"/></h4>" +--%>
