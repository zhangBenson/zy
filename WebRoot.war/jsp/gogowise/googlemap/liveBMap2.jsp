    ...
    <div id="MapInfoCon">
        ...
        <s:iterator value="personalOnlives" id="perO" status="idx">
            <div class="infoWrap" onclick="moveCenterTo(markers,infoWindows,<s:property value="#idx.Index"/>,<s:property value="#perO.latitude"/>,<s:property value="#perO.longitude"/>)">
                ...
                <div class="infoRight">
                    <a href="userBlog.html?user.id=<s:property value="#perO.owner.id"/>"  target="_blank" title="<s:property value="%{getText('map.body.param7',{#perO.owner.nickName})}"/>"><img src="<s:property value="#perO.owner.pic"/>" alt="<s:property value="#perO.owner.nickName"/>" /></a>
                </div>
            </div>
        </s:iterator>
