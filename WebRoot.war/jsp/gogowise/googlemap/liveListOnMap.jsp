...
<div id="wrapper">
    ...
    <div id="MapInfoCon">
        ...
        <s:iterator value="personalOnlives" id="perO" status="idx">
            <div class="infoWrap" onclick="moveCenterTo(markers,infoWindows,<s:property value="#idx.Index"/>,<s:property value="#perO.latitude"/>,<s:property value="#perO.longitude"/>)">
                <div class="infoLeft">
        ...
        <s:iterator value="otherPersonalOnlives" id="perO" status="idx">
            <div class="infoWrap" onclick="moveCenterTo(markers,infoWindows,<s:property value="#idx.Index + personalOnlives.size"/>,<s:property value="#perO.latitude"/>,<s:property value="#perO.longitude"/>)">
                <div class="infoLeft">
                    <a class="bubbleA" style="background-position:-<s:property value="(personalOnlives.size + #idx.Index)*24"/>px -198px;"></a>
                </div>
                <div class="infoMid">
                    <h3><s:property value="#perO.title"/></h3>
                    <ul>
