...
<div id="tools">
    <div class="tools_l" id="citytools">
        <div id="selCity">
            <div class="sel_container">
                <a href="javascript:void(0)" id="curCity" class="curcity-expand"
                   title="<s:property value="%{getText('map.selCity.param1')}"/>"
                   onclick="selectCity(this, {styleSwitch:true});return false">长沙市</a>
            </div>
            <font id="GR_Select" style="display:none">
                <a id="GR_SelectCity" class="curcity-expand" href="javascript:void(0)"
                   onclick="Instance('TANGRAM__t').showGRPop(this, 0);return false;">选择城区</a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a id="GR_SelectArea" class="curcity-expand" href="javascript:void(0)"
                   onclick="Instance('TANGRAM__t').showGRPop(this, 1)" style="visibility:hidden">选择地段</a>
            </font>
            <font id="supBus"> </font>
        </div>
        <div id="tools_search" style="display:none;">
            <form onsubmit="toolbarSubmit();return false" name="tsform">
                ...
                <div class="tsbutton"><input value="<s:property value="%{getText('map.selCity.param3')}"/>"
                                             onmouseover="this.className='tools_search_submit tools_search_submit_over'"
    ...
    <div id="MapInfoNav" class="tools_r">
        <div class="l-tools">
            ...
            <a id="favBtn" href="javascript:;"><span><s:property value="%{getText('map.body.param2')}"/></span></a>
        </div>
    </div>
</div>
...
<div id="wrapper">
    ...
    <div id="MapInfoCon">
        <p><s:property value="%{getText('map.body.param4',{personalOnlives.size})}"/></p>
        <s:iterator value="personalOnlives" id="perO" status="idx">
            <div class="infoWrap" onclick="moveCenterTo(markers,infoWindows,<s:property value="#idx.Index"/>,<s:property
                    value="#perO.latitude"/>,<s:property value="#perO.longitude"/>)">
                <div class="infoLeft">
                    <a class="bubbleA" style="background-position:-<s:property value="#idx.Index*24"/>px -198px;"></a>
                </div>
                <div class="infoMid">
                    ...
                    <a href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="id"/>" class="submit_btn"
                       target="_blank"><s:property value="%{getText('click.to.watch')}"/></a>
                </div>
                <div class="infoRight">
                    <a href="userBlog.html?user.id=<s:property value="#perO.owner.id"/>" target="_blank"
                       title="<s:property value="#perO.owner.nickName"/>"><img
                            src="<s:property value="#perO.owner.pic"/>"
                            alt="<s:property value="#perO.owner.nickName"/>"/></a>
                </div>
            </div>
        </s:iterator>

        <p><s:property value="%{getText('map.body.param6')}"/></p>
        <s:iterator value="otherPersonalOnlives" id="perO" status="idx">
            <div class="infoWrap"
                 onclick="moveCenterTo(markers,infoWindows,<s:property value="#idx.Index + personalOnlives.size"/>,
                     <s:property value="#perO.latitude"/>,<s:property value="#perO.longitude"/>)">
                <div class="infoLeft">
                    <a class="bubbleA" style="background-position:-<s:property
                            value="(personalOnlives.size + #idx.Index)*24"/>px -198px;"></a>
                </div>
                <div class="infoMid">
                    <h3><s:property value="#perO.title"/></h3>
                    <ul>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        myCity.get(function (result) {
            bMap.centerAndZoom(result.name, 13);                   // 初始化地图,设置城市和地图级别。
        });
        </s:if>
        ...
        <%-- 将被查看直播置于地图中间--%>
        bMap.centerAndZoom(livePoint, 12);                   // 初始化地图,设置城市和地图级别。
        </s:if>

        markerIcon = new BMap.Icon("images/map/markers_new_wn5i2b.png", new BMap.Size(24, 29));
        markerIcon.setImageOffset(new BMap.Size(-<s:property value="#idx.Index*24"/>, -198));
        ...
        <s:if test="#idx.Index == 0">
        marker<s:property value="id"/>.openInfoWindow(infoWindow<s:property value="id"/>);
        </s:if>
        </s:iterator>
        <s:iterator value="otherPersonalOnlives"  status="idx">
        perLat = <s:property value="latitude"/>;
        perLng = <s:property value="longitude"/>;
        livePoint = new BMap.Point(perLng, perLat);

        markerIcon = new BMap.Icon("images/map/markers_new_wn5i2b.png", new BMap.Size(24, 29));
        markerIcon.setImageOffset(new BMap.Size(-<s:property value="(personalOnlives.size + #idx.Index)*24"/>, -198));
        var marker<s:property value="id"/> = new BMap.Marker(livePoint, {icon: markerIcon});    // 创建标注
        sContent =
                "<a href='userBlog.html?user.id=<s:property value="owner.id"/>''  target='_blank'><img style='float:right;margin:14px 4px 4px 4px' src='<s:property value="owner.pic"/>' width='70' height='70' title='<s:property value="%{getText('map.body.param7',{owner.nickName})}"/>'/></a>" +
                        "<p style='margin:0;line-height:1.5;font-size:13px;'><s:property value="title"/></p>" +
