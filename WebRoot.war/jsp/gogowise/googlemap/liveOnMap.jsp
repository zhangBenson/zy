...
<div id="tools">
    ...
    <div id="MapInfoNav" class="tools_r">
        <div class="l-tools">
            ...
            <a id="favBtn" href="javascript:void(0)"><span><s:property
                    value="%{getText('map.body.param2')}"/></span></a>
        </div>
    </div>
</div>
...
<div id="wrapper">
    ...
    <div id="MapInfoCon">
        <div class="infoWrap"
             onclick="moveCenterTo(markers,infoWindows,0,<s:property value="personalOnlive.latitude"/>,<s:property
                     value="personalOnlive.longitude"/>)">
            <div class="infoLeft">
                <a class="bubbleA"></a>
            </div>
            <div class="infoMid">
                ...
                <a href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="personalOnlive.id"/>"
                   class="submit_btn" target="_blank"><s:property value="%{getText('click.to.watch')}"/></a>
            </div>
            <div class="infoRight">
                <a href="userBlog.html?user.id=<s:property value="personalOnlive.owner.id"/>" target="_blank"
                   title="<s:property value="personalOnlive.owner.nickName"/>"><img
                        src="<s:property value="personalOnlive.owner.pic"/>"
                        alt="<s:property value="personalOnlive.owner.nickName"/>"/></a>
            </div>
        </div>
        <p><s:property value="%{getText('map.body.param6')}"/></p>
        <s:iterator value="personalOnlives" id="perO" status="idx">
            <div class="infoWrap"
                 onclick="moveCenterTo(markers,infoWindows,<s:property value="#idx.Index + 1"/>,<s:property
                         value="#perO.latitude"/>,<s:property value="#perO.longitude"/>)">
                <div class="infoLeft">
                    <a class="bubbleA"
                       style="background-position:-<s:property value="(#idx.Index+1)*24"/>px -198px;"></a>
                </div>
                <div class="infoMid">
