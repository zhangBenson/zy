...
<div class="dfz-nav fl">
    <div class="fl">
        <p class="bnav">
            ...
            <a href="javascript:;"><s:property value="%{getText('show.square.new.events')}"/></a><i>&gt;</i><s:property value="%{getText('gogowise.news.content')}"/>
        </p>
    </div>
</div>
...
<div class="wrap fl">
    <div class="con fl">
        <div class="article-title">
            <h2 id="share_title"><s:property value="showNewEvent.title"/></h2>
            <div class="artInfo" id="blk_n001_003">
                <span id="pub_date"><s:date name="showNewEvent.createTime" format="%{getText('dateformat.forclass')}"/></span>&nbsp;&nbsp;
                <span id="media_name">
                    <a class="pub_name" href="userBlog.html?user.id=<s:property value="showNewEvent.owner.id"/>" target="_blank"><s:property value="showNewEvent.owner.nickName"/></a>&nbsp;&nbsp;&nbsp;
                </span>
            </div>
        </div>
        <div class="main-body">
            <%--<img  style="float:left;display: inline;margin:0 15px 15px 0;" alt="" src="<s:property value="showNewEvent.logoUrl"/>" title="<s:property value="showNewEvent.title"/>"/>--%>
            <p id="mainContent">　&nbsp;
                 <s:property value="showNewEvent.content"/>
            </p>
        </div>
