...
<div class="dfz-nav fl">
    <div class="fl">
        ...
        <p class="bnav">
            ...
            <a href="javascript:;"><s:property value="%{getText('gogowise.live.trailer')}"/></a><i>&gt;</i><s:property value="%{getText('gogowise.news.content')}"/>
        </p>
    </div>
</div>
...
<div class="wrap fl">
    <div class="con fl">
        ...
        <div class="artInfo" id="blk_n001_003">
            <span id="pub_date"><s:date name="liveTrailer.publishTime" format="%{getText('dateformat.forclass')}"/></span>&nbsp;&nbsp;
            <span id="media_name">
                <a class="pub_name" href="userBlog.html?user.id=<s:property value="liveTrailer.owner.id"/>" target="_blank"><s:property value="liveTrailer.owner.nickName"/></a>&nbsp;&nbsp;&nbsp;
                <s:if test="personalOnlive != null">
                     <a class="watch" href="watchPersonalOnlive.html?personalOnlive.id=<s:property value="personalOnlive.id"/>" target="_blank"><s:property value="%{getText('watch.the.live.term')}"/></a>
                </s:if>
                <s:else>
                     <a class="watch" href="userBlog.html?user.id=<s:property value="liveTrailer.owner.id"/>" target="_blank"><s:property value="%{getText('enter.into.user.blog')}"/></a>
                </s:else>
            </span>
        </div>
        <div class="main-body">
