...
<div class="dfz-nav fl">
    <div class="fl">
        ...
        <p class="bnav">
            ...
            <a href="javascript:;"><s:text name="gogowise.announce"/></a><i>&gt;</i><s:property value="%{getText('gogowise.news.content')}"/>
        </p>
    </div>
</div>
    ...
    <div class="con fl">
        <div class="article-title">
            ...
            <div class="artInfo" id="blk_n001_003">
                <span id="pub_date"><s:date name="goGoWiseAnnounce.publishTime"
                                            format="%{getText('dateformat.forclass')}"/></span>&nbsp;&nbsp;
                <span id="media_name">
                    <a class="pub_name" href="userBlog.html?user.id=<s:property value="goGoWiseAnnounce.owner.id"/>"
                       target="_blank"><s:property value="goGoWiseAnnounce.owner.nickName"/></a>&nbsp;&nbsp;&nbsp;
                </span>
            </div>
        </div>
        <div class="main-body">
