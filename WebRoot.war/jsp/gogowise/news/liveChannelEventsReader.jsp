...
<div class="dfz-nav fl">
    <div class="fl">
        ...
        <p class="bnav">
            ...
            <a href="javascript:;"><s:text name="live.square.new.events"/></a><i>&gt;</i><s:text name="gogowise.news.content"/>
        </p>
    </div>
</div>
...
<div class="wrap fl">
    <div class="con fl">
        <div class="article-title">
            ...
            <div class="artInfo" id="blk_n001_003">
                <span id="pub_date"><s:date name="liveChannelNewEvent.createTime"
                                            format="%{getText('dateformat.forclass')}"/></span>&nbsp;&nbsp;
                <span id="media_name">
                    <a class="pub_name" href="userBlog.html?user.id=<s:property value="liveChannelNewEvent.owner.id"/>"
                       target="_blank"><s:property value="liveChannelNewEvent.owner.nickName"/></a>&nbsp;&nbsp;&nbsp;
                </span>
            </div>
        </div>
        <div class="main-body">
    ...
    <div class="side fr">
        ...
        <div class="sdiv sdivt3">
            <h3 class="stit"><strong><a target="_blank" href="http://hunan.sina.com.cn/news/"><s:text name="live.square.new.events"/></a></strong></h3>
            <ul class="everyday-list">
                <s:iterator value="liveChannelNewEvents">
                    <li><a href="liveChannelEventRead.html?liveChannelNewEvent.id=<s:property value="id"/>"
                           class="liveChannel_newEvents"><s:property value="title"/></a></li>
                </s:iterator>
            </ul>
        </div>

        <div class="sdiv vedio-recom clear">
            <h3 class="stit"><strong><a href="javascript:;"><s:text name="news.center.recommend.video"/></a></strong><span><a href="javascript:;"
                                                                                                                              class="grey"><s:text name="others.more"/>&gt;&gt;</a></span></h3>
            <ul class="recom-list clear">
                <s:iterator value="liveChannels">
                    <li>
                        <a href="liveTermBlog.html?channelTerms.id=<s:property value="lastOwnRecordTerm.id"/>"
                           title="<s:property value="lastOwnRecordTerm.subTitle"/>"><img
                                src="<s:property value="lastOwnRecordTerm.logoUrl"/>"
                                alt="<s:property value="lastOwnRecordTerm.subTitle"/> "></a>
                            <%--<i>03:02</i>--%>
