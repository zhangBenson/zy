...
<div class="dfz-nav fl">
    <div class="fl">
        ...
        <p class="bnav">
            ...
            <a href="javascript:;"><s:property value="%{getText('live.square.new.events')}"/></a><i>&gt;</i><s:property value="%{getText('gogowise.news.content')}"/>
        </p>
    </div>
</div>
...
<div class="wrap fl">
    <div class="con fl">
        <div class="article-title">
            <h2 id="share_title"><s:property value="liveChannelNewEvent.title"/></h2>
            <div class="artInfo" id="blk_n001_003">
                <span id="pub_date"><s:date name="liveChannelNewEvent.createTime" format="%{getText('dateformat.forclass')}"/></span>&nbsp;&nbsp;
                <span id="media_name">
                    <a class="pub_name" href="userBlog.html?user.id=<s:property value="liveChannelNewEvent.owner.id"/>" target="_blank"><s:property value="liveChannelNewEvent.owner.nickName"/></a>&nbsp;&nbsp;&nbsp;
                </span>
            </div>
        </div>
        <div class="main-body">
            <%--<img  style="float:left;display: inline;margin:0 15px 15px 0;" alt="" src="<s:property value="liveChannelNewEvent.logoUrl"/>" title="<s:property value="liveChannelNewEvent.title"/>"/>--%>
            <p id="mainContent">　&nbsp;<s:property value="liveChannelNewEvent.content"/></p>
        </div>
     ...
     <div class="sdiv sdivt3">
            ...
            <ul class="everyday-list">
                <s:iterator value="goGoWiseAnnounces">
                  <li> <a href="announceRead.html?goGoWiseAnnounce.id=<s:property value="id"/>" class="goGoWiseAnnounce_newEvents"><s:property value="title"/></a></li>
                </s:iterator>
            </ul>
        </div>
         ...
         <div class="sdiv sdivt3">
            ...
            <ul class="everyday-list">
                <s:iterator value="liveTrailers">
                  <li> <a href="liveTrailerRead.html?liveTrailer.id=<s:property value="id"/>" class="goGoWiseAnnounce_newEvents"><s:property value="title"/></a></li>
                </s:iterator>
            </ul>
        </div>
        ...
        <div class="sdiv sdivt3">
            ...
            <ul class="everyday-list">
               <s:iterator value="courseNewEvents">
                <li><a href="courseEventRead.html?courseNewEvent.id=<s:property value="id"/>" class="course_newEvents"><s:property value="title"/></a></li>
               </s:iterator>
            </ul>
        </div>
        ...
        <div class="sdiv sdivt3">
            ...
            <ul class="everyday-list">
               <s:iterator value="showNewEvents">
                <li><a href="showEventRead.html?showNewEvent.id=<s:property value="id"/>" class="show_newEvents"><s:property value="title"/></a></li>
               </s:iterator>
            </ul>
        </div>
        ...
        <div class="sdiv">
            <h3 class="stit"><strong><a href="javascript:;"><s:property value="%{getText('news.center.course.recommend')}"/></a></strong><span><a href="javascript:;" class="grey"><s:property value="%{getText('others.more')}"/>&gt;&gt;</a></span></h3>
            <ul class="recom-list clear">
                <s:iterator value="courses">
                    <li>
                        <a href="voaCourseBlog.html?course.id=<s:property value="id"/>" target="_blank"><img src="<s:property value="logoUrl"/>" alt="<s:property value="name"/>"></a>
