...
#bottom{ width:1020px; margin-left:138px;margin-top:-1px; background: url(images/first_32.gif) top no-repeat; height:29px; float:left;}
...
#footercontent{ text-align:center; color:#FFFFFF;}
.title1{ font-size:18px; color:#800040; padding:10px 0 0 6px; font-weight:bold; text-align:center;}
.title2{ font-weight:bold; font-size:14px; color:#333; padding:30px 0 10px 6px; border-bottom:#333 dashed 1px;}
.tbleft{ text-align:right; width:80px; vertical-align:middle; padding:10px 6px 10px 0px;}
.btn{ background-repeat:no-repeat; width:75px; height:30px; border:none; cursor:pointer;}
#btn1{ background:url(images/submitsignup.gif);}
#btn2{ background:url(images/reset.gif);}
#tablebottom{border-top:#333 dotted 1px; text-align:center; padding-top:20px; height:60px;}
.wronginfo{ font-size:12px; color:#F00;}
#toptb{ padding:4px 0 10px 5px;}
</style>
...
<div id="main">
  ...
  <table width="750" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
           ...
           <s:else>
                    <td class="tbleft">Email：</td>
                    <td><s:textfield name="singUpInfo.user.email" id="email"/><span id="yzemail" class="wronginfo">*</span></td>
           </s:else>
      </tr>
    ...
    <tr>
      ...
      <td>
           <s:select list="#{1:{getText('singup.singType.1')},2:{getText('singup.singType.2')},3:{getText('singup.singType.3')}}" name="singUpInfo.singType" listKey="key" listValue="value" headerKey="" headerValue="请选择演唱形式" id="singtype"/>
    ...
    <tr>
      ...
      <td><p>
        <label>
            <s:select list="#{true:'[男]',false:'[女]'}"  name="singUpInfo.user.sexy" listKey="key" listValue="value" headerKey="" headerValue="请选择性别" id="sex"/>
    ...
    <tr>
      ...
      <td>
          <s:textfield name="singUpInfo.phone" id="phone" required="true"/>  <span class="wronginfo" id="yzphone">*</span></td>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
          <s:if test="%{showCompetitionSessionList}">
                <s:if test="%{competition.id}">
                   <s:select name="sessionId" list="competitionSession" listKey="key" listValue="value" headerKey="" headerValue="请选参赛场次" id="competition"/><span class="wronginfo" yd="yzcompetition">*</span>
                 </s:if>
           </s:if>
      </td>
      <td class="tbleft">照片：</td>
      <td rowspan="3">
        <s:if test="%{haveUserInfo}"><img src="<s:property value="singUpInfo.user.pic"/>" width="80" height="80" id="reImg"/></s:if>
      ...
      <td colspan="4" align="center" id="tablebottom">
          <s:submit name="singUp" action="saveSingUp" value="" style="background-repeat:no-repeat; width:75px; height:30px; border:none; cursor:pointer;background:url(images/submitsignup.gif);"></s:submit>
            &nbsp;&nbsp;&nbsp;
          <s:reset name="reset" value="" style="background-repeat:no-repeat; width:75px; height:30px; border:none; cursor:pointer;background:url(images/reset.gif);"/>
      </td>
      </tr>
  </table>
