    ...
    <div id="mainEnter">
        ...
        <div id="center">
            <table width="400" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="tdleft"><h1><img src="images/safe.gif" width="17" height="19"/><s:text name="label.safety.valid"/></h1></td>
                ...
                <tr>
                    <td colspan="2" class="btn"><a href="#" class="repassword_submit_btn"
                                                   onclick="sendEmail();"><s:text name="button.send.valid.code"/></a></td>
                </tr>
                <tr class="con">
                ...
                <tr>
                    <td colspan="2" class="btn"><s:submit cssClass="repassword_submit_btn"
                                                          value="%{getText('button.submit')}"/></td>
                </tr>
            </table>
        </div>
    </div>
