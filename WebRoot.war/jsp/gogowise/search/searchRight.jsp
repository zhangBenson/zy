    ...
    <s:iterator value="hottestTeachers">
         <div class="onePerson fl">
            ...
            <p class="personMid fl">
                <a class="title" href="userBlog.html?user.id=<s:property value="id"/>" title="<s:property value="nickName"/>"><s:property value="nickName"/></a>
                <span class="sheet"><span class="orange_words"><s:property value="fansNum"/>&nbsp;</span><s:property value="%{getText('user.add.focus')}"/>&nbsp;&nbsp;&nbsp;<%--<span class="orange_words">70&nbsp;</span>课程--%></span>
