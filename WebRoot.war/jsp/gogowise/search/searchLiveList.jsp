            ...
            <s:iterator value="liveChannels">
                <div class="listView fl">
                    <div class="viewRight fl">
                        ...
                        <a class="person" href="userBlog.html?user.id=<s:property value="creator.id"/>"
                           title="<s:property value="creator.nickName"/>"><img width="30" height="30"
                                                                               src="<s:property value="creator.pic"/>"/></a>
                    </div>
                    ...
                    <div class="viewLeft fl">
                        <p class="title">
                            ...
                            <a class="watch orange_words"
                               href="liveChannelBlog.html?liveChannel.id=<s:property value="id"/>"><s:text name="gogowise.things.details"/></a>
                        </p>

                        <p class="info">
                            <span><span class="orange_words"><s:date name="createTime"
                                                                     format="%{getText('dateformat')}"/></span></span>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <span><span class="orange_words"> <s:property value="fansNum"/>&nbsp;</span><s:text name="course.blog.purchase.num"/></span>&nbsp;&nbsp;|&nbsp;&nbsp;
                                <%--<span><span class="orange_words"> 247&nbsp;</span>推荐</span> &nbsp;&nbsp;|&nbsp;&nbsp;--%>
                            <span><s:text name="course.blog.total.terms"/><span class="orange_words"> <s:property value="totalTermsNum"/>&nbsp;</span><s:text name="course.blog.total.terms.tail"/></span>
                        </p>
