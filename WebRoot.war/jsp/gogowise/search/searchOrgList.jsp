    ...
    <div class="memeberWrap orgInfo fl">
         ...
         <s:iterator value="organizations">
            <div class="memeberInfo fl">
                <div class="Info1 fl">
                    <a href="orgBlog.html?org.id=<s:property value="id"/>" title="<s:property value="schoolName"/>"><img class="orgLogo" src="<s:property value="logoUrl"/>"/></a>
                </div>
                <div class="Info2 fl">
                    ...
                    <span><%--7老师&nbsp;&nbsp;5课程&nbsp;&nbsp;--%><s:property value="fansNum"/><s:property value="%{getText('user.add.focus')}"/></span>
