...
<div class="listUp">
    ...
    <h3 class="h3_title"><a href="javascript:;" onclick="startSearch(2);"><s:property value="%{getText('search.header.member')}"/></a>&nbsp;|&nbsp;<a href="javascript:;" onclick="startSearch(3);"><s:property value="%{getText('search.header.organization')}"/></a></h3>
    ...
    <div class="memeberWrap fl">
        ...
        <s:iterator value="baseUsers">
           <div class="memeberInfo fl">
                <div class="Info1 fl">
                    <a href="userBlog.html?user.id=<s:property value="id"/>" title="<s:property value="nickName"/>"><img src="<s:property value="pic"/>"/></a>
                </div>
                <div class="Info2 fl">
    ...
    <s:iterator value="courses">
        <div class="listView fl">
                <div class="viewRight fl">
                    <a class="img" href="voaCourseBlog.html?course.id=<s:property value="id"/>" title="<s:property value="name"/>">
                        <img src="<s:property value="logoUrl"/>" />
                    </a>
                    <a class="person" href="userBlog.html?user.id=<s:property value="teacher.id"/>" title="<s:property value="teacher.nickName"/>"><img width="30" height="30" src="<s:property value="teacher.pic"/>"/></a>
                </div>
                ...
                <div class="viewLeft fl">
                    ...
                    <p class="info">
                        ...
                        <span><s:property value="%{getText('course.blog.total.terms')}"/><span class="orange_words"> <s:property value="courseTermsNum" />&nbsp;</span><s:property value="%{getText('course.blog.total.terms.tail')}"/></span>
                    </p>
