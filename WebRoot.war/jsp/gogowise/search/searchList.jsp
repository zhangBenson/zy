...
<div class="listUp">
    ...
    <h3 class="h3_title"><a href="javascript:;" onclick="startSearch(2);"><s:text name="search.header.member"/></a>&nbsp;|&nbsp;<a href="javascript:;"
                                                                                                                                   onclick="startSearch(3);"><s:text name="search.header.organization"/></a></h3>
...
<div class="listDown fl">
    <h3 class="h3_title"><a href="javascript:;" onclick="startSearch(4);"><s:text name="search.header.course"/></a>
            ...
            <div class="viewLeft fl">
                ...
                <p class="info">
                    ...
                    <span><s:text name="course.blog.total.terms"/><span
                            class="orange_words"> <s:property value="courseTermsNum"/>&nbsp;</span><s:text name="course.blog.total.terms.tail"/></span>
                </p>
