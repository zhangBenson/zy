                    ...
                    <div class="viewLeft fl">
                        <p class="title">
                            ...
                            <a class="watch orange_words"
                               href="showBlog.html?myShow.id=<s:property value="id"/>"><s:text name="gogowise.things.details"/></a>
                        </p>
                        ...
                        <p class="info">
                            ...
                            <span><s:text name="course.blog.total.terms"/><span class="orange_words"> <s:property value="showTermsNum"/>&nbsp;</span><s:text name="course.blog.total.terms.tail"/></span>
                        </p>
