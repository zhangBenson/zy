...
<s:form>
    ...
    <div class="flash_wrap flash_one2three">
        <iframe scrolling=no frameborder="0" src="partyMessage.html" id="messages" name="messages"
                style="position:absolute;z-index:2;background-color: white;top:410px;left:522px;;width:425px; height:230px;"></iframe>

        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0"
                name="Girl" width="1004" height="730" id="Girl" wmode="transparent" class="flash_obj flash_obj_large">
