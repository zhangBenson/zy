...
<s:form>
 ...
 <script language="JavaScript" type="text/javascript">
    ...
    <div class="flash_wrap">
        <iframe scrolling=no frameborder="0"  src="partyMessage.html" id="messages"  name="messages"  style="position:absolute;z-index:2;background-color: white;top:355px;left:520px;width:430px; height:200px;margin: 0px;padding:0px"></iframe>
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" name="Girl" width="1004" height="630" id="Girl" wmode="transparent"  class="flash_obj flash_obj_large" >
