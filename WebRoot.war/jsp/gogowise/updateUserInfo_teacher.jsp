                    ...
                    <ul>
                        ...
                        <li>
                            <table class="account_table">
                                <tr><td colspan="2"><span class="option_tittle"><
                                    s:property value="%{getText('label.account.info1')}"/><span class="accountTip">
                                    <s:text name="messege.account.bank"/></span></span></td> </tr>
                                <tr>
