...
<%@ taglib prefix="s" uri="struts-tags.tld" %>
 ...
 .title{ font-size:16px; color:#800040; border-bottom: #999999 dotted 2px; height:40px; vertical-align:bottom; text-align:center;}
 .item{ text-align:right; font-size:12px; width:140px; border:#FFFFFF solid thin; height:25px;}
 .item1{ font-size:12px; color:#333333; border:#FFFFFF solid thin;}
 .table1{ background-color:#F2F2F2; border: #CCCCCC 2px solid; margin-top:5px;}
...
<table width="680" cellspacing="0" class="table1">
  ...
  <tr>
    <td class="item">昵称</td>
    <td class="item1"><form id="form2" name="form2" method="post" action="">
      <label>
        <input type="text" name="textfield" id="textfield" value=<s:property value="competitionPhase.competition.subject.owner.nickName"/> >
        </label>
    </form>    </td>
    <td class="item">邮箱</td>
  ...
  <tr>
    ...
    <td rowspan="2" class="item1"><input type="image" name="imageField" id="imageField" src="file:///G|/www.gogowise.com/Images/"<s:property value="competitionPhase.competition.subject.owner.pic"/> width="60px" height="65px;" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="item1"><form id="form7" name="form7" method="post" action="">
      <label>
    ...
    <td rowspan="2" class="item1"><form id="form4" name="form4" enctype="multipart/form-data" method="post" action="">
      <label>
  ...
  <tr>
    <td class="item">手机</td>
    <td class="item1"><form id="form8" name="form8" method="post" action="">
      <label>
  ...
  <tr>
    ...
    <td class="item1"><form id="form5" name="form5" method="post" action="">
      <label>
        <input type="text" name="textfield2" id="textfield2" value="<s:property value="competitionPhase.competition.subject.owner.question"/> " />
        </label>
    </form>
    </td>
    <td class="item">知券</td>
  ...
  <tr>
    ...
    <td class="item1"><form id="form6" name="form6" method="post" action="">
      <label>
        <input type="text" name="textfield3" id="textfield3" value="<s:property value="competitionPhase.competition.subject.owner.answer"/> "/>
        </label>
    </form>
    </td>
    <td class="item">&nbsp;</td>
  ...
  <tr class="item">
    <td colspan="4" align="center" valign="middle"><form id="form1" name="form1" method="post" action="">
      <label>
        <br />
