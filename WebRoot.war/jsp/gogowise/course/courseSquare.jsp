            ...
            <s:iterator value="courses">
               <li>
                    ...
                    <div class="date_reserve">
                        <span class="date"><s:date name="classOnTheCorner.date" format="%{getText('dateformat.forclass')}"/></span>
    ...
    <div class="highlight">
        ...
        <ul>
           <s:iterator value="courseNewEvents">
            <li><div class="dot"></div><a href="courseEventRead.html?courseNewEvent.id=<s:property value="id"/>" title="<s:property value="title"/>" class="course_newEvents"><s:property value="title"/></a></li>
           </s:iterator>
        </ul>
    </div>
    <%--<div class="ad_img"></div>--%>
    ...
    <div class="hot_teacher sc_d">
        ...
        <ul>
            <s:iterator value="hottestTeacher">
                <li>
                    <a class="img" href="userBlog.html?user.id=<s:property value="id"/>" title="<s:property value="nickName"/>"><img src="<s:property value="pic"/>"/></a>
                    <a class="nick" href="userBlog.html?user.id=<s:property value="id"/>" title="<s:property value="nickName"/>"><s:property value="nickName"/></a>
                    <s:if test="!userFocused">
                        <a class="follow" href="javascript:;" onclick="becomeFans(this,<s:property value="id"/>);"><s:property value="%{getText('user.add.focus')}"/></a>
                    </s:if>
                    <s:else>
                        <a class="follow" href="javascript:;" onclick="becomeFans(this,<s:property value="id"/>);"><s:property value="%{getText('user.add.focused')}"/></a>
                    </s:else>
     ...
     <div class="new_org sc_d">
        ...
        <ul>
            <s:iterator value="organizations">
               <li>
                    <a class="img" href="orgBlog.html?org.id=<s:property value="id"/>" title="<s:property value="schoolName"/>"><img src="<s:property value="logoUrl"/>"/></a>
                    <div class="date_reserve">
                        <span class="date"><s:property value="%{getText('course.square.of.new.orgs.addTime')}"/>：<s:date name="createDate" format="%{getText('dateformat')}"/></span>
                    </div>
                    <div class="tc">
                        <a class="title" href="orgBlog.html?org.id=<s:property value="id"/>" title="<s:property value="schoolName"/>"><s:property value="schoolName"/></a>
                        <%--<a class="teacher" href="userBlog.html?user.id=<s:property value="teacher.id"/>" title="<s:property value="teacher.nickName"/>"><img src="<s:property value="teacher.pic"/>"/></a>--%>
                    </div>
               </li>
            </s:iterator>
