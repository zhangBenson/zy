...
<div class="square_container">
    ...
    <div class="head_img">
        <p class="desc"><span class="big"><s:property
                value="%{getText('index.not.need.install.soft')}"/></span><br/><br/><s:property
                value="%{getText('index.first.page.intro')}"/></p>

        <p class="handle">
            <a class="handle_1" href="createCourseAllInOne.html"><s:property
                    value="%{getText('course.square.be.teacher')}"/></a>
            <a class="handle_2" href="courseSelection.html"><s:property
    ...
    <div class="classify sc_d">
        ...
        <ul class="switch">
            <li class="stand_out" onclick="getCoursesDivideByType(0,this);"><s:property
                    value="%{getText('search.header.all')}"/></li>
            <li onclick="getCoursesDivideByType(1,this);"><s:property
                    value="%{getText('course.square.course.type.language')}"/></li>
            <li onclick="getCoursesDivideByType(2,this);"><s:property
                    value="%{getText('course.square.course.type.trip')}"/></li>
            <li onclick="getCoursesDivideByType(3,this);"><s:property
                    value="%{getText('course.square.course.type.carreer')}"/></li>
            <li onclick="getCoursesDivideByType(4,this);"><s:property
                    value="%{getText('course.square.course.type.science')}"/></li>
            <li onclick="getCoursesDivideByType(5,this);"><s:property
                    value="%{getText('course.square.course.type.abroad')}"/></li>
            <li onclick="getCoursesDivideByType(6,this);"><s:property
                    value="%{getText('course.square.course.type.sociaty')}"/></li>
        </ul>
                    ...
                    <s:iterator value="courses">
                        <li>
                            ...
                            <div class="date_reserve">
                                ...
                                <a href="initCourseconfirm.html?course.id=<s:property value="course.id"/>"><s:property
                ...
                <ul>
                    <s:iterator value="hottestTeacher">
                        <li>
                            ...
                            <span><s:property value="fansNum"/><s:property
                                    value="%{getText('the.num.of.focus.on.live.channel')}"/></span>
                        </li>
                    </s:iterator>
                </ul>
            </div>
