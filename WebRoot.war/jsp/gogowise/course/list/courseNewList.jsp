...
<div class="listView fl">
    ...
    <div class="viewLeft fl">
        ...
        <p class="info">
            ...
            <span>
                <s:if test="charges == 0"><span class="orange_words"><s:property value="%{getText('course.without.charges')}"/></span></s:if><s:else><span class="orange_words"><s:property value="charges" /></span><s:property value="%{getText('course.consumptionType.true')}"/></s:else>
