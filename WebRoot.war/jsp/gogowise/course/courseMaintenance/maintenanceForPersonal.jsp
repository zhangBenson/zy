...
<div class="course_create_container">
        ...
        <table cellpadding="0" cellspacing="0">
          ...
          <tbody class="list_tbody">
           <s:iterator value="course.classes">
              ...
              <td>
                   <span class="class_btn edit_class_btn" id="course_edit<s:property value="id"/>" onclick="editSpecifiedClass(<s:property value="id"/>);"><s:property value="%{getText('course.class.edit')}"/></span>
               </td>
               <td>
                   <span class="class_btn" onclick="deleteAddedClass('classes<s:property value="id"/>',<s:property value="id"/>);"><img src="images/delete.gif"/><s:property value="%{getText('course.class.delete')}"/></span>
               </td>
            </tr>
           </s:iterator>
          </tbody>
      ...
      <div class="content_class_add">
        <div class="add_selection">
          ...
          <ul class="self_system_ul" id="self_show_ul">
            <li>
              <div class="option_tittle"><s:property value="%{getText('lable.course.name')}"/></div><div id="class_name_msg" class="input_msg"></div>
              <div class="option_content">
                <s:textfield name="courseClass.name" id="class_name_input" value="%{getText('class.count',{classCount})}" cssClass="long_text_field" readonly="true"/>
              </div>
            </li>
            <li>
              <div class="option_tittle"><s:property value="%{getText('lable.course.nickname')}"/></div><div id="class_nickname_msg" class="input_msg"></div>
              <div class="option_content">
                <s:textfield name="courseClass.nickName" id="class_nickname_input" cssClass="long_text_field" />
              </div>
            </li>
            <li class="short_li">
              <div class="option_tittle"><s:property value="%{getText('lable.course.starttime')}"/></div><div id="class_start_time_msg" class="input_msg"></div>
              <div class="option_content">
            ...
            <li class="long_li">
                ...
                <s:submit value="%{getText('course.creation.confirm')}" cssClass="submit_btn" onclick="return checkSaveClass();"/>
            </li>
          </ul>
          </s:form>
          ...
          <ul class="auto_system_ul" id="auto_show_ul">
            <li class="long_li">
                <table id="add_class_table">
                    <tr><td><span class="option_tittle"><s:property value="%{getText('lable.course.starttime')}"/></span><span class="input_msg" id="form2_start_time_msg"></span></td><td><s:property value="%{getText('label.lastingtime')}"/></td><td>&nbsp;</td></tr>
                    <tr id = "urFirst">
            ...
            <li class="long_li">
              <div class="option_tittle"><s:property value="%{getText('date.fixed.model')}"/></div><div class="input_msg"></div>
            ...
            <li class="long_li">
              <div class="option_tittle"><s:property value="%{getText('course.creation.repeat.range')}"/></div>
  ...
  <div class="direction_wrap">
        <input type="button" class="act_btn back" onclick="modifygoback2step2();" value="<s:property value="%{getText('page.previous')}"/>" />
        <input type="submit" class="act_btn forth" onclick="return checkModifyClasses();" value="<s:property value="%{getText('page.next')}"/>" />
  </div>
</div>