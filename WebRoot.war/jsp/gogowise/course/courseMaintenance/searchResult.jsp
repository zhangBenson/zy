...
.blogframe .video{height:90px;width:120px;padding: 2px;margin-left:14px;margin-top:10px;margin-right:6px; margin-bottom:6px;border: 1px solid #CCC;box-shadow: -1px -1px 3px rgba(0,0,0,0.2);}
 .blogframe .video img{height:90px;width:120px;}
 .courseinfo{ width:210px; margin:8px 0 0 5px;}
.shortCourseInfo{width:165px;}
.longCourseInfo{width:275px;}
.courseinfo p{ margin:0; line-height:24px;}
.courseinfo p.course_attend{color:#069;cursor:pointer;font-weight: bold;}
.courseinfo p.course_attend:hover{color:#28b;}
b{ color:#cc6600;}
a:link,a:visited{ color:#cc6600;}
a:hover{ color:#F90;}
b a{ color:#F90; text-decoration:underline;}
.blogframe h6{ color:#006699; font-size:18px;padding-bottom:2px; float:left; width:640px; position:relative;}
...
h6 .type2{ position:absolute; top:0; right:130px;}
h6 .seeallclass{position:absolute; top:0; right:0px; cursor: pointer; font-size: 16px;color:#cc6600;}

#reservationbtn{ background: url(images/blogindex/maintenance.gif) no-repeat; width:136px; height:40px; border:0; cursor:pointer;}
...
<s:iterator value="courses" status="idx">
      ...
      <div class="blogframe">
          ...
          <h6><s:property value="name"/>
              ...
              <span class="seeall">
                   <a href="initCourseInfoModify.html?course.id=<s:property value="id"/>">
          ...
          <div class="courseinfo shortCourseInfo">
              ...
              <p class="course_attend">Course Attendances</p>
          </div>
          <div class="courseinfo shortCourseInfo">
          ...
          <div class="courseinfo longCourseInfo">
 ...
 <script type="text/javascript">
     ...
     $(".seeallclass").click(function() {
         $("div.classintro").not($(this).parents("div.blogframe").children()).hide();
