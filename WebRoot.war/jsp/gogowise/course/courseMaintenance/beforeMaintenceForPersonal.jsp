        ...
        <div class="create_content">
            <ul class="content_courseInfo">
                ...
                <li class="long_select_li">
                    ...
                    <div class="option_content"><s:textfield cssClass="slim_text_field" name="course.charges" value="0"
                                                             type="text" readonly="true"/>&nbsp;<s:property
                ...
                <s:if test="courseType == 1 || courseType == 2">
                    <li>
                        ...
                        <div class="option_content"><s:textfield cssClass="long_text_field" id="course_teacherEmail"
                                                                 placeholder="%{getText('org.course.lecturer.email')}"
                                                                 onblur="checkTeacherMail(this);" name="teacherEmail"
                                                                 type="text"/></div>
                    </li>
                </s:if>
            </ul>
