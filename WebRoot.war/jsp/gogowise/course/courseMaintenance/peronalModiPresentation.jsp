...
<div class="course_create_container">
    ...
    <div class="create_content">
        <div class="content_course_class_info">
            ...
            <div class="fabu_div">
                <span class="fabu_btn" onclick="personalModifyFabu(<s:property value="course.id"/>,<s:property
                        value="teacherChange"/>);"/>
    ...
    <div class="direction_wrap">
        <input type="button" class="act_btn back" onclick="goback2personalModify();"
