...
<div class="course_create_container">
  ...
  <div class="create_content">
    <div class="content_course_class_info">
      ...
      <div class="fabu_div">
          <span class="fabu_btn" onclick="personalModifyFabu(<s:property value="course.id"/>,<s:property value="teacherChange"/>);" />
            <s:property value="%{getText('course.maintenance.confirm')}" />
          </span>
      </div>
  ...
  <div class="direction_wrap">
      <input type="button" class="act_btn back" onclick="goback2personalModify();" value="<s:property value="%{getText('page.previous')}"/>" />
  </div>
</div>