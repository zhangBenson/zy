    ...
    <div class="footersbg">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="footersLink">| <a href="index.html"><s:property value="%{getText('menu.item.index')}"/></a>
                    | <a href="courseSquare.html"><s:property value="%{getText('frame.course.center')}"/></a> | <a
                            href="aboutUs.html"><s:property value="%{getText('link.about.us')}"/></a> |
                </div>
            </div>
        </div>
    </div>
