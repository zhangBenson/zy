		  ...
		  <ul >
            <li id="li_1" >
		      ...
		      <span>
                   ...
                   <input id="element_1_2"  name="identity" class="element radio" type="radio" value="2" checked="checked"/>
            ...
            <li class="buttons">
                  <s:submit name="submit" id="saveForm" value="%{getText('button.next')}" class="button_text"/>
		    </li>
		  </ul>
	    </s:form>
        </div>
