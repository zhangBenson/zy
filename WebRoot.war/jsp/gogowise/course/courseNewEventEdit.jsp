...
<div class="course_create_container">
  ...
  <s:form action="editCourseNewEvent" method="POST" enctype="multipart/form-data">
      <s:hidden name="courseNewEvent.id"/>
      <div class="create_content">
          <ul class="content_courseInfo">
              <li>
                  <div class="option_tittle">名称</div>
                  <div class="show_name_input_msg input_msg"></div>
                  <div class="option_content"><s:textfield cssClass="long_text_field" id="show_showName" name="courseNewEvent.title"/>
                  </div>
              </li>
              <li>
                  ...
                  <div class="option_content">
                      <s:textarea cssClass="long_text_area" id="show_showDesp" name="courseNewEvent.content"/>
                  </div>
              </li>
              <li>
                  ...
                  <s:hidden id="show_showLogo" cssClass="long_text_field" name="courseNewEvent.logoUrl"/>
              </li>
          </ul>
      </div>
...
<script type="text/javascript">
    <s:if test="courseNewEvent.id != null && courseNewEvent.logoUrl != null">
         $("#show_log_preview").attr('src','<s:property value="courseNewEvent.logoUrl"/>');
    </s:if>
</script>
