...
.reservationbtn {
    background: url(images/courseImages/vod.gif) no-repeat;
    width: 136px;
    height: 40px;
    border: none;
    cursor: pointer;
        ...
        <s:iterator value="courses" status="idx">
            ...
            <div class="blogframe">
                ...
                <div class="video"><s:a action="voaCourseBlog"><s:param name="course.id" value="id"/><img
                        src="<s:property value="logoUrl"/>"/></s:a></div>
                <h6><s:property value="name"/>
                    <span id="rate_t_<s:property value="#idx.index"/>" class="type2"></span>
              <span class="seeall">
                   <input name="" type="button" value="" onclick="voa(<s:property value="id"/>);"
                ...
                <div class="courseinfo">
                    ...
                    <s:if test="personalTeacher==null">
                        <p><s:text name="label.online.class.org.name"/>：<b><s:a
                                action="orgBlog"><s:param name="org.id" value="organization.id"/><s:property value="organization.schoolName"/></s:a></b></p>
                    </s:if>
