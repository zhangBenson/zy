...
<div class="create_cont fl">
        ...
        <s:form id="course_main_info_form">
            ...
            <div class="stepCont" style="display:block;">
                ...
                <div class="pic_2">
                    ...
                    <div class="storeWrap">
                        <input type="button" class="store_btn" id="step2_store" value="<s:property value="%{getText('term.info.save')}"/>"/>
                ...
                <div class="content_inner fl">
                      ...
                      <div class="self_system_wrap">
                          <s:form id="self_class_system_form">
                                  ...
                                  <div class="storeWrap">
                                    <input type="button" class="store_btn" id="step3_self_store" value="<s:property value="%{getText('term.info.save')}"/>"/>
                      ...
                      <div class="auto_system_wrap" style="display:none;">
                          <s:form id="auto_class_system_form">
                              ...
                              <div class="storeWrap">
                                  <input type="button" class="store_btn" id="step3_auto_store" value="<s:property value="%{getText('term.info.save')}"/>"/>
                              </div>
                          </s:form>
                      </div>
                </div>
    ...
    <div class="create_confirm">
        <input type="button" id="submit_btn_large" class="submit_btn_large" onclick="publishCourse();" value="<s:property value="%{getText('course.management.store')}"/>"/>
    </div>
