    ...
    <h3><s:property value="%{getText('course.resource.upload.resource')}"/></h3>
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="courseMaterial.sourceTitle" /><span class="errorMessage" id="cm_title"></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><textarea name="courseMaterial.description" onkeyup="changeWordNumber(this,$('#cm_desc'),250);" placeholder="<s:property value="%{getText('course.resource.fill.desc')}"/>"></textarea><span class="errorMessage" id="cm_desc"></span></td>
            </tr>
            <tr>
                <td></td>
                <td><s:submit cssClass="submit_material_btn" onclick="return checkUploadForm();" value="%{getText('course.resource.upload.resource')}"/></td>
            </tr>
            </s:form>
        </table>
</div>
