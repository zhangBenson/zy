...
<div class="pageLoc fl">
    <a href="myRegistration.html">我注册的课程</a>
    <i>&gt;</i>
    <%--<a href="">某某某某课程</a>--%>
    <%--<i>&gt;</i>--%>
    <span>添加课程新鲜事</span>
...
<div class="eidtorWrap fl">
    <s:form action="addCourseEvent">
        <s:hidden name="course.id"/>
        <p>
            <label>课程新鲜事主题</label>&nbsp;&nbsp;&nbsp;<span class="tip_words" id="event_title_tip"></span> <br/><br/>
            <input class="text event_title" type="text" name="courseNewEvent.title"/>    <br/><br/><br/>
        </p>

        <p>
            <label for="editor1">在这里输入新鲜事有关内容</label> &nbsp;&nbsp;&nbsp;<span class="tip_words" id="event_content_tip"></span> <br/><br/>
            <textarea cols="80" id="editor1" name="courseNewEvent.content" rows="10">这个课程真有趣！</textarea>
