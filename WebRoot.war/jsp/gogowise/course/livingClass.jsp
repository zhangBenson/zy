...
<div class="rightcontent">
              ...
              <div class="blogframe">
                  ...
                  <div class="courseLogo"><s:a action="voaCourseBlog"><s:param name="course.id" value="id"/><img src="<s:property value="logoUrl"/>" onerror="javascript:this.src='images/nopic.jpg'" /></s:a></div>
                  <div class="course_info">
                      <div class="course_tittle">
                          <h6><s:property value="name"/><s:if test="organization != null">--<s:property value="organization.schoolName"/></s:if></h6>
                          <span class="type2"></span>
                      </div>
                      <div class="course_detail">
                          <table cellpadding="5" cellspacing="5">
                              <tr>
                                  <td><s:property value="%{getText('org.blog.lecture')}"/>：<s:a action="userBlog"><s:param name="user.id" value="teacher.id"/><s:property value="teacher.nickName"/></s:a></td>
                                  <td><s:property value="%{getText('label.number.of.attendee')}"/>：<span class="orangeWords">
                                       <s:property value="studentNum"/>
                                  </span></td>
                              </tr>
                              <tr>
                                  <td><s:property value="classOnTheCorner.name"/>：<span class="orangeWords"><s:date name="classOnTheCorner.date" format="%{getText('dateformat.forclass')}"/></span></td>
                                  <td><s:property value="%{getText('course.total.charge')}"/>：<span class="orangeWords"><s:property value="charges"/>&nbsp;<s:property value="%{getText('label.zhibi.'+consumptionType)}"/></span></td>
                              </tr>
                              <tr><td colspan=2 style="width:445px;"><s:property value="%{getText('course.info.description')}"/>：<span class="orangeWords" id="descriptionMsg<s:property value='#idx.index'/>"><s:property value="description"/></span></td></tr>
                          </table>
                      </div>
                      ...
                      <div class="course_manipulate">
                           <a  class="course_supervise_btn" onclick="audting(<s:property value="classOnTheCorner.id"/>);"><s:property value="%{getText('button.start.try')}" /></a>
