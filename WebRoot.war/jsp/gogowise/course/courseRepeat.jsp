...
<div class="stepTip fl">
    ...
    <i>&gt;</i>
    <s:select name="course.fromCourse.id" id="courseName" list="orgs" listKey="key" cssClass="long_select"
              listValue="value" value="course.id"/>
    <i>&gt;</i>
            ...
            <div class="pic_2">
                <ul class="content_courseInfo fl">
                    ...
                    <li>
                        ...
                        <s:textfield cssClass="long_text_field" id="step2_course_student_type" name="course.studentType"
                                     type="text"/>
                    ...
                    <s:if test="courseType == 1 || courseType == 2">
                        <li>
                            ...
                            <s:textfield cssClass="long_text_field" id="course_teacherEmail"
                                         placeholder="%{getText('org.course.lecturer.email')}"
                                         name="course.teacherEmail"/>&nbsp;
