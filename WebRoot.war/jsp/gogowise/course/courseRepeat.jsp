...
<div class="create_cont fl">
    <div class="stepTip fl">
        ...
        <i>&gt;</i>
        <s:select name="course.fromCourse.id" id="courseName" list="orgs" listKey="key" cssClass="long_select" listValue="value" value="course.id"/>
        <i>&gt;</i>
        <s:property value="%{getText('label.select.repeat')}"/>
    </div>
    ...
    <div class="stepWrap fl">
            ...
            <div class="stepCont step1Cont">
                ...
                <div class="pic_2">
                    ...
                    <div class="storeWrap">
                        <input type="button" class="store_btn" id="step1_store" value="保存" />
                ...
                <div class="pic_2 after_store" id="step1_store_cont">
                    ...
                    <input type="button" class="store_btn" id="step1_modify" value="修改" onclick="modifyStepMsg(this,1);"/>
                </div>
                <div class="pic_3"></div>
            </div>
    </div>
        ...
        <s:form id="course_main_info_form">
            ...
            <div class="stepCont">
                ...
                <div class="pic_2">
                    ...
                    <div class="storeWrap">
                        <input type="button" class="store_btn" id="step2_store" value="保存"/>
                ...
                <div class="pic_2 after_store" id="step2_store_cont">
                    <ul>
                        ...
                        <li><s:property value="%{getText('course.student.appointed')}"/>：<span class="orange_words" id="store_emails"><s:property value="course.courseTeachingBook"/></span></li>
                    </ul>
                    <div class="obv_logo"><s:property value="%{getText('label.online.class.logo')}"/><br/><img  id="obv_course_logo" src="<s:property value="course.logoUrl"/>"/></div>

                    <input type="button" class="store_btn" id="step2_modify" value="修改" onclick="modifyStepMsg(this,2);"/>
                </div>
                <div class="pic_3"></div>
            </div>
        </s:form>
                ...
                <div class="content_inner fl">
                      ...
                      <div class="self_system_wrap">
                          <s:form id="self_class_system_form">
                                  ...
                                  <div class="storeWrap">
                                    <input type="button" class="store_btn" id="step3_self_store" value="保存"/>
                      ...
                      <div class="auto_system_wrap" style="display:none;">
                          <s:form id="auto_class_system_form">
                              ...
                              <div class="storeWrap">
                                  <input type="button" class="store_btn" id="step3_auto_store" value="保存"/>
                              </div>
                          </s:form>
                      </div>
                </div>
    ...
    <div class="create_confirm">
        <input type="button" id="submit_btn_large" class="submit_btn_large" onclick="publishCourse();" value="创建课程"/>
    </div>

</div>

<%@ include file="/jsp/gogowise/course/courseCreate/stepAll4Repeat_js.jsp" %>
...
<script type="text/javascript">
    $(function(){
        $("#courseName").change(function(){
            window.location.href = "courseRepeat.html?course.id="+$(this).val();
        });
    });
</script>