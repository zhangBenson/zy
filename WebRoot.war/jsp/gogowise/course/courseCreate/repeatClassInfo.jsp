...
<div class="course_create_container">
  ...
  <div class="direction_wrap">
        <input type="button" class="act_btn back" onclick="goback2repeatCourse();" value="<s:property value="%{getText('page.previous')}"/>" />
        <input type="submit" class="act_btn forth" onclick="return checkRepeatClasses();" value="<s:property value="%{getText('page.next')}"/>" />
  </div>
</div>