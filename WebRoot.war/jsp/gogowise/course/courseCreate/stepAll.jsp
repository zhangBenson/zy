                    ...
                    <s:if test="courseType == 1 || courseType == 2">
                        <li>
                            ...
                            <s:iterator value="teachers" status="stx">
                                <input type="radio" name="teacherIds" value="<s:property value="id"/>"
                                       id="teacherIds-<s:property value="#stx.count"/>" title="email">
                                <label for="teacherIds-<s:property value="#stx.count"/>" class="checkboxLabel"
                                       tag="<s:property value="email"/>"><s:property
                                        value="nickName==null?email:nickName"/></label>&nbsp;&nbsp;
                            </s:iterator>
