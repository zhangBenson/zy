...
<li>1、<s:property value="%{getText('title.select.type')}"/></li>
  ...
  <div class="create_content">
    <div class="content_course_class_info">
      ...
      <div class="course_logo"><span class="blue_tittle"><s:property value="%{getText('course.logo')}" /></span><br/><br/>
  ...
  <div class="direction_wrap">
      <input type="button" class="act_btn back" onclick="goback2repeatClass();" value="<s:property value="%{getText('page.previous')}"/>" />
  </div>
