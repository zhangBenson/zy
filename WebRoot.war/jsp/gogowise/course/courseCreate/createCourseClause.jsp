...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <style type="text/css">
            #main{font-size:12px;width: 600px;/*height:350px;*//*overflow-y:scroll;*/color: black;text-align: left;}
            #main p{ font-family: "΢微软雅黑","宋体"; line-height: 25px; color: #333;text-align: left;}
            #main h4{ color: #333; font-size: 14px; margin-top: 10px; margin-bottom: 4px;text-align: left;display: block;clear: both;}
            #main h3{color: #333; font-size: 16px; margin-top: 10px; margin-bottom: 4px;text-align: left;}
        </style>
