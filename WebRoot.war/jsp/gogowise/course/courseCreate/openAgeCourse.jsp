...
.blogframe .video{height:100px;width:133px;padding: 2px;margin: 0 5px 10px 15px;border: 1px solid #CCC;box-shadow: -1px -1px 2px rgba(0,0,0,0.2);}
.blogframe .video img{width:133px;height:100px;}
...
.seeall{ font-size:16px; color:#cc6600; position:absolute; right:-30px; top:35px; cursor:pointer; width:136px; height:40px;}
          ...
          <div class="courseinfo shortCourseInfo">
           ...
           <div class="courseinfo shortCourseInfo">
            ...
            <div class="courseinfo">
               ...
               <p><s:property value="%{getText('course.invite.student.num')}"/>：<b><s:property value="inviteStudentNum"/></b> <s:property value="%{getText('label.forcast.person')}" /></p>
            </div>
                        ...
                        <s:iterator value="classes">
                            <tr>
                                ...
                                <td><s:property value="%{getText('lable.course.endtime')}"/>：<b><s:date
                                        name="finishDate" format="%{getText('dateformat.forclass')}"/></b></td></tr></s:iterator>
                    </table>
           </div>
            <img src="images/blogindex/courseframebottom.gif" class="frame1bottom"/></div></s:iterator>
