...
<div class="course_create_container">
          ...
          <tbody class="list_tbody">
           <s:iterator value="course.classes">
              ...
              <td>
               ...
               <td>
                   <a class="class_btn" onclick="deleteAddedClass('classes<s:property value="id"/>',<s:property value="id"/>);"><img src="images/delete.gif"/><s:property value="%{getText('course.class.delete')}"/></a>
               </td>
            </tr>
           </s:iterator>
          </tbody>
  ...
  <div id="classesMsg" class="tip_words"></div>
    <div class="direction_wrap">
        <input type="button" class="act_btn back" onclick="goback2step2();" value="<s:property value="%{getText('page.previous')}"/>" />
        <input type="button" class="act_btn forth" onclick="return checkClasses();" value="<s:property value="%{getText('page.next')}"/>" />
    </div>
</div>