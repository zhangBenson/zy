    ...
    <s:form action="repeatCourse" method="POST" validate="true" theme="css_xhtml" enctype="multipart/form-data">
        ...
        <div class="create_content">
            <ul class="content_courseInfo">
                <li>
                    <div class="option_tittle"><s:property value="%{getText('repeat.course.of.select.course')}"/></div>
                    <div class="course_name_input_msg input_msg"></div>
                    <div class="option_content"><s:select name="course.fromCourse.id" id="courseName" list="orgs"
                                                          listKey="key" cssClass="long_text_field" listValue="value"
                                                          value="course.id"/></div>
                </li>
                ...
                <li class="long_select_li">
                    ...
                    <div class="option_content"><s:textfield id="courseStartDate" name="startTime" readonly="true"
                ...
                <li>
                    ...
                    <span class="add_student_btn_for_course_repeat" id="add_student_btn_for_course_repeat"><s:property
                            value="%{getText('course.add.student')}"/></span>
                    ...
                    <div class="option_content" id="invitedStudents">
                        <input class="long_text_field_for_student"
                               ...
                               id="studentEmail1" onblur="checkRepeatStudentMail(this);" name="emails" type="text"/>
                    </div>
                </li>
            </ul>
        </div>
        <div class="direction_wrap">
            ...
            <input type="submit" class="act_btn forth" onclick="return yzRepeatCourseForm();"
