             ...
             <s:iterator value="courseInviteStudents" status="idx">
                 ...
                 <s:else>
                     <s:if test="identity!=null">
                            var count = <s:property value="#idx.index+1"/>
...
<div class="course_create_container">
  ...
  <s:form action="saveCourse" method="POST" validate="false" theme="css_xhtml">
      ...
      <div class="create_content">
        <ul class="content_courseInfo">
            ...
            <li>
                ...
                <div class="option_content"><s:textfield cssClass="long_text_field" id="step2_course_name" name="course.name" type="text" /></div>
            </li>
            <li>
            ...
            <li>
                <div class="option_tittle"><s:property value="%{getText('course.info.of.student.type')}"/></div><div class="course_student_type_input_msg input_msg"></div>
                <div class="option_content"><s:textfield cssClass="long_text_field" id="step2_course_student_type" name="course.studentType" type="text" /></div>
             </li>
            <li>
                <div class="option_tittle"><s:property value="%{getText('course.info.of.teaching.book')}"/></div><div class="course_teaching_book_input_msg input_msg"></div>
                <div class="option_content"><s:textfield cssClass="long_text_field" id="step2_course_teaching_book" name="course.courseTeachingBook" type="text" /></div>
             </li>
            <li>
                <div class="option_tittle"><s:property value="%{getText('course.info.of.course.type')}"/></div><div class="course_type_input_msg input_msg"></div>
                <div class="option_content"><s:select list="#{'1':getText('course.type.1'),'2':getText('course.type.2'),'3':getText('course.type.3'),'4':getText('course.type.4'),'5':getText('course.type.5'),'6':getText('course.type.6')}" headerKey="-1" headerValue="%{getText('please.choose.course.type')}" cssClass="long_text_field" id="step2_course_type" name="course.courseType"/></div>
             </li>
            <li class="long_select_li">
                ...
                <div class="option_content"><s:textfield id="courseStartDate" name="course.startDate" readonly="true" cssClass="Wdatepicker short_text_field"/></div>
            </li>
            <li class="long_select_li">
                ...
                <div class="option_content"><s:textfield cssClass="short_text_field" name="course.charges" value="0" type="text" readonly="false"/>&nbsp;<s:property value="%{getText('label.zhibi.true')}"/></div>
            </li>
            <li>
                ...
                <div class="option_content">
                    ...
                    <input type="button" id="change_portrait" value="<s:property value="%{getText('onlive.message.update')}"/>" href="courseLogoProcess.html"/>
                </div>
            </li>
      ...
      <div class="direction_wrap">
            ...
            <input type="submit" class="act_btn forth" onclick="return yzSaveCourseForm();" value="<s:property value="%{getText('page.next')}"/>" />
      </div>
  </s:form>
</div>
