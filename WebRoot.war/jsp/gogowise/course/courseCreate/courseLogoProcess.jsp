                    ...
                    $(".submit_btn").click(function(){
                        if(OriginalImage.src=""){
                         ...
                         $.post("cropUserPortrait.html",postStr,function(data){
                               ...
                               $("#reImg").attr("src",real_path);
                               $("#usermenu_user_img").attr("src",real_path);
                               $("#userheader_user_img").attr("src",real_path);
                               window.parent.window.$.wokaobox.close();
                         },"text");
                    });
    ...
    <body>
        <div class="image_manipulate_container" id="image_manipulate_container">
            <div class="image_manipulate_inner_div">
                ...
                <div class="fileload_split"></div>
                <div class="edit_div"><%--<input type="button" id="edit_btn" value="编辑头像" class="edit_btn"/>--%>
                </div>
