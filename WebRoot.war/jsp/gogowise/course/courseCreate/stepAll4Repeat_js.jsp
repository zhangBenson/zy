...
$(function () {
    ...
    $("#step1_store").click(function () {
        ...
        if (count > maxStudentCount) {
            $("#step2_store_msg").html("课程类型已修改，邀请的人数不能超过 " + maxStudentCount + ",请删除过多的邀请。");
            $(".stepWrap h3[alt='2']").trigger("click");
            if (step2Stored) {
...
var plsSelectType = "请保存课程类型";
var plsFillCourseInfo = "请完善并保存课程信息";
var plsFillClassInfo = "请输入并保存课堂信息";
...
var warn_charges_empty = "收费不能为空";
var warn_charges_format_wrong = "请输入有效的金额";
var warn_charges_amount_wrong = "收费不能大于1000";
...
//js of step3
var warn_class_name_empty = "课堂名不能为空";
