...
<div class="course_create_container">
  ...
  <div class="create_content">
    <div class="content_course_class_info">
      <h3><s:property value="%{getText('course.info')}"/></h3>
      <ul>
        <li><span class="blue_tittle"><s:property value="%{getText('course.info.courseName')}" />：</span><span class="orangeWords" id="share_title"><s:property value="course.name"/></span></li>
        ...
        <li><span class="blue_tittle"><s:property value="%{getText('course.info.of.student.type')}"/>：</span><span class="orangeWords"><s:property value="course.studentType"/></span></li>
        <li><span class="blue_tittle"><s:property value="%{getText('course.info.of.teaching.book')}"/>：</span><span class="orangeWords"><s:property value="course.courseTeachingBook"/></span></li>
        <li><span class="blue_tittle"><s:property value="%{getText('course.info.of.course.type')}"/>：</span><span class="orangeWords"><s:property value="%{getText('course.type.'+course.courseType)}"/></span></li>
      ...
      <div class="course_logo"><span class="blue_tittle">
           <s:property value="%{getText('course.logo')}" /></span><br/><br/>
           <img id="share_pic" src="<s:property value="course.logoUrl"/>"/>
      </div>
      <s:if test="courseInviteStudents.size != 0">
      <div class="invited_students"><span class="blue_tittle"><s:property value="%{getText('course.invite.student.list')}" />：</span><span class="orangeWords"><s:iterator value="courseInviteStudents"><s:property value="invitedStudentEmail"/>;</s:iterator></span></div>
      </s:if>
      <div class="course_intro"><span class="blue_tittle"><s:property value="%{getText('course.info.description')}" />：</span><br/><span class="orangeWords" id="share_desc"><s:property value="course.description"/></span></div>
      ...
      <div class="fabu_div">
          <span class="fabu_btn" onclick="fabu(<s:property value="course.id"/>);"><s:property value="%{getText('course.maintenance.confirm')}" /></span>
      </div>
  ...
  <div class="direction_wrap">
      <input type="button" class="act_btn back" onclick="goback2step3();" value="<s:property value="%{getText('page.previous')}"/>" />
  </div>
</div>