    ...
    <s:iterator value="courses" status="idx">
        <div class="course_item">
            ...
            <div class="course_info infoWrap">
                ...
                <p class="teacher"><s:property value="%{getText('label.forcast.lecturer')}"/>：<a href="userBlog.html?user.id=<s:property value='teacher.id'/>" title="<s:property value='teacher.nickName'/>"><s:property value='teacher.nickName'/></a> </p>
                ...
                <a class="manage_course" id="courseRecommend<s:property value="#idx.index"/>" href="#recommdatepanel<s:property value="#idx.index"/>"><s:property value="%{getText('label.recommend.course')}"/></a>
                ...
                <a class="manage_course" <%--id="courseNewEvents<s:property value="#idx.index"/>" --%> href="initAddCourseEvent.html?course.id=5"><s:property value="%{getText('add.course.new.event.in')}"/></a>
            </p>
            </div>
                  ...
                  <div id="course_newEvent<s:property value="#idx.index"/>">
                      <form id="course_newEvent_form<s:property value="#idx.index"/>">
                       ...
                       <li>
                          <div class="highlight">
                              <div class="area">
                                  <p><s:property value="%{getText('new.events.title')}"/> &nbsp; &nbsp; &nbsp;<span style="color:red;" id="form_msg<s:property value="#idx.index"/>"></span></p>
                                  <input type="text" css="highlight_file" name="courseNewEvent.title" id="courseNewEvent_title<s:property value="#idx.index"/>"/>
                              </div>
                              <div class="area">
                                  ...
                                  <%--<input type="file" css="highlight_file" name="" id="courseNewEvent_logUrl"/>--%>
                                      <div>
                                          ...
                                          <img src="images/defaultImgs/course.gif" id="logo_preview<s:property value="#idx.index"/>"/>
                                      </div>
                                      <input type="file" id="courseNewEvent_logo<s:property value="#idx.index"/>" name="upload" class="highlight_file"/>
                                      <input type="hidden" id="courseNewEvent_logoUrl<s:property value="#idx.index"/>" name="courseNewEvent.logoUrl"/>
                              </div>
                              <div class="area">
                                  <p><s:property value="%{getText('term.info.update.right.there')}"/><span class="live_term_highlight_tip"></span></p>
                                  <textarea name="courseNewEvent.content" id="courseNewEvent_content<s:property value="#idx.index"/>"></textarea>
                              </div>
                              <div class="handle">
                                  <a href="#fancybox" class="submit" onclick="submitCourseNewEvent(<s:property value="#idx.index"/>);"><s:property value="%{getText('term.info.save')}"/></a>
