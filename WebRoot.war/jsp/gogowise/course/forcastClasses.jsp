...
.courseinfo{ width:230px; margin:8px 0 0 5px;}
...
<s:iterator value="courses" status="idx">
      <div class="blogframe">
          ...
          <div class="video"><s:a action="voaCourseBlog"><s:param name="course.id" value="id"/><img src="<s:property value="logoUrl"/>" border="0" /></s:a></div>
          <h6><s:property value="name"/>
              ...
              <span class="seeall">
                   <a onclick="return saveReservation(<s:property value="#idx.index"/> ,<s:property value="id"/>,<s:if test="teacher!=null"><s:property value="teacher.id"/></s:if><s:else>0</s:else>);">
