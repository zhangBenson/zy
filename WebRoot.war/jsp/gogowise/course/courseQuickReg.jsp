    ...
    <div class="create_content">
        <div class="content_course_class_info">
            ...
            <div class="course_intro"><span class="blue_tittle"><s:property
                    value="%{getText('course.info.description')}"/>：</span><br/><span class="orangeWords"><s:property
            ...
            <div id="fee_reg_content">
                ...
                <span class="reg_email_tip"><s:property value="%{getText('lable.your.email')}"/>：</span> <input
                    id="reg_email_input" class="email_input" name="email" type="text"/><span
                    class="email_input_msg input_msg"></span>
                <input class="reg_btn" type="button" value="<s:property value="%{getText('button.registration')}" />"
                       onclick="return yzQuickReg();"/>
            </div>

            <div class="gotoIndex">
                <h3 class="warm_tip"><s:property value="%{getText('org.warmtip')}"/>：</h3>
                <span class="tip_words"><s:property value="%{getText('label.quick.reg.success.tips.first.part')}"/>&nbsp;<span
                        id="user_free_reg_email"></span><s:property
                        value="%{getText('label.quick.reg.success.tips.last.part')}"/><span onclick="gotoEmailHost();"
                                                                                            class="tip_btn"><s:property
                        value="%{getText('message.check.email.for.quickReg')}"/></span></span>
            </div>
            ...
            <div class="share_div">
                ...
                <div id="ckepop">
                    ...
                    <a href="http://www.jiathis.com/share?uid=1617054"
                       class="jiathis jiathis_txt jiathis_separator jtico jtico_jiathis" target="_blank"><s:property
...
//                  hideMore:true
                ...
                <script type="text/javascript" src="http://v2.jiathis.com/code/jia.js?uid=1617054"
