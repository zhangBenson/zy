        ...
        <s:iterator value="courses" status="idx">
            ...
            <div class="blogframe">
              ...
              <span class="seeall">
                           ...
                           <input name="" type="button" value="我要退订" id=""
                                  onclick="saveReservation('<s:property value='id'/>')"/>
                ...
                <div class="courseinfo">
                    <p><s:property value="%{getText('label.course.fee')}"/>：<b><s:if
                            test="%{personalTeacher == null}"><s:property value="%{4 * classes.size}"/>
                        <s:if test="consumptionType">知币 </s:if><s:else>知券</s:else></s:if><s:else><s:property
                            value="charges"/><s:if test="consumptionType">知币 </s:if><s:else>知券</s:else></s:else></b></p>
                        ...
                        <s:iterator value="classes">
                            ...
                            <tr>
                                ...
                                <td><b><s:if test="finished"><span><s:property
                                        value="%{getText('label.ended')}"/></span></s:if></b></td>
                                　
                            </tr>
                        </s:iterator>
                    </table>
