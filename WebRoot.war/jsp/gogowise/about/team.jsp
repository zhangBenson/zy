...
<div class="auright">
    <div class="rtHead">
        <h3><s:text name="nav.team.info"/></h3>
        ...
        <div class="cascade">
            ...
            <span> > </span>
            <span><s:text name="nav.team.info"/></span>
        </div>
    </div>
    ...
    <div class="rtCont">
        <div class="founder_box fl">
            ...
            <div class="fl desc_wrapper">
                ...
                <p class="founder_box_desc">
                    Zeng Zeng received the Ph.D. in electrical and computer engineering from The National University of
                    Singapore, in 2005. He received his BS and MS degrees in automatic control from Huazhong University
                    of Science and Technology, Wuhan, P.R. China, in 1997 and 2000, respectively. His research interests
                    include cloud education and training, cloud computing/storage, distributed/grid computing systems,
                    multimedia storage systems, and controller area networks.
                    <br/>Having worked as an associate professor at Hunan University and now a senior research fellow at
                    The National University of Singapore, Zeng is spearheading the setup of Gogowise’s headquarters in
                    Singapore. Under his leadership, the company was recently awarded the iJAM funding from the Media
        ...
        <div class="founder_box fl">
            ...
            <div class="fl desc_wrapper">
                ...
                <p class="founder_box_desc">
                    Jeremy graduated from National University of Singapore with a B. Eng and did his MBA at Nanyang
                    Technological University. He is currently the deputy director at Advanced Digital Sciences Center
                    and is responsible for the day-to-day operations and commercialization of its technologies. Over the
                    years, he has been involved in a number of start-ups and has worked with them to provide guidance in
                    terms of strategy and fundraising. With Jeremy’s exposure in the regional start-up scene, his role
                    in the Gogowise founding team is irreplaceable. Leading the business team, he seamlessly complements
                    Dr Zeng’s technical expertise.
                </p>
            </div>
        </div>
        <%--<div class="founder_box fl">--%>
