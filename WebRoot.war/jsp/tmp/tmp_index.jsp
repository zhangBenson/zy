...
<div id="content">
        ...
        <table width="187px"  height="246px" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><a href="initReg.html">
              <div class="registerNow"><img src="images/indexImgs/index_regist.png"/><s:property value="%{getText('button.register')}" /></div>
              </a></td>
          </tr>
          <tr>
            <td><div class="nickname">
                <input name="user.email" id="nickname"  placeholder="<s:property value="%{getText('msg.email')}" />" type="text" /><br/>
                <span class="emailTip"></span>
              </div></td>
          </tr>
          <tr>
            <td><div class="password">
                <input name="user.password" id="password"  placeholder="<s:property value="%{getText('msg.pwd')}" />" type="password" /> <br/>
                <span class="pwdTip"></span>
              </div></td>
          </tr>
          <tr>
            <td><div class="login&forget">
                  <div class="login">
                      <div class="loginImg" ><img src="images/indexImgs/index_log_in.png"/><s:property value="%{getText('button.log.in')}" /></div>
                      <a href="initRepassword.html"><span class="forgetPwd"><s:property value="%{getText('link.forget.pwd')}" />？</span></a>
                  </div>
                </div>
            </td>
          </tr>
  ...
  <div id="contentDown">
    <div class="beginExp">
      ...
      <a href="livingClass.html"  class="more_course"><s:property value="%{getText('label.course.online.more')}" />></a>
    </div>
            ...
            <s:iterator value="courses" status="idx">
                <li>
                    <p>
                        ...
                        <img src="<s:property value="logoUrl"/>" title="<s:property value="description"/>" onerror="javascript:src='images/nopic.jpg'"/>
                        ...
                        <span class="course_time" id="course_time_<s:property value="#idx.index"/>"><s:date name="classOnTheCorner.date" format="%{getText('dateformat.forclass')}"/></span>
                        <script type="text/javascript">
                            $(document).ready(function(){
            ...
            <s:iterator value="myShows" status="idx">
                <li>
                    <p>
                        ...
                        <span class="course_tittle"><s:property value="name"/></span>
                        <span class="course_time" id="show_time_<s:property value="#idx.index"/>"><s:date name="firstFutureTerm.startTime" format="%{getText('dateformat.forclass')}"/></span>
                        <script type="text/javascript">
                            $(document).ready(function(){
