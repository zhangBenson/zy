...
<%--</div>--%>
<%--</div>--%>
    <s:iterator value="meetings" status="idx">
<div class="course_item">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="add_friend_email" onclick="addFriendEmail(<s:property value="#idx.index"/>);">
                                <s:property value="%{getText('button.add.email.friend')}"/></td>
                        </tr>
                        <tr>
    ...
    <s:if test="meetings.size()==0">
        <div class="error">Sorry, You have no created meetings now....</div>
    </s:if>
