...
<h3 class="courseSubhead"><s:property value="%{getText('design.game.title')}"/></h3>
    ...
    <%-- Course Videos--%>
<div id="videoList">
    <s:iterator value="course.gameClasses" id="class" status="status">
    <s:if test="#status.index<6">
    <s:if test="#status.index % 3 == 0">
    <div class="row"></s:if>
    ...
    <div id="hiddenGameList" class="none">
        ...
        <s:if test="course.gameClasses.size()>6">
            <p class="text-right">
                <button id="moreClass" style="cursor:hand; border: 1px dotted;background-color: #ffffff;"
                ...
                <div class="row">
                    <div class="forumsinfo">
                        ...
                        <div class="forumsContentContainer">
                            ...
                            <p class="text-right"><s:date name="commentTime"
            ...
            <s:iterator value="courses2teacher"><%--courses2teacher--%>
                <div class="col-sm-4">
                    <a href="voaCourseBlog.html?course.id=<s:property value="id"/>" title="<s:property value="name"/>">
                        <div class="recommended"><img src="<s:property value="logoUrl"/>" alt=""/><br/><span><s:property
                                value="name"/></span></div>
                    </a>
                </div>
            </s:iterator>
    ...
    <div class="container">
        ...
        <div class="well">
            <a href="orgBlog.html?org.id=<s:property value="course.organization.id"/>"
               title="<s:property value="course.organization.nickName"/>">
