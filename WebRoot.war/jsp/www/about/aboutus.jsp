...
<body>
	<div class="container">
		...
		<h3 class="courseSubhead">OUR TEAM</h3>
		<img src="images/about/bportrait10.jpg" class="roundPortraitLeft">
		<h1 class = "lecturerName">Zeng Zeng</h1>
		<div class="lecturerTitle">Founder and CEO</div>
		<h4 class="courseBody">
		...
		<img src="images/about/bportrait9.jpg" class="roundPortraitLeft">
		<h1 class="lecturerName" >Jeremy Heng</h1>	
		<div class="lecturerTitle" >Co-founder and Director</div>
		...
		<h3 class="courseSubhead">COMPANY PROFILE</h3>
		<h4 class="courseBody">
