        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    <li>
                        <h4>服务条款的确认和接纳</h4>
                        嘉兴移动公开课用户服务的所有权和运作权归嘉兴移动公开课拥有。嘉兴移动公开课所提供的服务将按照有关章程、服务条款和操作规则严格执行。用户通过注册程序点击“我同意” 按钮，即表示用户与嘉兴移动公开课达成协议并接受所有的服务条款。
                    </li>
                    <li>
                        <h4>嘉兴移动公开课服务简介</h4>
                        嘉兴移动公开课通过国际互联网为用户提供新闻及文章浏览、图片浏览、软件下载、网上留言和BBS论坛等服务。
                        <br/>
                        用户必须：
                        <br/>
                        ...
                        <br/>
                        （3）用户同意遵守《中华人民共和国保守国家秘密法》、《中华人民共和国计算机信息系统安全保护条例》、《计算机软件保护条例》等有关计算机及互联网规定的法律和法规、实施办法。在任何情况下，嘉兴移动公开课合理地认为用户的行为可能违反上述法律、法规，嘉兴移动公开课可以在任何时候，不经事先通知终止向该用户提供服务。用户应了解国际互联网的无国界性，应特别注意遵守当地所有有关的法律和法规。
                    </li>
                    <li>
                        <h4>服务条款的修改</h4>
                        嘉兴移动公开课会不定时地修改服务条款，服务条款一旦发生变动，将会在相关页面上提示修改内容。如果您同意改动，则再一次点击“我同意”按钮。 如果您不接受，则及时取消您的用户使用服务资格。
                    </li>
                    <li>
                        <h4>服务修订</h4>
                        嘉兴移动公开课保留随时修改或中断服务而不需知照用户的权利。嘉兴移动公开课行使修改或中断服务的权利，不需对用户或第三方负责。
                    </li>
                    <li>
                        <h4>用户隐私制度</h4>
                        尊重用户个人隐私是嘉兴移动公开课的 基本政策。嘉兴移动公开课不会公开、编辑或透露用户的注册信息，除非有法律许可要求，或嘉兴移动公开课在诚信的基础上认为透露这些信息在以下三种情况是必要的：
                        <br/>
                        a、遵守有关法律规定，遵从合法服务程序。
                        <br/>
                        b、保持维护嘉兴移动公开课的商标所有权。
                    ...
                    <li>
                        <h4>用户的帐号，密码和安全性</h4>
                        一旦注册成功成为嘉兴移动公开课用户，您将得到一个密码和帐号。如果您不保管好自己的帐号和密码安全，将对因此产生的后果负全部责任。另外，每个用户都要对其帐户中的所有活动和事件负全责。您可随时根据指示改变您的密码，也可以结束旧的帐户重开一个新帐户。用户同意若发现任何非法使用用户帐号或安全漏洞的情况，立即通知嘉兴移动公开课。
                    </li>
                    <li>
                        <h4>免责条款</h4>
                        用户明确同意网站服务的使用由用户个人承担风险。
                        <br/>
                        嘉兴移动公开课不作任何类型的担保，不担保服务一定能满足用户的要求，也不担保服务不会受中断，对服务的及时性，安全性，出错发生都不作担保。用户理解并接受：任何通过嘉兴移动公开课服务取得的信息资料的可靠性取决于用户自己，用户自己承担所有风险和责任。
                    </li>
                    <li>
                        <h4>有限责任</h4>
                        嘉兴移动公开课对任何直接、间接、偶然、特殊及继起的损害不负责任。
                    </li>
                    <li>
                        <h4>不提供零售和商业性服务</h4>
                        用户使用网站服务的权利是个人的。用户只能是一个单独的个体而不能是一个公司或实体商业性组织。用户承诺不经嘉兴移动公开课同意，不能利用网站服务进行销售或其他商业用途。
                    </li>
                    <li>
                        <h4>用户责任</h4>
                    ...
                    <li>
                        ...
                        律的资料。未经许可而非法进入其它电脑系统是禁止的。若用户的行为不符合以上的条款，嘉兴移动公开课将取消用户服务帐号。
                    </li>
                    <li>
                        <h4>网站内容的所有权</h4>
                        嘉兴移动公开课定义的内容包括：文字、软件、声音、相片、录象、图表；在广告中全部内容；电子邮件的全部内容；嘉兴移动公开课为用户提供的商业信息。所有这些内容受版权、商标、标签和其它财产所有权法律的保护。所以，用户只能在嘉兴移动公开课和广告商授权下才能使用这些内容，而不能擅自复制、篡改这些内容、或创造与内容有关的派生产品。
                    </li>
                    <li>
                        <h4>附加信息服务</h4>
                        用户在享用嘉兴移动公开课提供的免费服务的同时，同意接受嘉兴移动公开课提供的各类附加信息服务。
                    </li>
                    <li>
                        <h4>解释权</h4>
                        本注册协议的解释权归嘉兴移动公开课所有。如果其中有任何条款与国家的有关法律相抵触，则以国家法律的明文规定为准。
                    </li>
                </ol>
            </div>
