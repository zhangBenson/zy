                ...
                <h1 class = "courseSynopsis">Please log in to continue.</h1>
                 ...
                 <s:form validate="true" theme="css_xhtml" cssClass="form-horizontal"  method="POST" action="logon">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"> <s:property value="%{getText('email')}" /><span class="errorinfo" id="yzemail">*</span></label>
                        <div class="col-sm-10">
                            <s:textfield name="user.email" id="email" cssClass="form-control" placeholder="Email"/>
                        </div>
                    </div>
                    <div class="form-group">
