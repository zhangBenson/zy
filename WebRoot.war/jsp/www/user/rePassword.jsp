...
<style type="text/css">
    ...
    .errorMessage{ color:#F00; font-size:10px; float: left;}
</style>
    ...
    <div class="row">
        ...
        <div class="col-sm-6" style="">
            <div class="basePanelTextLeft">
                ...
                <s:form cssClass="form-horizontal" action="findEmailUser" theme="css_xhtml" validate="true" method="post" id="form">
                    ...
                    <div class="form-group" style="text-align: center">
                        <a href="#" onclick="changeImg();" ><img id="imgObj" src="textCode.html?time=<%=System.currentTimeMillis()%>" width="120px" height="44px" /></a>
                    </div>
