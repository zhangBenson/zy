    ...
    <div class="row">
        ...
        <div class="col-sm-6" style="">
            <div class="basePanelTextLeft">
                ...
                <s:form action="yzRePasswordCode" id="form" method="POST" theme="css_xhtml" validate="true" cssClass="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <s:textfield type="text" name="user.email" id="textfield" disabled="true" cssClass="form-control"/>
                        </div>
