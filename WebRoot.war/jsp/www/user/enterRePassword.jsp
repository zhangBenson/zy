                ...
                <s:form action="yzRePasswordCode" id="form" method="POST" theme="css_xhtml" validate="true"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <a href="#" class="btn btn-danger  btn-sm btn-block" onclick="sendEmail();"><s:text name="button.send.valid.code"/></a>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="textfield2" class="col-sm-2 control-label"><s:text name="label.valid.code"/>：</label>
