        ...
        <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="forumsinfo">
                                <div class="forumsUserContainer">
                                    <s:a action="userBlog" cssClass="nick_name"><s:param name="user.id" value="owner.id"/><img src="<s:property value="owner.pic"/>" alt="" class="forumportrait"/></s:a>
                                    <s:a action="userBlog" cssClass="nick_name"><s:param name="user.id" value="owner.id"/><p class="textOverSinglerow"><s:property value="owner.nickName"/></p></s:a>
                                </div>
            ...
            <div>
                ...
                <s:form theme="css_xhtml" name="commentsForm" method="post" id="commentForm">
                    ...
                    <br/>
                    <input type="button" class="btn btn-primary btn-lg btn-block" id="message_submit_btn" value="<s:property value="%{getText('blog.comments.submit')}"/>" />
                </s:form>
            </div>
