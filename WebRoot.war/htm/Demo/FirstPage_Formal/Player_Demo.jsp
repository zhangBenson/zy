...
$(document).ready(function () {
    ...
    /*$("#top").load("/jsp/www/layout/top.jsp");
     $("#detailfooters").load("footers.htm");*/

    $("#btnaddUser").click(function () {
        addOneStudent("Scan", "htm/Demo/FirstPage_Formal/gogowisestyle/image/portrait5.jpg", "c1", 1, 1);
    });
...
<div class="pull-left">
    <div class="classVedioPanel">
        ...
        <param name="movie" value="Player_Demo.swf" />
        ...
        <!--[if !IE]>
        -->
        <!-- <object type="application/x-shockwave-flash" data="Player_Demo.swf" width="720" height="560">
        <param name="quality" value="high" />
        <param name="bgcolor" value="#000000" />
        <param name="allowScriptAccess" value="sameDomain" />
        <param name="allowFullScreen" value="true" />
    ...
    <!--<![endif]-->
        ...
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
            ...
            <param name="movie" value="htm/Demo/FirstPage_Formal/Player_Demo.swf"/>
            <param name="quality" value="high"/>
            <param name="wmode" value="transparent"/>
            <param name="allowFullScreen" value="true"/>
            <embed src="htm/Demo/FirstPage_Formal/Player_Demo.swf" allowFullScreen="true" width="720" height="560" quality="high"
                        ...
                        <li>
                            <ul id="studionList">
                                ...
                                <li class="ui-state-default">
                                    <a href="#">
                                        <div class="studioPortraitPanel">
                                            <img src="htm/Demo/FirstPage_Formal/gogowisestyle/image/bportrait5.jpg" alt="">
                                            <p>Name</p>
                                        </div>
                                    </a>
                                ...
                                <li class="ui-state-default">
                                    <a href="#">
                                        <div class="studioPortraitPanel">
                                            <img src="htm/Demo/FirstPage_Formal/gogowisestyle/image/portrait1.jpg" alt="">
                                            <p>Name</p>
                                        </div>
                                    </a>
                                ...
                                <li class="ui-state-default">
                                    <a href="#">
                                        <div class="studioPortraitPanel">
                                            <img src="htm/Demo/FirstPage_Formal/gogowisestyle/image/portrait2.jpg" alt="">
                                            <p>Name</p>
                                        </div>
                                    </a>
                                ...
                                <li class="ui-state-default">
                                    <a href="#">
                                        <div class="studioPortraitPanel">
                                            <img src="htm/Demo/FirstPage_Formal/gogowisestyle/image/portrait3.jpg" alt="">
                                            <p>Name</p>
                                        </div>
                                    </a>
                                ...
                                <li class="ui-state-default">
                                    <a href="#">
                                        <div class="studioPortraitPanel">
                                            <img src="htm/Demo/FirstPage_Formal/gogowisestyle/image/portrait4.jpg" alt="">
                                            <p>Name</p>
                                        </div>
                                    </a>
...
<div class="modal fade" id="questionsStudentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
