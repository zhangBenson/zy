...
<script type="text/javascript">
    ...
    var showNameEmpty = "<s:text name='name.cannot.be.empty'/>";
    var showDespEmpty = "<s:text name='content.cannot.be.empty'/>";

    var showLogoEmpty = "<s:text name='please.ready.to.upload.file'/>";
    var showLogoUploadSuccess = "<s:text name='image.logo.upload.success'/>";
...
//            'fileDataName' : 'uploads',
            ...
            onUploadStart: function (event, queueID, fileObj) {
                $(".show_logo_input_msg").html(warn_div + "<s:text name='image.logo.start.upload'/>");
            }
        });
