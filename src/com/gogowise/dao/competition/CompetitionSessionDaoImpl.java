...
public class CompetitionSessionDaoImpl extends ModelDao.ModelDaoImpl<CompetitionSession> implements CompetitionSessionDao {
    private CompetitionPhaseDao competitionPhaseDao;
    private HostAllocationDao hostAllocationDao;
    private CompetitionPhaseDaoImpl.JudgeAllocationDao judgeAllocationDao;
    private CompetitionDaoImpl.SingerAllocationDao singerAllocationDao;
...
//        sessionForSave.setName(name);
    ...
    public CompetitionPhaseDaoImpl.JudgeAllocationDao getJudgeAllocationDao() {
        return judgeAllocationDao;
    }

    public void setJudgeAllocationDao(CompetitionPhaseDaoImpl.JudgeAllocationDao judgeAllocationDao) {
        this.judgeAllocationDao = judgeAllocationDao;
    }

    public CompetitionDaoImpl.SingerAllocationDao getSingerAllocationDao() {
        return singerAllocationDao;
    }

    public void setSingerAllocationDao(CompetitionDaoImpl.SingerAllocationDao singerAllocationDao) {
