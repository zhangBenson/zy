 ...
 */
public class One2threeStudentSession {
        ...
        if(orgMeeting.getOrgMeetingMembers().size()==3){
            if(orgMeeting.getOrgMeetingMembers().get(0).getMemberEmail() == userEmail){
                  ...
                  if(orgMeeting.getOrgMeetingMembers().get(2).getMember() != null){
                       this.setStudentID2(orgMeeting.getOrgMeetingMembers().get(2).getMember().getId());
                       this.setStudentName2(orgMeeting.getOrgMeetingMembers().get(2).getMember().getNickName());
                  }
            }else if(orgMeeting.getOrgMeetingMembers().get(1).getMemberEmail() == userEmail) {
